...
WorkspaceFactoryModel.prototype.addElementToList = function (element) {
  ...
  this.hasVariableCategory = element.custom == 'VARIABLE'
    ? true
    : this.hasVariableCategory
  this.hasProcedureCategory = element.custom == 'PROCEDURE'
    ? true
...
WorkspaceFactoryModel.prototype.isDefinedBlockType = function (blockType) {
  const isStandardBlock = StandardCategories.coreBlockTypes.indexOf(blockType) !=
      -1
