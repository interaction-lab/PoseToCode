...
AppController.prototype.exportBlockLibraryToFile = function () {
  ...
  // Get file name.
  const filename = prompt('Enter the file name under which to save your block ' +
      'library.', 'library.xml')
  ...
  if (filename) {
    ...
    const msg = 'Could not export Block Library without file name under which ' +
      'to save library.'
...
AppController.prototype.assignBlockFactoryClickHandlers = function () {
  ...
  document.getElementById('files').addEventListener('change',
    function () {
      // Warn user.
      const replace = confirm('This imported block library will ' +
...
AppController.prototype.confirmLeavePage = function (e) {
  ...
  if ((!BlockFactory.isStarterBlock() &&
    ...
    const confirmationMessage = 'You will lose any unsaved changes. ' +
