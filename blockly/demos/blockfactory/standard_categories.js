...
StandardCategories.categoryMap.logic = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Logic"
);
StandardCategories.categoryMap.logic.xml = Blockly.Xml.textToDom(
...
StandardCategories.categoryMap.loops = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Loops"
);
StandardCategories.categoryMap.loops.xml = Blockly.Xml.textToDom(
  '<xml xmlns="https://developers.google.com/blockly/xml">' +
...
StandardCategories.categoryMap.math = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Math"
);
StandardCategories.categoryMap.math.xml = Blockly.Xml.textToDom(
  '<xml xmlns="https://developers.google.com/blockly/xml">' +
...
StandardCategories.categoryMap.text = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Text"
);
StandardCategories.categoryMap.text.xml = Blockly.Xml.textToDom(
  '<xml xmlns="https://developers.google.com/blockly/xml">' +
...
StandardCategories.categoryMap.lists = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Lists"
);
StandardCategories.categoryMap.lists.xml = Blockly.Xml.textToDom(
  '<xml xmlns="https://developers.google.com/blockly/xml">' +
...
StandardCategories.categoryMap.colour = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Colour"
);
StandardCategories.categoryMap.colour.xml = Blockly.Xml.textToDom(
  '<xml xmlns="https://developers.google.com/blockly/xml">' +
...
StandardCategories.categoryMap.functions = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Functions"
);
...
StandardCategories.categoryMap.variables = new ListElement(
  ListElement.TYPE_CATEGORY,
  "Variables"
);
