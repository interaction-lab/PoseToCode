...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Plans\u00E4teskalkylator</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Ett flygplan har tv\u00E5 s\u00E4ten i cockpiten (ett f\u00F6r piloten och ett f\u00F6r andrepiloten) och ett antal rader med passagerars\u00E4ten. Varje rad inneh\u00E5ller fyra s\u00E4ten.";
      break;
    case 3:
      output +=
        "Ett flygplan har tv\u00E5 s\u00E4ten i cockpiten (ett f\u00F6r piloten och ett f\u00F6r andrepiloten) och ett antal rader med passagerars\u00E4ten i f\u00F6rsta och andra klass. Varje rad i f\u00F6rsta klass inneh\u00E5ller fyra s\u00E4ten. Varje rad i andra klass inneh\u00E5ller fem s\u00E4ten.";
      break;
  }
  output +=
    '</p><p>Bygg en formel (nedan) som ber\u00E4knar det totala antalet s\u00E4ten p\u00E5 flygplanet n\u00E4r raderna \u00E4ndras (ovan).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
