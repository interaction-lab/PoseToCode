...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Vliegtuigstoelencalculator</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Een vliegtuig heeft twee stoelen in de cockpit (voor de piloot en de copiloot) en een aantal rijen met stoelen voor passagiers. Iedere rij bevat vier stoelen.";
      break;
    case 3:
      output +=
        "Een vliegtuig heeft twee stoelen in de cockpit (voor de piloot en de copiloot) en een aantal rijen voor 1e klasse en 2e klasse passagiers. Iedere rij in de 1e klasse heeft vier stoelen. Iedere rij in de 2e klasse heeft vijf stoelen.";
      break;
  }
  output +=
    '</p><p>Maak hieronder een formule die het totale aantal stoelen in het vliegtuig berekent als het aantal rijen hierboven wordt aangepast.</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
