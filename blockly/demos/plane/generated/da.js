...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Flys\u00E6delommeregner</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Et fly har to pladser i cockpittet (til pilot og med-pilot), og et antal r\u00E6kker af passagers\u00E6der. Hver r\u00E6kke indeholder fire s\u00E6der.";
      break;
    case 3:
      output +=
        "Et fly har to pladser i cockpittet (til pilot og med-pilot), og et antal r\u00E6kker af 1. klasses og 2. klasses passagers\u00E6der. Hver 1. klasses r\u00E6kke indeholder fire s\u00E6der. Hver 2. klasses r\u00E6kke indeholder fem s\u00E6der.";
      break;
  }
  output +=
    '</p><p>Opbyg en formel (nedenfor), der beregner det samlede antal pladser p\u00E5 flyet, hvis antal r\u00E6kker \u00E6ndres (ovenfor).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
