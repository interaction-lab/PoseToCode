...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Fluchzeichsitzrechner</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "En Fluchzeich hot zwooi Sitze im Pilotestand (f\u00FCr den Pilot und Co-Pilot) und en Oonzohl an Reihe mit Passagiersitze. Jede Reih enth\u00E4lt vier Sitze.";
      break;
    case 3:
      output +=
        "En Fluchzeich hot zwooi Sitze im Pilotstand (f\u00FCr den Pilot und Co-Pilot) und en Oonzohl an Reihe mit Passagiersitze der 1. und 2. Klasse. Jede 1.-Klasse-Reih enth\u00E4lt vier Sitze. Jede 2.-Klasse-Reih enth\u00E4lt f\u00FCnf Sitze.";
      break;
  }
  output +=
    '</p><p>Erstell en Formel (unne), die die gesamte Oonzohl an Sitze im Fluchzeich berechnet, wenn die Reihe (uwe) ge\u00E4nnert sin.</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
