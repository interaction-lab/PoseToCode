...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Flugzeugsitzrechner</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Ein Flugzeug hat zwei Sitze im Pilotenstand (f\u00FCr den Piloten und Co-Piloten) und eine Anzahl an Reihen mit Passagiersitzen. Jede Reihe enth\u00E4lt vier Sitze.";
      break;
    case 3:
      output +=
        "Ein Flugzeug hat zwei Sitze im Pilotenstand (f\u00FCr den Piloten und Co-Piloten) und eine Anzahl an Reihen mit Passagiersitzen der 1. und 2. Klasse. Jede 1.-Klasse-Reihe enth\u00E4lt vier Sitze. Jede 2.-Klasse-Reihe enth\u00E4lt f\u00FCnf Sitze.";
      break;
  }
  output +=
    '</p><p>Erstelle eine Formel (unten), die die gesamte Anzahl an Sitzen im Flugzeug berechnet, wenn die Reihen (oben) ge\u00E4ndert werden.</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
