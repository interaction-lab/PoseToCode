...
Blockly.Blocks.plane_set_seats = {
  ...
  init: function () {
    ...
    this.setColour(330);
    this.appendValueInput("VALUE").appendField(Plane.getMsg("Plane_setSeats"));
...
Blockly.Blocks.plane_get_rows = {
  ...
  init: function () {
    ...
    this.appendDummyInput().appendField(
      Plane.getMsg("Plane_getRows").replace("%1", Plane.rows1st),
      "title"
    );
...
Blockly.Blocks.plane_get_rows1st = {
  ...
  init: function () {
    ...
    this.setColour(330);
    this.appendDummyInput().appendField(
      Plane.getMsg("Plane_getRows1").replace("%1", Plane.rows1st),
      "title"
    );
    this.setOutput(true, "Number");
  },
...
Blockly.Blocks.plane_get_rows2nd = {
  ...
  init: function () {
    ...
    this.setColour(330);
    this.appendDummyInput().appendField(
      Plane.getMsg("Plane_getRows2").replace("%1", Plane.rows2nd),
      "title"
    );
    this.setOutput(true, "Number");
  },
