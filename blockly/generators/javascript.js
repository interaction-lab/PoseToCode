...
Blockly.JavaScript.finish = function (code) {
  ...
  const definitions = [];
  for (const name in Blockly.JavaScript.definitions_) {
...
Blockly.JavaScript.getAdjusted = function (
  ...
  let order = opt_order || Blockly.JavaScript.ORDER_NONE;
  ...
  if (delta > 0) {
    ...
    var at =
      Blockly.JavaScript.valueToCode(block, atId, order) || defaultAtIndex;
  }
