...
Blockly.Python.lists_indexOf = function (block) {
  ...
  var functionName = Blockly.Python.provideFunction_("last_index", [
    "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "(my_list, elem):",
...
Blockly.Python.lists_getIndex = function (block) {
  ...
  const listOrder =
    where == "RANDOM" ? Blockly.Python.ORDER_NONE : Blockly.Python.ORDER_MEMBER;
...
Blockly.Python.lists_setIndex = function (block) {
  ...
  let list =
    Blockly.Python.valueToCode(block, "LIST", Blockly.Python.ORDER_MEMBER) ||
    "[]";
  const mode = block.getFieldValue("MODE") || "GET";
  const where = block.getFieldValue("WHERE") || "FROM_START";
  const value =
  ...
  function cacheList() {
    ...
    const listVar = Blockly.Python.variableDB_.getDistinctName(
      "tmp_list",
...
Blockly.Python.lists_sort = function (block) {
  ...
  const list =
    Blockly.Python.valueToCode(block, "LIST", Blockly.Python.ORDER_NONE) ||
    "[]";
...
Blockly.Python.lists_split = function (block) {
  ...
  if (mode == "SPLIT") {
    var value_input =
      Blockly.Python.valueToCode(block, "INPUT", Blockly.Python.ORDER_MEMBER) ||
      "''";
    var value_delim = Blockly.Python.valueToCode(
      block,
      "DELIM",
    ...
    var value_input =
      ...
      "[]";
    var value_delim =
      Blockly.Python.valueToCode(block, "DELIM", Blockly.Python.ORDER_MEMBER) ||
      "''";
