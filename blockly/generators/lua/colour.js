...
Blockly.Lua.colour_rgb = function (block) {
  ...
  const g =
    Blockly.Lua.valueToCode(block, "GREEN", Blockly.Lua.ORDER_NONE) || 0;
...
Blockly.Lua.colour_blend = function (block) {
  ...
  const colour1 =
    Blockly.Lua.valueToCode(block, "COLOUR1", Blockly.Lua.ORDER_NONE) ||
    "'#000000'";
  const colour2 =
    Blockly.Lua.valueToCode(block, "COLOUR2", Blockly.Lua.ORDER_NONE) ||
    "'#000000'";
  const ratio =
    Blockly.Lua.valueToCode(block, "RATIO", Blockly.Lua.ORDER_NONE) || 0;
  const code =
