...
Blockly.Dart.math_number = function (block) {
  ...
  if (code == Infinity) {
    ...
    order =
      code < 0 ? Blockly.Dart.ORDER_UNARY_PREFIX : Blockly.Dart.ORDER_ATOMIC;
  }
  return [code, order];
};
...
Blockly.Dart.math_single = function (block) {
  ...
  if (operator == "NEG") {
    ...
    arg =
      Blockly.Dart.valueToCode(block, "NUM", Blockly.Dart.ORDER_UNARY_PREFIX) ||
      "0";
    if (arg[0] == "-") {
  ...
  if (operator == "ABS" || operator.substring(0, 5) == "ROUND") {
    ...
    arg =
      Blockly.Dart.valueToCode(block, "NUM", Blockly.Dart.ORDER_NONE) || "0";
  }
...
Blockly.Dart.math_number_property = function (block) {
  ...
  const number_to_check = Blockly.Dart.valueToCode(
    block,
    "NUMBER_TO_CHECK",
    Blockly.Dart.ORDER_MULTIPLICATIVE
  );
  ...
  if (dropdown_property == "PRIME") {
    ...
    Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
    const functionName = Blockly.Dart.provideFunction_("math_isPrime", [
  ...
  switch (dropdown_property) {
    ...
    case "NEGATIVE":
      ...
      break;
    case "DIVISIBLE_BY":
      var divisor = Blockly.Dart.valueToCode(
        block,
        "DIVISOR",
        Blockly.Dart.ORDER_MULTIPLICATIVE
      );
...
Blockly.Dart.math_change = function (block) {
  ...
  const argument0 =
    Blockly.Dart.valueToCode(block, "DELTA", Blockly.Dart.ORDER_ADDITIVE) ||
    "0";
  const varName = Blockly.Dart.variableDB_.getName(
...
Blockly.Dart.math_on_list = function (block) {
  ...
  const list =
    Blockly.Dart.valueToCode(block, "LIST", Blockly.Dart.ORDER_NONE) || "[]";
  let code;
  switch (func) {
    case "SUM":
      var functionName = Blockly.Dart.provideFunction_("math_sum", [
        "num " +
    ...
    case "MIN":
      ...
      var functionName = Blockly.Dart.provideFunction_("math_min", [
        "num " +
          Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
          "(List<num> myList) {",
    ...
    case "AVERAGE":
      ...
      var functionName = Blockly.Dart.provideFunction_("math_mean", [
      ...
      break;
    case "MEDIAN":
      var functionName = Blockly.Dart.provideFunction_("math_median", [
        "num " + Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ + "(List myList) {",
    ...
    case "MODE":
      ...
      var functionName = Blockly.Dart.provideFunction_("math_modes", [
    ...
    case "RANDOM":
      Blockly.Dart.definitions_.import_dart_math =
        "import 'dart:math' as Math;";
      var functionName = Blockly.Dart.provideFunction_("math_random_item", [
        "dynamic " +
          Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
          "(List myList) {",
...
Blockly.Dart.math_constrain = function (block) {
  ...
  Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
  const argument0 =
    Blockly.Dart.valueToCode(block, "VALUE", Blockly.Dart.ORDER_NONE) || "0";
  const argument1 =
    Blockly.Dart.valueToCode(block, "LOW", Blockly.Dart.ORDER_NONE) || "0";
  const argument2 =
    Blockly.Dart.valueToCode(block, "HIGH", Blockly.Dart.ORDER_NONE) ||
    "double.infinity";
  const code =
    "Math.min(Math.max(" +
    argument0 +
...
Blockly.Dart.math_random_int = function (block) {
  ...
  Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
  const argument0 =
    Blockly.Dart.valueToCode(block, "FROM", Blockly.Dart.ORDER_NONE) || "0";
  const argument1 =
    Blockly.Dart.valueToCode(block, "TO", Blockly.Dart.ORDER_NONE) || "0";
  const functionName = Blockly.Dart.provideFunction_("math_random_int", [
...
Blockly.Dart.math_atan2 = function (block) {
  ...
  Blockly.Dart.definitions_.import_dart_math = "import 'dart:math' as Math;";
  const argument0 =
    Blockly.Dart.valueToCode(block, "X", Blockly.Dart.ORDER_NONE) || "0";
  const argument1 =
    Blockly.Dart.valueToCode(block, "Y", Blockly.Dart.ORDER_NONE) || "0";
  return [
