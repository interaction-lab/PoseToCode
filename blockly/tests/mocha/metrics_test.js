...
suite("Metrics", function () {
  ...
  test("GetContentDimensionsExact - empty", function () {
    ...
    const defaultZoom = Blockly.WorkspaceSvg.getContentDimensionsExact_(ws);
  ...
  test("GetContentDimensionsExact - empty zoom in", function () {
    ...
    const zoomIn = Blockly.WorkspaceSvg.getContentDimensionsExact_(ws);
  ...
  test("GetContentDimensionsExact - empty zoom out", function () {
    ...
    const zoomOut = Blockly.WorkspaceSvg.getContentDimensionsExact_(ws);
