...
suite("Utils", function () {
  ...
  suite("tokenizeInterpolation", function () {
    ...
    test("String table", function () {
      ...
      let tokens = Blockly.utils.tokenizeInterpolation("%{bky_string_ref}");
      chai.assert.deepEqual(
        tokens,
        ["test string"],
    ...
    test("Error cases", function () {
      let tokens = Blockly.utils.tokenizeInterpolation("%{bky_undefined}");
      chai.assert.deepEqual(
        tokens,
        ["%{bky_undefined}"],
  ...
  suite("String", function () {
    test("starts with", function () {
      chai.assert.isFalse(
        Blockly.utils.string.startsWith("123", "2"),
        "Does not start with"
      );
      chai.assert.isTrue(
        Blockly.utils.string.startsWith("123", "12"),
        "Start with"
      );
      chai.assert.isTrue(
        Blockly.utils.string.startsWith("123", ""),
        "Start with empty string 1"
      );
      chai.assert.isTrue(
        Blockly.utils.string.startsWith("", ""),
        "Start with empty string 12"
      );
    });
