...
suite("Navigation", function () {
  ...
  suite("Tests toolbox keys", function () {
    ...
    function testToolboxSelectMethodCalled(
      ws,
      mockEvent,
      keyCode,
      selectMethodName
    ...
    test("Go to flyout", function () {
      ...
      chai.assert.equal(
        Blockly.navigation.currentState_,
  ...
  suite("Tests flyout keys", function () {
    ...
    test("Previous", function () {
      ...
      let flyoutBlock = Blockly.navigation
        .getFlyoutCursor_()
        .getCurNode()
        .getLocation();
      chai.assert.equal(
        flyoutBlock.getFieldValue("TEXT"),
      ...
      flyoutBlock = Blockly.navigation
        .getFlyoutCursor_()
        .getCurNode()
        .getLocation();
      chai.assert.equal(
    ...
    test("Next", function () {
      ...
      const flyoutBlock = Blockly.navigation
        .getFlyoutCursor_()
        .getCurNode()
        .getLocation();
      chai.assert.equal(
  ...
  suite("Test key press", function () {
    ...
    test("Action exists - field handles action", function () {
      ...
      const isHandled = Blockly.navigation.onBlocklyAction(
