...
suite('Navigation', function () {
  ...
  suite('Tests toolbox keys', function () {
    ...
    function testToolboxSelectMethodCalled (ws, mockEvent, keyCode, selectMethodName) {
      ...
      const selectNextStub = sinon.stub(toolbox, selectMethodName)
    ...
    test('Go to flyout', function () {
      ...
      const flyoutCursor = Blockly.navigation.getFlyoutCursor_()
  ...
  suite('Tests flyout keys', function () {
    ...
    test('Previous', function () {
      ...
      let flyoutBlock = Blockly.navigation.getFlyoutCursor_().getCurNode().getLocation()
    ...
    test('Next', function () {
      ...
      chai.assert.equal(Blockly.navigation.currentState_,
        Blockly.navigation.STATE_FLYOUT)
      const flyoutBlock = Blockly.navigation.getFlyoutCursor_().getCurNode().getLocation()
      chai.assert.equal(flyoutBlock.getFieldValue('TEXT'),
        'FirstCategory-SecondBlock')
    })
  ...
  suite('Tests workspace keys', function () {
    ...
    test('Mark', function () {
      ...
      this.mockEvent.keyCode = Blockly.utils.KeyCodes.ENTER
      chai.assert.isTrue(Blockly.navigation.onKeyPress(this.mockEvent))
      const markedNode = this.workspace.getMarker(Blockly.navigation.MARKER_NAME).getCurNode()
  ...
  suite('Test key press', function () {
    ...
    test('Action does not exist', function () {
      ...
      const isHandled = Blockly.navigation.onKeyPress(this.mockEvent)
    ...
    test('Action exists - field handles action', function () {
      ...
      const isHandled = Blockly.navigation.onBlocklyAction(Blockly.navigation.ACTION_OUT)
