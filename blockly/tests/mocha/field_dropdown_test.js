...
suite("Dropdown Fields", function () {
  ...
  function assertValue(dropdownField, expectedValue, expectedText) {
    const actualValue = dropdownField.getValue();
    const actualText = dropdownField.getText();
  ...
  suite("Constructor", function () {
    ...
    test("Dynamic Dropdown Text", function () {
      const dynamicDropdownFunc = function () {
        return [
          ["a", "A"],
          ["b", "B"],
          ["c", "C"],
      ...
      const dropdownField = new Blockly.FieldDropdown(dynamicDropdownFunc);
      assertValue(dropdownField, "A", "a");
    });
  ...
  suite("fromJson", function () {
    ...
    test("Text Dropdown", function () {
      const dropdownField = Blockly.FieldDropdown.fromJson({
        options: [
          ["a", "A"],
          ["b", "B"],
          ["c", "C"],
