...
Blockly.Blocks.unittest_assertequals = {
  ...
  init: function () {
    ...
    this.appendValueInput("MESSAGE").appendField("name").setCheck("String");
    this.appendValueInput("ACTUAL").appendField("actual");
    this.appendValueInput("EXPECTED").appendField("expected");
...
Blockly.Blocks.unittest_adjustindex = {
  ...
  init: function () {
    this.jsonInit({
      ...
      colour: 65,
      tooltip:
        "Adjusts the value based on whether generated code is using " +
