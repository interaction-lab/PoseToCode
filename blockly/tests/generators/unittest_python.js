...
Blockly.Python.unittest_main = function (block) {
  ...
  const resultsVar = Blockly.Python.variableDB_.getName('unittestResults',
...
Blockly.Python.unittest_assertequals = function (block) {
  // Asserts that a value equals another value.
  const message = Blockly.Python.valueToCode(block, 'MESSAGE',
    Blockly.Python.ORDER_NONE) || ''
  const actual = Blockly.Python.valueToCode(block, 'ACTUAL',
    Blockly.Python.ORDER_NONE) || 'None'
  const expected = Blockly.Python.valueToCode(block, 'EXPECTED',
    Blockly.Python.ORDER_NONE) || 'None'
...
Blockly.Python.unittest_adjustindex = function (block) {
  let index = Blockly.Python.valueToCode(block, 'INDEX',
