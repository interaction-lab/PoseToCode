...
async function runGeneratorsInBrowser() {
  ...
  await runLangGeneratorInBrowser(browser, prefix + ".js", function () {
    toJavaScript();
  });
  await runLangGeneratorInBrowser(browser, prefix + ".py", function () {
    toPython();
  });
  await runLangGeneratorInBrowser(browser, prefix + ".dart", function () {
    toDart();
  });
  await runLangGeneratorInBrowser(browser, prefix + ".lua", function () {
    toLua();
  });
  await runLangGeneratorInBrowser(browser, prefix + ".php", function () {
    toPhp();
  });
