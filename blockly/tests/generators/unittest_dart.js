...
Blockly.Dart.unittest_main = function (block) {
  ...
  const resultsVar = Blockly.Dart.variableDB_.getName('unittestResults',
...
Blockly.Dart.unittest_assertequals = function (block) {
  // Asserts that a value equals another value.
  const message = Blockly.Dart.valueToCode(block, 'MESSAGE',
    Blockly.Dart.ORDER_NONE) || ''
  const actual = Blockly.Dart.valueToCode(block, 'ACTUAL',
    Blockly.Dart.ORDER_NONE) || 'null'
  const expected = Blockly.Dart.valueToCode(block, 'EXPECTED',
    Blockly.Dart.ORDER_NONE) || 'null'
...
Blockly.Dart.unittest_adjustindex = function (block) {
  let index = Blockly.Dart.valueToCode(block, 'INDEX',
