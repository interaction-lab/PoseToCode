...
Blockly.JavaScript.unittest_main = function (block) {
  ...
  const resultsVar = Blockly.JavaScript.variableDB_.getName(
    "unittestResults",
    Blockly.Names.DEVELOPER_VARIABLE_TYPE
  );
  const functionName = Blockly.JavaScript.provideFunction_("unittest_report", [
...
Blockly.JavaScript.unittest_main.defineAssert_ = function (block) {
  ...
  const functionName = Blockly.JavaScript.provideFunction_("assertEquals", [
    "function " +
...
Blockly.JavaScript.unittest_fail = function (block) {
  ...
  const message = Blockly.JavaScript.quote_(block.getFieldValue("MESSAGE"));
  const functionName = Blockly.JavaScript.provideFunction_("unittest_fail", [
    "function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(message) {",
    "  // Always assert an error.",
    "  if (!" + resultsVar + ") {",
