...
Blockly.JavaScript.unittest_main = function (block) {
  ...
  const resultsVar = Blockly.JavaScript.variableDB_.getName('unittestResults',
...
Blockly.JavaScript.unittest_assertequals = function (block) {
  ...
  const actual = Blockly.JavaScript.valueToCode(block, 'ACTUAL',
    Blockly.JavaScript.ORDER_COMMA) || 'null'
  const expected = Blockly.JavaScript.valueToCode(block, 'EXPECTED',
    Blockly.JavaScript.ORDER_COMMA) || 'null'
...
Blockly.JavaScript.unittest_adjustindex = function (block) {
  let index = Blockly.JavaScript.valueToCode(block, 'INDEX',
