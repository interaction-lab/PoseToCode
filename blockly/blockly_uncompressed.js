...
this.BLOCKLY_DIR = (function (root) {
  if (!root.IS_NODE_JS) {
    ...
    const re = new RegExp("(.+)[/]blockly_(.*)uncompressed.js$");
    for (var i = 0, script; (script = scripts[i]); i++) {
      const match = re.exec(script.src);
      if (match) {
        return match[1];
      }
    }
...
this.BLOCKLY_BOOT = function (root) {
  ...
  goog.addDependency(
    ...
    ["Blockly.utils.Svg", "Blockly.utils.dom"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.Component", "Blockly.Component.Error"],
    ["Blockly.utils.IdGenerator", "Blockly.utils.dom", "Blockly.utils.style"],
    {}
  );
  goog.addDependency(
    "../../core/connection.js",
  ...
  goog.addDependency(
    ...
    ["Blockly.constants", "Blockly.registry"],
    {}
  );
  goog.addDependency(
    "../../core/connection_db.js",
    ["Blockly.ConnectionDB"],
    ["Blockly.RenderedConnection", "Blockly.constants"],
    {}
  );
  ...
  goog.addDependency(
    "../../core/dropdowndiv.js",
    ["Blockly.DropDownDiv"],
    ["Blockly.utils.dom", "Blockly.utils.math", "Blockly.utils.style"],
    {}
  );
  goog.addDependency(
    "../../core/events.js",
    ["Blockly.Events"],
    ["Blockly.registry", "Blockly.utils"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.WorkspaceDragger", "Blockly.utils.object"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    "../../core/generator.js",
    ["Blockly.Generator"],
    ["Blockly.Block", "Blockly.constants"],
    {}
  );
  goog.addDependency(
    "../../core/gesture.js",
  ...
  goog.addDependency(
    "../../core/grid.js",
    ["Blockly.Grid"],
    ["Blockly.utils.Svg", "Blockly.utils.dom", "Blockly.utils.userAgent"],
    {}
  );
  goog.addDependency(
    "../../core/icon.js",
  ...
  goog.addDependency(
    "../../core/input.js",
    ["Blockly.Input"],
    ["Blockly.Connection", "Blockly.FieldLabel", "Blockly.constants"],
    {}
  );
  goog.addDependency(
    "../../core/insertion_marker_manager.js",
    ["Blockly.InsertionMarkerManager"],
    ["Blockly.Events", "Blockly.blockAnimations", "Blockly.constants"],
    { lang: "es5" }
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.ASTNode"],
    ["Blockly.constants", "Blockly.utils.Coordinate"],
    { lang: "es5" }
  );
  goog.addDependency(
    "../../core/keyboard_nav/basic_cursor.js",
    ["Blockly.BasicCursor"],
    ["Blockly.ASTNode", "Blockly.Cursor"],
    { lang: "es5" }
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.FlyoutCursor"],
    ["Blockly.Cursor", "Blockly.navigation", "Blockly.utils.object"],
    { lang: "es5" }
  );
  goog.addDependency(
    "../../core/keyboard_nav/key_map.js",
    ["Blockly.user.keyMap"],
  ...
  goog.addDependency(
    ...
    ["Blockly.Marker"],
    ["Blockly.ASTNode", "Blockly.navigation"],
    {}
  );
  goog.addDependency(
    "../../core/keyboard_nav/navigation.js",
    ["Blockly.navigation"],
    [
      "Blockly.ASTNode",
      "Blockly.Action",
  ...
  goog.addDependency(
    ...
    ["Blockly.TabNavigateCursor"],
    ["Blockly.ASTNode", "Blockly.BasicCursor", "Blockly.utils.object"],
    {}
  );
  goog.addDependency(
    "../../core/marker_manager.js",
    ["Blockly.MarkerManager"],
    ["Blockly.Cursor", "Blockly.Marker"],
    {}
  );
  goog.addDependency(
    "../../core/menu.js",
  ...
  goog.addDependency(
    "../../core/menuitem.js",
    ["Blockly.MenuItem"],
    ["Blockly.utils.IdGenerator", "Blockly.utils.aria", "Blockly.utils.dom"],
    {}
  );
  goog.addDependency(
    "../../core/msg.js",
  ...
  goog.addDependency(
    ...
    ["Blockly.blockRendering"],
    ["Blockly.registry", "Blockly.utils.object"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.blockRendering.ConstantProvider", "Blockly.utils.object"],
    { lang: "es5" }
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.blockRendering.ConstantProvider", "Blockly.utils.svgPaths"],
    { lang: "es5" }
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.geras", "Blockly.geras.RenderInfo"],
    [
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.ExternalValueInput",
  ...
  goog.addDependency(
    "../../core/renderers/geras/measurables/inputs.js",
  ...
  goog.addDependency(
    "../../core/renderers/measurables/connections.js",
    [
  ...
  goog.addDependency(
    "../../core/renderers/measurables/inputs.js",
    [
      "Blockly.blockRendering.ExternalValueInput",
      "Blockly.blockRendering.InlineInput",
  ...
  goog.addDependency(
    "../../core/renderers/measurables/row_elements.js",
    [
  ...
  goog.addDependency(
    "../../core/renderers/measurables/rows.js",
    [
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.InputRow",
      "Blockly.blockRendering.Row",
  ...
  goog.addDependency(
    ...
    ["Blockly.minimalist", "Blockly.minimalist.RenderInfo"],
    ["Blockly.utils.object"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    ...
    ["Blockly.thrasos", "Blockly.thrasos.RenderInfo"],
    [
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.ExternalValueInput",
      "Blockly.blockRendering.InlineInput",
  ...
  goog.addDependency(
    ...
    ["Blockly.zelos", "Blockly.zelos.RenderInfo"],
    [
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.ExternalValueInput",
      "Blockly.blockRendering.InlineInput",
  ...
  goog.addDependency(
    ...
    ["Blockly.zelos.StatementInput"],
    ["Blockly.blockRendering.StatementInput", "Blockly.utils.object"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    "../../core/renderers/zelos/measurables/rows.js",
    ["Blockly.zelos.BottomRow", "Blockly.zelos.TopRow"],
    [
      "Blockly.blockRendering.BottomRow",
      "Blockly.blockRendering.SpacerRow",
      "Blockly.blockRendering.TopRow",
  ...
  goog.addDependency(
    "../../core/scrollbar.js",
    ["Blockly.Scrollbar", "Blockly.ScrollbarPair"],
    [
      "Blockly.Touch",
      "Blockly.utils",
      "Blockly.utils.Coordinate",
  ...
  goog.addDependency(
    "../../core/theme/highcontrast.js",
    ["Blockly.Themes.HighContrast"],
    ["Blockly.Theme"],
    {}
  );
  goog.addDependency(
    "../../core/theme/modern.js",
  ...
  goog.addDependency(
    ...
    ["Blockly.ToolboxSeparator"],
    ["Blockly.ToolboxItem", "Blockly.registry", "Blockly.utils.dom"],
    { lang: "es5" }
  );
  goog.addDependency(
  ...
  goog.addDependency(
    "../../core/utils/dom.js",
    ["Blockly.utils.dom"],
    ["Blockly.utils.Svg", "Blockly.utils.userAgent"],
    {}
  );
  goog.addDependency(
  ...
  goog.addDependency(
    "../../core/utils/style.js",
    ["Blockly.utils.style"],
    ["Blockly.utils.Coordinate", "Blockly.utils.Size"],
    {}
  );
  ...
  goog.addDependency(
    ...
    ["Blockly.VariableModel"],
    ["Blockly.Events", "Blockly.Events.VarCreate", "Blockly.utils"],
    {}
  );
  goog.addDependency(
    "../../core/variables.js",
  ...
  goog.addDependency(
    ...
    ["Blockly.WorkspaceDragSurfaceSvg"],
    ["Blockly.utils", "Blockly.utils.Svg", "Blockly.utils.dom"],
    {}
  );
  goog.addDependency(
...
if (this.IS_NODE_JS) {
  ...
  document.write(
    '<script src="' + this.BLOCKLY_DIR + '/closure/goog/base.js"></script>'
  );
