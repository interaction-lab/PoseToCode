...
Blockly.Mutator.prototype.createEditor_ = function () {
  ...
  */
  ...
  if (hasFlyout) {
    workspaceOptions.languageTree = Blockly.utils.toolbox.convertToolboxDefToJson(
      quarkXml
    );
  ...
  const flyoutSvg = hasFlyout
    ? this.workspace_.addFlyout(Blockly.utils.Svg.G)
    : null;
...
Blockly.Mutator.prototype.setVisible = function (visible) {
  ...
  if (visible) {
    ...
    if (this.block_.saveConnections) {
      ...
      const mutatorBlock = /** @type {{saveConnections: function(!Blockly.Block)}} */ (this
        .block_);
