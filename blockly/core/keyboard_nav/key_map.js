...
Blockly.user.keyMap.setActionForKey = function (keyCode, action) {
  const oldKey = Blockly.user.keyMap.getKeyByAction(action)
...
Blockly.user.keyMap.getKeyByAction = function (action) {
  const keys = Object.keys(Blockly.user.keyMap.map_)
...
Blockly.user.keyMap.serializeKeyEvent = function (e) {
  const modifiers = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys)
  let key = ''
...
Blockly.user.keyMap.createSerializedKey = function (keyCode, modifiers) {
  let key = ''
  const validModifiers = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys)
