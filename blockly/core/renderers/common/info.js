...
Blockly.blockRendering.RenderInfo.prototype.populateTopRow_ = function () {
  ...
  const hasHat =
    ...
    !hasPrevious;
  const leftSquareCorner = this.topRow.hasLeftSquareCorner(this.block_);
  ...
  const rightSquareCorner = this.topRow.hasRightSquareCorner(this.block_);
...
Blockly.blockRendering.RenderInfo.prototype.makeSpacerRow_ = function (
  ...
  const spacer = new Blockly.blockRendering.SpacerRow(
    this.constants_,
    height,
    width
  );
