...
Blockly.blockRendering.ConstantProvider.prototype.setDynamicProperties_ =
  ...
  this.ADD_START_HATS = theme.startHats != null
? theme.startHats
      : this.ADD_START_HATS
...
Blockly.blockRendering.ConstantProvider.prototype.setFontConstants_ = function (
  ...
  const fontMetrics = Blockly.utils.dom.measureFontMetrics('Hg',
...
Blockly.blockRendering.ConstantProvider.prototype.makeOutsideCorners = function () {
   ...
   * @const
   */
  const bottomLeft = Blockly.utils.svgPaths.arc('a', '0 0,1', radius,
    Blockly.utils.svgPaths.point(-radius, -radius))
   ...
   * @const
   */
  const bottomRight = Blockly.utils.svgPaths.arc('a', '0 0,1', radius,
    Blockly.utils.svgPaths.point(-radius, radius))
