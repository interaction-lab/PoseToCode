...
Blockly.blockRendering.ConstantProvider.prototype.setFontConstants_ = function (
  ...
  const fontMetrics = Blockly.utils.dom.measureFontMetrics(
    "Hg",
...
Blockly.blockRendering.ConstantProvider.prototype.validatedBlockStyle_ = function (
  ...
  const valid = /** @type {!Blockly.Theme.BlockStyle} */ ({});
  if (blockStyle) {
    Blockly.utils.object.mixin(valid, blockStyle);
  }
  // Validate required properties.
  const parsedColour = Blockly.utils.parseBlockColour(
...
Blockly.blockRendering.ConstantProvider.prototype.makeInsideCorners = function () {
  ...
  const innerTopLeftCorner = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,0",
    radius,
  ...
  const innerBottomLeftCorner = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,0",
    radius,
    Blockly.utils.svgPaths.point(radius, radius)
...
Blockly.blockRendering.ConstantProvider.prototype.makeOutsideCorners = function () {
   ...
   * @const
   */
  const bottomLeft = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,1",
    radius,
    Blockly.utils.svgPaths.point(-radius, -radius)
...
Blockly.blockRendering.ConstantProvider.prototype.createDom = function (
  ...
  */
  const embossFilter = Blockly.utils.dom.createSvgElement(
  ...
  const feSpecularLighting = Blockly.utils.dom.createSvgElement(
  ...
  */
  ...
  if (Blockly.blockRendering.Debug) {
    const debugFilter = Blockly.utils.dom.createSvgElement(
      Blockly.utils.Svg.FILTER,
      {
    ...
    const debugComponentTransfer = Blockly.utils.dom.createSvgElement(
...
Blockly.blockRendering.ConstantProvider.prototype.injectCSS_ = function (
  ...
  this.cssNode_ = /** @type {!HTMLStyleElement} */ (document.getElementById(
    cssNodeId
  ));
  ...
  const cssNode = /** @type {!HTMLStyleElement} */ (document.createElement(
    "style"
  ));
 ...
 * @protected
 */
Blockly.blockRendering.ConstantProvider.prototype.getCSS_ = function (
  selector
) {
  return [
    /* eslint-disable indent */
