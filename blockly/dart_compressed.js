...
(function (root, factory) {
  ...
  Blockly.Dart.lists_getIndex = function (a) {
    function b() {
      var f = Blockly.Dart.variableDB_.getDistinctName(
          "tmp_list",
          Blockly.VARIABLE_CATEGORY_NAME
        ),
        g = "List " + f + " = " + e + ";\n";
  ...
  Blockly.Dart.lists_setIndex = function (a) {
    function b() {
      if (e.match(/^\w+$/)) return "";
      var g = Blockly.Dart.variableDB_.getDistinctName(
          "tmp_list",
          Blockly.VARIABLE_CATEGORY_NAME
        ),
        k = "List " + g + " = " + e + ";\n";
  ...
  Blockly.Dart.procedures_defreturn = function (a) {
    ...
    for (
      var k = f ? "dynamic" : "void", l = [], m = a.getVars(), h = 0;
      h < m.length;
      h++
    )
      l[h] = Blockly.Dart.variableDB_.getName(
        m[h],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    c = k + " " + b + "(" + l.join(", ") + ") {\n" + c + d + e + g + f + "}";
