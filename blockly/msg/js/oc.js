...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "passar a l’iteracion de bocla seguenta";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Aquesta foncion a d'entradas duplicadas.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Podètz pas utilizar un nom de variabla void.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Renvia lo primièr element dins una lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Renvia l'element de la posicion especificada dins la lista.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Renviar verai se las doas entradas son egalas.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Renviar verai se las doas entradas son diferentas.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Renviar verai se las doas entradas son vertadièras.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://oc.wikipedia.org/wiki/Aritmetica";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Renvia lo logaritme decimal d’un nombre.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Renvia lo cosinus d’un angle en grases (pas en radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Renvia lo sinus d’un angle en grases (pas en radians).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Renvia la tangenta d’un angle en grases (pas en radians).";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE =
  "en Majuscula Al Començament De Cada Mot";
