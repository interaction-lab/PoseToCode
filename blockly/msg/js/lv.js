...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Sajauc kopā divas krāsas ar doto attiecību (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Izveidot krāsu ar norādīto daudzumu sarkanā, zaļā un zilā toņu. Visas vērtības ir starp 0 un 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "turpināt ar cikla nākamo iterāciju";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Iet ārā no iekļaujošā cikla";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Nepildīt atlikušo cikla daļu bet sākt nākamo iterāciju.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Brīdinājums: šo bloku drīkst izmantot tikai cikla iekšienē.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Katram objektam no saraksta piešķirt mainīgajam '%1' šo objektu un izpildīt komandas.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Ļauj mainīgajam '%1' pieņemt vērtības no sākuma līdz beigu vērtībai, un izpildīt iekļautos blokus katrai no šīm pieņemtajām vērtībām.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Pievienot, noņemt vai mainīt sekciju secību šim "ja" blokam.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Ja vērtība ir patiesa, tad izpildīt komandas.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Ja vērtība ir patiesa, tad izpildīt pirmo bloku ar komandām. Citādi izpildīt otro bloku ar komandām.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Ja pirmā vērtība ir patiesa, tad izpildīt pirmo bloku ar komandām. Citādi, ja otrā vērtība ir patiesa, izpildīt otro bloku ar komandām.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Ja pirmā vērtība ir patiesa, tad izpildīt pirmo bloku ar komandām. Citādi, ja otrā vērtība ir patiesa, izpildīt otro bloku ar komandām. Ja neviena no vertībām nav patiesa, tad izpildīt pēdējo bloku ar komandām.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Izpildīt komandas, kamēr vērtība ir nepatiesa.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Izpildīt komandas, kamēr vērtība ir patiesa.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  'Mainīgais "%2" tiek izmantots %1 vietās. Dzēst?';
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Izveidot sarakstu no jebkura skaita vienību.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "paņemt apakšsarakstu no beigām no pozīcijas";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START =
  "paņemt apakšsarakstu no pozīcijas";
Blockly.Msg.LISTS_GET_SUBLIST_TAIL = ""; // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP = "Nokopēt daļu no dotā saraksta.";
Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP =
  "Saraksta elementu numerācija no beigām sākas no %1";
Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP =
  "Saraksta elementu numerācija sākas no %1";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Atgriež pozīciju sarakstā, kurā atrodas dotais objekts.  Atgriež %1 ja objekts neatrodas sarakstā.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Izveido sarakstu, kas sastāv no dotās vērtības noteiktu reižu skaita.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Ievieto elementu saraksta sākumā.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Ievieto sarakstā elementu norādītajā pozīcijā.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Ievieto sarakstā jaunu elementu nejauši izvēlētā pozīcijā.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Aizvieto elementu saraksta sākumā.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Aizvieto sarakstā elementu norādītajā pozīcijā.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Aizvieto elementu saraksta beigās.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Aizvieto sarakstā elementu nejauši izvēlētā pozīcijā.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Sadalīt tekstu vārdos izmantojot atdalītāju.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://lv.wikipedia.org/wiki/Nevien%C4%81d%C4%ABba";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Patiess, ja abas puses ir vienādas.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Patiess, ja kreisā puse ir lielāka par labo pusi.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Patiess, ja kreisā puse ir lielāka vai vienāda ar labo pusi.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Patiess, ja kreisā puse ir mazāka par labo pusi.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Patiess, ja kreisā puse ir mazāka vai vienāda ar labo pusi.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Patiess, ja vismaz viena puse ir patiesa.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Pārbaudīt nosacījumu. Ja 'nosacījums' ir patiess, atgriež vērtību 'ja patiess', pretējā gadījumā vērtību 'ja aplams'.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://lv.wikipedia.org/wiki/Aritm%C4%93tika";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Atgriež divu skaitļu reizinājumu.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Atgriež pirmo skaitli kāpinātu pakāpē otrais skaitlis.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Atgriež kādu no matemātikas konstantēm: π (3.141…), e (2.718…), φ (1.618…), √(2) (1.414…), √(½) (0.707…), ∞ (bezgalība).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Ierobežo skaitli no noteiktajās robežās (ieskaitot galapunktus).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Pārbauda, vai skaitlis ir pāra, nepāra, vesels, pozitīvs, negatīvs vai dalās ar noteiktu skaitli. Atgriež "patiess" vai "aplams".';
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Atgriež nejaušu reālo skaitli robežās no 0 (iekļaujot) līdz 1 (neiekļaujot).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Atgriež nejaušu veselu skaitli dotajās robežās (iekļaujot galapunktus)";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Atgriež skaitļa logaritmu pie bāzes 10.";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Izpildīt iepriekš definētu funkcju '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Izpildīt iepriekš definētu funkcju '%1' un izmantot tās rezultātu.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Izveido funkciju, kas neatgriež rezultātu.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Pievienot, pārkārtot vai dzēst funkcijas argumentus.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Atgriež teksta kopiju ar mainītiem lielajiem/mazajiem burtiem.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  'Pievienot, noņemt vai mainīt sekciju secību šim "teksta" blokam.';
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "paņemt apakšvirkni no beigām sākot ar burta nr";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "paņemt apakšvirkni sākot no burta nr";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST =
  "meklēt pirmo vietu, kur sākas teksts";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "meklēt pēdējo vietu, kur sākas teksts";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Atgriež teksta kopiju ar noņemtām atstarpēm vienā vai otrā galā.";
