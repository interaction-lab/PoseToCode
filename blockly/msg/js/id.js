...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  "Tambahkan prasyarat ke dalam blok IF.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Lakukan beberapa perintah beberapa kali.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Kembalikan item terakhir dalam list.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Kembalikan item acak dalam list.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Hapus item terakhir dalam list.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Buat salinan bagian tertentu dari list.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Menetapkan item terakhir dalam list.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Kembalikan dasar logaritma 10 dari angka.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Buat sebuah fungsi dengan satu output.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Kembalikan spesifik bagian dari teks.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Kembalikan benar jika teks yang disediakan kosong.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Buat teks dengan cara gabungkan sejumlah item.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Meminta pengguna untuk memberi sebuah angka.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT =
  "Meminta pengguna untuk memberi beberapa teks.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "tetapkan variabel ini dengan input yang sama.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Sebuah variabel dengan nama '%1' sudah ada.";
