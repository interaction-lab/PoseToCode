...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Ni mogoče izbrisati spremenljivke »%1«, ker je uporabljena v definiciji funkcije »%2«";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Zmeša dve barvi v danem razmerju (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Ustvari barvo z določeno količino rdeče, zelene in modre. Vse vrednosti morajo biti med 0 in 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Izstopi iz trenutne zanke.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Preskoči preostanek te zanke in nadaljuje z naslednjo ponovitvijo.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Pozor: Ta delček lahko uporabiš samo znotraj zanke.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Za vsak element v seznamu, nastavi spremenljivko »%1« na ta element. Pri tem se izvedejo določeni delčki.";
Blockly.Msg.CONTROLS_FOR_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#count-with";
Blockly.Msg.CONTROLS_FOR_TITLE = "štej s/z %1 od %2 do %3 po %4";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Vrednost spremenljivke »%1« se spreminja od začetnega števila do končnega števila, z določenim korakom. Pri tem se izvedejo določeni delčki.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Dodaj, odstrani ali spremeni vrstni red odsekov za ponovno nastavitev »če« delčka.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Če je vrednost resnična, izvedi določene delčke.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Če je vrednost resnična, izvedi prvo skupino delčkov. Sicer izvedi drugo skupino delčkov.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Če je prva vrednost resnična, izvedi prvo skupino delčkov. Sicer, če je resnična druga vrednost, izvedi drugo skupino delčkov.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Če je prva vrednost resnična, izvedi prvo skupino delčkov. Sicer, če je resnična druga vrednost, izvedi drugo skupino delčkov. Če nobena izmed vrednosti ni resnična, izvedi zadnjo skupino delčkov.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Delčki se izvajajo dokler je vrednost neresnična.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Delčki se izvajajo dokler je vrednost resnična.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Izbrišem %1 uporab spremenljivke »%2«?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ta funkcija ima podvojene vnose";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Ne moreš uporabiti spremenljivke brez imena.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Doda, odstrani ali spremeni vrstni red elementov tega seznama.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Odstrani in vrne prvi element seznama.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Odstrani in vrne zadnji element seznama.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Odstrani in vrne naključni element seznama.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Odstrani zadnji element seznama.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Odstrani naključni element seznama.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "ustvari podseznam od mesta št. od konca";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START =
  "ustvari podseznam od mesta št.";
Blockly.Msg.LISTS_GET_SUBLIST_TAIL = ""; // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Ustvari nov seznam, kot kopijo določenega dela seznama.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Vrne mesto (indeks) prve/zadnje pojavitve elementa v seznamu. Če elementa ne najde, vrne %1.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "ustvari seznam z elementom %1, ki se ponovi %2 krat";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Ustvari seznam z danim elementom, ki se poljubno mnogo krat ponovi.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Vstavi element na začetek seznama.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Nastavi element na določenem mestu v seznamu.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Nastavi zadnji element seznama.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Nastavi naključni element seznama.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Združi seznam besedil v eno besedilo, ločeno z ločilom.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Razdruži besedilo v seznam besedil. Za razdruževanje besedila uporabi ločilo.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Vrne resnično, če je prvi vnos večji od drugega.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Vrne resnično, če je prvi vnos večji ali enak drugemu.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Vrne resnično, če je prvi vnos manjši od drugega.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Vrne resnično, če je prvi vnos manjši ali enak drugemu.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Vrne resnično, če je vnos neresničen. Vrne neresnično, če je vnos resničen.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Vrne resnično, če sta oba vnosa resnična.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Vrne resnično, če je vsaj eden od vnosov resničen.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Preveri pogoj v »testu«. Če je pogoj resničen, potem vrne vrednost »če resnično«; sicer vrne vrednost »če neresnično«.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Vrne arkus tangens točke (X, Y) v stopinjah med -180 in 180.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Vrne eno izmed običajnih konstant: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ali ∞ (neskončno).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Omeji število, da bo med določenima (vključenima) mejama.";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Preveri, če je število sodo, liho, praštevilo, celo, pozitivno, negativno ali, če je deljivo z določenim številom. Vrne resnično ali neresnično.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Vrne povprečje (aritmetično sredino) števil na seznamu.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Vrne seznam najpogostejšega elementa(-ov) na seznamu.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Vrne naključno število izmed števil na seznamu.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Vrne naključni ulomek med (vključno) 0.0 in 1.0 (izključno).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Vrne naključno število med dvema določenima mejama, vključno z mejama.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Vrne kosinus kota v stopinjah (ne radianih).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Vrne sinus kota v stopinjah (ne radianih).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Vrne tangens kota v stopinjah (ne radianih).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Izvede uporabniško funkcijo '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Izvede uporabniško funkcijo '%1' in uporabi njen izhod.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Doda, odstrani ali spremeni vrstni red vnosov te funkcije.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Prešteje kolikokrat se neko besedilo pojavi znotraj drugega besedila.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Doda, odstrani ali spremeni vrstni red elementov tega besedila.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Vrne mesto (indeks) prve/zadnje pojavitve drugega besedila v prvem besedilu. Če besedila ne najde, vrne %1.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Vrne resnično, če je določeno besedilo prazno.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Zamenja vse pojavitve besedila znotraj drugega besedila.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Vrne kopijo besedila z odstranjenimi presledki z ene ali obeh strani.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Nastavi, da je vrednost spremenljivke enaka vnosu.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "Spremenljivka »%1« že obstaja.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Spremenljivka z imenom »%1« že obstaja za tip »%2«";
