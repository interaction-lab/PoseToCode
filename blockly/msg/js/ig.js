...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Agaghị ekpochapụlị agbanwe '%1' maka nsonye ya na nkọwa nke ọrụ ahụ '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Na ngwakọta agba abụọ ọnụ na na oke enyere (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Mepụta agba nwere ọnụ ọgụgụ kpọmkwem nke agba uhie, akwụkwọ ndụ, na akara niile ga-adịrịrị n'etiti 0 rụọ 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "malite na nsoghari nke meghachi ozo";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Gba puo na gburugburu nke ọdị n’ime ya.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Wụọ mkpụchị meghachi ndị a fọdụrụ, ma gaa n'ihu na nsoghari nke aka.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Ịdọ aka ná ntị: Enwere ike iji ngọngọ a naanị n'ime meghachi.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Maka ihe ọ bụla n'ime ndepụta, debe agbanwe '%1' na ihe ahụ, wee degharịa ụfọdụ koodu.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Nwere ngwakọta '%1' na akara ọbụla sịte na mbịdo ọnụọgụgụ rụọ na ngwụcha ọnụọgụgụ, na-ngụta sịtere na nkeji oge kpọmkwem. megharịa koodu oge ọbụla:";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Tinye ọnọdụ na ngọngọ ma ọ bụrụ.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Tinye ngwucha, ọnọdụ jide-niile na ngọngọ ma ọ bụrụ.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Tinye, wepu, ma ọ bụ megharia ngalaba iji haziearịa nke a ma ọ bụrụ na ngọngọ.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Ọ bụrụ na akara bụ ezịọkwụ, mezie ụfọdụ okwu.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Ọ bụrụ na akara bụ ezịọkwụ, mezie ngọngọ mbụ nke okwu. Ma ọ bụghị ya, mezie ngọngọ nke abụọ nke okwu.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Ọ bụrụ na akara mbụ bụ ezịọkwụ, mezie ngọngọ mbụ nke okwu. Ma ọ bụghị ya, ọ bụrụ na akara nke abụọ bụ ezịọkwụ, mee ngọngọ nke abụọ nke okwu.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Ọ bụrụ na akara mbụ bụ ezịọkwụ, mezie ngọngọ mbụ nke okwu. Ma ọ bụghị ya, ọ bụrụ na akara nke abụọ bụ ezịọkwụ, mee ngọngọ nke abụọ nke okwu. Ọ bụrụ na onweghị akara bụ ezịọkwụ, mee ngọngọ okwu ikpeazụ.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Ọ bụ ebe akara bụ ụgha, megharịa ụfọdụ koodu.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Ọ bụ ebe akara bụ ezịọkwụ, megharịa ụfọdụ koodu.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Kpochapụ %1 ojịjị nke agbanwe '%2'?";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Ị nweghị ike iji aha agbanwe dị n’efu.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Tinye, wepu, ma ọ bụ megharia ngalaba iji haziearia ngọngọ ederede a.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Weghachitere ihe na ọnọdụ a kapịrị ọnụ na ndepụta.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Weghachitere ihe ikpeazụ n'ime ndepụta.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Wepu ma weghachite ihe mbu na ndepụta.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Wepu ma weghachite ihe na ọnọdụ a kapịrị ọnụ na ndepụta.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Wepu ihe mbụ n'ime ndepụta.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Wepu ihe ahụ na ọnọdụ a kapịrị ọnụ na ndepụta.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "nweta akụkụ ndepụta site na # site na njedebe";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START =
  "nweta akụkụ ndepụta site na #";
Blockly.Msg.LISTS_GET_SUBLIST_TAIL = ""; // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Na-emepụta otu akụkụ a kapịrị ọnụ nke ndepụta.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Weghachitere ntughari nke mbụ / nke ikpeazụ nke ihe dị na ndepụta. Weghachitere %1 ma ọ bụrụ na achọtaghị ihe.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Weghachite eziokwu ma ọ bụrụ na ndepụta ahụ dị n’efu.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "mepụta ndepụta na ihe %1 emegharịrị ugboro %2";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Na-emepụta listi ndepụta gụnyere akara a nyere ya ugboro ugboro.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Jikọọ ndepụta nke ederede gaa na otu ederede, nke oihe nkewa kewara.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Kewaa ederede n'ime ndepụta nke ederede, na-agbasa na ihe nkwea ọ bụla.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye hatara onwe ha.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye mbu dị ụkwụụ karia ntinye nke abụọ.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye mbu dị ụkwụụ karia ma ọ bụ hatara ntinye nke abụọ.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye mbu dị obere karia ntinye nke abụọ.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye mbu dị obere karia ma ọ bụ hatara ntinye nke abụọ.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Weghachitere ezịọkwụ ma ọ bụrụ na ntinye bụ ụgha. Weghachitere ụgha ma ọ bụrụ na ntinye bụ ezịọkwụ.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Weghachi ezịọkwụ ma ọ bụrụ na ntinye abụọ a bụ ezịọkwụ.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Weghachi ezịọkwụ ma ọ bụrụ na ọdịkarịa ala otu n’ime ntinye a bụ ezịọkwụ.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Lelee ọnọdụ na 'ule'. Ọ bụrụ na ọnọdụ ahụ bụ eziokwu, weghachitere akara 'ọ bụrụ na eziokwu’; ma ọ bụghị ya weghachitere akara 'ọ bụrụ ụgha'.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://en.wikipedia.org/wiki/Arithmetic";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD =
  "Weghachite ngụkọ ọnụ ọgụgụ abụọ ahụ.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Weghachite kwenye ọnụ ọgụgụ abụọ ahụ.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Weghachite nwepụ ọnụ ọgụgụ abụọ ahụ.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Weghachite mụbaa ọnụ ọgụgụ abụọ ahụ.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Weghachite nọmba mbu nke emeturu ike nke nọmba nke abụọ.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 nke X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Weghachite aktanjentị nke isi (X, Y) na ogo site na -180 rụọ 180.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Weghachite otu n'ime kọnstant ndị nkịtị: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (infinity).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Gbochịe ọnụọgụgụ dị n'etiti nọmba dị oke ala na nọmba dị oke elu (gụnyere).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Tụlee ma nọmba ọ bụ ịvụn, ọd, praim, zuru ezu, posịtịf, negetịf, ma e nwere nọmba ga ekenwu ya. Weghachitere eziokwu ma ọ bụ ụgha.";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Weghachite ihe fọdụrụ site na nkewa nọmba abụọ.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Weghachite agbaetiti (nchịkọta mpụta) nke akara ọnụọgụ na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Weghachite nọmba kacha ukwuu na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  "Weghachite nọmba agbaetiti na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Weghachite nọmba kacha obere na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Weghachite ndepụta nke nke ihe kachasị mkpa na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Weghachite Ihe ọbụla site na ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Weghachite ntughari usoro nke ndepụta.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Weghachite nchịkọta nke nọmba niile na ndepụta.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Weghachite ọnụọgụgụ ọbụla dị n'etiti 0.0 (gụnyere) na 1.0 (agụnyeghị).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Weghachite ọnụọgụgụ ọbụla dị n'etiti ihe abụọ a kapịrị ọnụ, agụnyere.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Weghachite isi lọgarịdịm 10 nke nọmba.";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Gbaa ọrụ a kọwaa onye-ọrụ '%1' ma jiri mmepụta ya.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Na emepụta ọrụ na-enweghị mmepụta.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Ịdọ aka ná ntị: Ọrụ a nwere ọnụọgụ abụọ.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Tinye, wepu, ma ọ bụ tugharịa ntinye na ọrụ a.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Weghachite akwụkwọ ozi ahụ na ọnọdụ a kapịrị ọnụ.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Gụọ ugboro ole ụfọdụ ederede na’apụta n’ụfọdụ ederede ọzọ.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END =
  "na akwụkwọ ozi # site na njedebe";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "nweta njịkọ-ala na akwụkwọ ozi mbu";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "nweta njịkọ-ala na akwụkwọ ozi # site na njedebe";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "nweta njịkọ-ala na akwụkwọ ozi #";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = ""; // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Weghachite akụkụ nke akọwapụtara ederede.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Weghachitere ezịọkwụ ma ọ bụrụ na ederede enyere di n’efu.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Mepụta otu ederede site na ijikọta ọnụ ọgụgụ ihe ọ bụla.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "ogologo nke %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Weghachitere nọmba nke akwụkwọ ozi (gụnyere oghere) na ederede enyere.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Bipụta ederede a kapịrị ọnụ, nọmba ma ọ bụ akara ọzọ.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Dochie ihe omuma nke ederede ufodu n'ime ufodu ederede ozo.";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH =
  "belata oghere dị mkpụmkpụ si n'akụkụ abụọ nke";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT =
  "belata oghere dị mkpụmkpụ si n'akụkụ aka ịkpa nke";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT =
  "belata oghere dị mkpụmkpụ si n'akụkụ aka nrị nke";
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Weghachite otu ederede ya na oghere ọzọ wepụrụ site n'otu ma ọ bụ akụkụ mechị abụọ.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Agbanwe akpọrọ '%1' dị adị na ụdị ozo: '%2'.";
