...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "ииастәуп ацикл анаҩстәи ашьаҿахьы";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Агәҽанҵара:Ари аблок ахархәара амоуп ацикл аҩныҵҟа мацара.";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  'Иацнаҵоит аҭагыазаашьа аблок "акәзар" ахь';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Аҭагылазаашьа иашазар, инанагӡоит акомандақәа.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Аҭагылазаашьа иашазар, инанагӡоит актәи аблок акомандақәа. Акәымзар инанагӡоит аҩбатәи аблок акомандақәа.";
...
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://ru.wikipedia.org/wiki/Ацикл_(апрограммаркра)";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Аҭагылазаашьа мцнаҵы, инанагӡалоит акомандақәа.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Аҭагылазаашьа иашанаҵ, инанагӡалоит акомандақәа.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Шәара ишәылшом аҽеиҭак азы иҭацәу ахьӡ ахархәара";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Иҳанаҭоит ахьӡынҵа актәи аелемент.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Иҳанаҭоит ахьӡынҵа аҵыхәтәантәи аелемент.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Иҳанаҭоит ахьӡынҵа иарбанзаалакь елементк.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Ианнахәуеит ахьӡынҵа актәи аелемент.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Ианнахәуеит ахьӡынҵа аҵыхәтәантәи аелемент.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Ианнахәуеит ахьӡынҵа иарбанзаалакь елементк.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Иацнаҵоит аелемент ахьӡынҵа анҵәамҭахь.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Иҳанаҭоит иҵоуроу аҵакы, иҭагалақәоу еиҟаразар.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Иҳанаҭоит аҵакы аиаша, актәи иҭагалоу аҩбатәи аасҭа еиҳазар.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Иҳанаҭоит аҵакы аиаша, актәи иҭагалоу аҩбатәи аасҭа еиҳазар ма иаҟаразар.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Иҳанаҭоит иҵоуроу аҵакы, актәи иҭагалоу аҩбатәи аасҭа еиҵазар.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Иҳанаҭоит аҵакы аиаша, актәи иҭагалоу аҩбатәи аасҭа еиҵазар ма иаҟаразар.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Иҳанаҭоит иҵоуроу аҵакы, иҭагалақәоу еиҟарамзар.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Иҳанаҭоит аҵакы аиаша, иҭагалоу мцызар. Иҳанаҭоит аҵакы амц, иҭагалоу иашазар.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Иҳанаҭоит аҵакы аиаша, иҭагалоу аҩбагьы иашазар.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Иҳанаҭоит аҵакы аиаша, иҭагалоу руак иашазар.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Иҳанаҭоит ҩ-хыҧхьаӡарак реигырхалыҵ.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Иҳанаҭоит ҩ-хыҧхьаӡарак рышьҭыхлыҵ.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://ru.wikipedia.org/wiki/Аматематикатә_константа";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Иҳанаҭооит аконстантақәа руак: π (3.141...), e (2.718...), φ (1.618...), sqrt(2) (1.414...), sqrt(½) (0.707...) ма ∞ (аҵыхәаҧҵәарадара).";
...
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://ru.wikipedia.org/wiki/Ашара_цәынхала";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Иҳанаҭоит ахьӡынҵа аҟны ахыҧхьаӡарақәа зегьы рарифметикатә бжьара.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Иҳанаҭоит ахьӡынҵа аҟны иреиҳау ахыҧхьаӡара.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Иҳанаҭоит ахьӡынҵа аҟны иреицо ахыҧхьаӡара.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Иҳанаҭоит ахьӡынҵа аҟны иарбанзаалакь елементк.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Иҳанаҭоит ахьӡынҵа иаҵанакуа ахыҧхьаӡарақәа зегьы реицҵалыҵ.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM =
  "иарбанзаалакь ахыҧхьашара 0 инаркны (иалаҵаны)  1 аҟынӡа";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Иҳанаҭоит иарбанзаалакь ахыҧхьаӡара 0.0 инаркны (иалаҵаны) 1.0 аҟынӡа.";
Blockly.Msg.MATH_RANDOM_INT_HELPURL =
  "https://en.wikipedia.org/wiki/Random_number_generation"; // untranslated
Blockly.Msg.MATH_RANDOM_INT_TITLE =
  "иарбанзаалакь еибгоу ахыҧхьаӡара %1 инаркны %2 нӡа";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Иҳанаҭоит ахыҧхьаӡара иҧсабаратәу алагорифм.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Иҳанаҭоит ахыҧхьаӡара ажәабатә логари̓фм";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://ru.wikipedia.org/wiki/Атригонометриатә_функциақәа";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://ru.wikipedia.org/wiki/Ацхыраагӡатә программа";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Иаҧнаҵоит апроцедура, аҵакы ҳазымҭо.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Актәи аҵакы иашазар, иҳанаҭоит аҩбатәи аҵакы.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Агәаҽанҵара: Ари аблок ахархәара ауеит афункциа аҧҵара аҟны.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Иҳанаҭоит аҵакы аиаша, иҟоу атеқст ҭацәызар.";
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Иҳанаҭоит асимволқәа рхыҧхьаӡара (апробелқәа алаҵаны) иҟоу атеқст аҟны.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Иакьыҧхьуеит атеқст, ахыҧхьаӡара ма даҽа обиеқтк.";
