...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Şıma renganê sûr, aşıl u kohoy ra rengê do spesifik vırazê. Gani ê pêro 0 u 100 miyan de bıbê.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "Gama bin da çerxeni ra dewam ke";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Öujtewada çerxeni ra bıvıci";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Diqat: No bloke şeno teyna yew çerxiyayış miyan de bıgırweyo.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Yew lista de her item rê, varyansê '%1' itemi rê vırazê, u dıma tayê akerdışi (beyani) bıdê";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "Pê amarêno %1 %2 ra %3 rê , herg gam de %4 vurnayışi";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Eger yew vaye raşto, o taw şıma tayê akerdışi kerê.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Yew erc raşto se yu beyanat bıd.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "%1 ke vırnayışê '%2'i gırweneno, besteriyo?";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Heruna nameyê curnekari veng mevıradê.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Debiyaye dı erci zey pêyêse ercê "True" dane.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Eger her dı cıkewtışi zi raştê, şıma ageyrê.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Şerta'test'i test keno.  Eger ke şert raşta se erca 'raşt'i çarneno, çepo se erca 'çep'  çarneno.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Sabitanê wertağan ra yew açarne: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (bêpeyniye).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Liste ra yew elemento rastameye açarne.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Logaritmay 10i yew amari rê peyser tadê";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://diq.wikipedia.org/wiki/Fonksiyonê_trigonometriye";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Yew fonksiyono çap nêdate vırazeno";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Tembe: Nê fonksiyoni de parametreyê dıleti estê.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "rêza bınêne herfa # peyêne ra bıgê";
