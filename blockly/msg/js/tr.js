...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "'%1' değişkeni, '%2' fonksiyonunun tanımının bir parçası olduğu için silinemez";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Verilen bir orana (0.0 - 1.0) bağlı olarak iki rengi karıştırır.";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Kırmızı, yeşil ve mavinin belirli miktarıyla bir renk oluştur.  Tüm değerler 0 ile 100 arasında olmalıdır.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Uyarı: Bu blok yalnızca bir döngü içinde kullanılabilir.";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "ile sayılır %1 %2 den %3 ye, her adımda %4 değişim";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Başlangıç sayısından bitiş sayısına kadar belirtilen aralık ve belirtilen engeller ile devam eden değerler alan '%1' değişkeni oluştur.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "If bloğuna bir koşul ekleyin.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'If bloğuna kalan durumları "yakalayan" bir son ekle.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "If bloğuna ekle, kaldır veya yeniden düzenleme yap.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Eğer değişken true, yani gerçekleşmiş ise ardından gelen işlemi yerine getir.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Eğer değişken true, yani gerçekleşiyor ise ilk bloktaki işlemleri yerine getir. Aksi halde ikinci bloktaki işlemleri yerine getir.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Eğer ilk değişken true, yani koşul gerçekleşmiş ise ilk blok içerisindeki işlemi gerçekleştir. Eğer ikinci değişken true ise, ikinci bloktaki işlemi gerçekleştir.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Eğer ilk değer true, yani olumlu ise, ilk bloktaki işlemi gerçekleştir. İlk değer true değil ama ikinci değer true ise, ikinci bloktaki işlemi gerçekleştir. Eğer değerlerin hiçbiri true değil ise son bloktaki işlemi gerçekleştir.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Bir değer yanlış olduğunda bazı beyanlarda bulun.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Bir değer doğru olduğunda bazı beyanlarda bulun.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "'%2' değişkeninin %1 kullanımını silmek istiyor musunuz?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Bu fonksiyonda mükerrer girdi tanımlı.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Değişken adı kısmı boş bırakılamaz.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Veri kaydı içermeyen 0 uzunluğunda bir liste döndürür";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "liste";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Bu liste bloğunu yeniden yapılandırmak için bölüm ekleyin, kaldırın veya yeniden sıralayın.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "İstediğiniz sayıda öğe içeren bir liste oluşturun.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Listenin belirtilen bölümünün bir kopyasını oluşturur.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Listedeki öğenin ilk/son oluşumunun dizinini döndürür. Öğe bulunmazsa %1 değerini döndürür.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Belirtilen sayıda tekrarlanan belirli bir değerden oluşan bir liste oluşturur.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Metin listesini bir sınırlayıcı ile ayrılmış tek bir metinde birleştirin.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Metni, her bir sınırlayıcıyı kırarak bir metin listesine bölün.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://tr.wikipedia.org/wiki/Eşitsizlikler";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Her iki giriş de birbirine eşitse true değerini döndürün.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "İlk giriş ikinci girişten büyükse true değerini döndürün.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "İlk giriş ikinci girişten büyük veya ona eşitse true değerini döndürün.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "İlk giriş ikinci girişten küçük veya ona eşitse true değerini döndürün.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Giriş yanlışsa true değerini döndürür. Giriş doğruysa false değerini döndürür.";
Blockly.Msg.LOGIC_NULL = "boş";
Blockly.Msg.LOGIC_NULL_HELPURL =
  "https://tr.wikipedia.org/wiki/Sıfırlanabilir_tip";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Her iki giriş de doğruysa true döndür.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "'test' durumunu kontrol edin. Koşul true olursa, 'if true' değerini döndürür; aksi takdirde 'if false' değerini döndürür.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "İki sayının çarpımını döndürün.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Yükseltilen ilk sayıyı ikinci sayının gücüne döndürün.";
...
Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://tr.wikipedia.org/wiki/Programlama_deyimi";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://tr.wikipedia.org/wiki/Matematiksel_sabit";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Ortak sabitlerden birini döndür: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (sonsuzluk).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Bir sayıyı belirtilen sınırlar arasında (dahil) ile sınırlandırın.";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Bir sayının çift, tek, asal, bütün, pozitif, negatif veya belirli bir sayıya bölünebilir olup olmadığını kontrol edin. True veya false değerini döndürür.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Listedeki sayısal değerlerin ortalamasını (aritmetik ortalama) döndürün.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Belirtilen iki sınır arasında rastgele bir tamsayı döndürün.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Bir sayının 10 logaritmasını geri döndür.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Bir derecenin kosinüsünü döndürün (radyan değil).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Sinüsü bir derece döndürün (radyan değil).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Bir derecenin tanjantını döndürün (radyan değil).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://tr.wikipedia.org/wiki/Alt_program";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Kullanıcı tanımlı '%1' işlevini çalıştırın.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://tr.wikipedia.org/wiki/Alt_program";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Kullanıcı tanımlı '%1' işlevini çalıştırın ve çıkışını kullanın.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Çıkışı olmayan bir işlev oluşturur.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Uyarı: Bu işlev yinelenen parametrelere sahiptir.";
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Vurgulama işlevi tanımı";
Blockly.Msg.PROCEDURES_IFRETURN_HELPURL = "http://c2.com/cgi/wiki?GuardClause";
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Bir değer true ise, ikinci bir değer döndürün.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Uyarı: Bu blok yalnızca bir işlev tanımı içinde kullanılabilir.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Bu işleve giriş ekleyin, kaldırın veya yeniden sıralayın.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Metnin bir kopyasını farklı bir durumda döndürün.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Bazı metnin başka bir metnin içinde kaç kez oluştuğunu sayın.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Bu metin bloğunu yeniden yapılandırmak için bölüm ekleyin, kaldırın veya yeniden sıralayın.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Metnin belirli bir bölümünü döndürür.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "İkinci metindeki ilk metnin ilk/son oluşumunun dizinini döndürür. Metin bulunmazsa %1 değerini döndürür.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "İstediğiniz sayıda öğeyi birleştirerek bir metin parçası oluşturun.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "%1 uzunluğu";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Sağlanan metindeki harflerin (boşluklar dahil) sayısını döndürür.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Belirtilen metni, sayıyı veya başka bir değeri yazdırın.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Bazı metnin tüm tekrarlarını başka bir metnin içinde değiştirin.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Metindeki karakterlerin sırasını tersine çevirir.";
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://tr.wikipedia.org/wiki/Dize_(bilgisayar_bilimi)";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Bir veya her iki uçtan boşluklar kaldırılmış olarak metnin bir kopyasını döndürün.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Bu değişkeni girişe eşit olacak şekilde ayarlar.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "'%1' isimli değişken adı zaten var.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "'%1' isimli değişken '%2' tipli başka bir değişkende tanımlı.";
