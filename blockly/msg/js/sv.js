...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Kan inte radera variabeln '%1' eftersom den är en del av definition för funktionen '%2'";
Blockly.Msg.CHANGE_VALUE_TITLE = "Ändra värde:";
Blockly.Msg.CLEAN_UP = "Städa upp block";
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Hopfällda block innehåller varningar.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "fortsätta med nästa upprepning av loop";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Bryt ut ur den innehållande upprepningen.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Hoppa över resten av denna loop och fortsätt med nästa loop.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Varning: Detta block kan endast användas i en loop.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Låt variabeln "%1" anta värden från starttalet till sluttalet, beräknat med det angivna intervallet, och utför de angivna blocken.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Om värdet är sant, utför det första kommandoblocket. Utför annars det andra kommandoblocket.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  'Radera %1 användningar av variabeln "%2"?';
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Denna funktion har dubblettinmatningar.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Du kan inte använda ett tomt variabelnamn.";
...
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP =
  "Lägg till ett föremål till listan.";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Skapa en lista med valfritt antal föremål.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Ger tillbaka objektet på den efterfrågade positionen i en lista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Returnerar ett slumpmässigt objekt i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Tar bort och återställer det första objektet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Tar bort och återställer objektet på den specificerade positionen i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Tar bort och återställer det sista objektet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Tar bort och återställer ett slumpmässigt objekt i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Tar bort det första objektet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Tar bort objektet på den specificerade positionen i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Tar bort det sista objektet i en lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Tar bort en slumpmässig post i en lista.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Ger tillbaka den första/sista förekomsten av objektet i listan. Returnerar %1 om objektet inte hittas.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "skapa lista med föremålet %1 upprepat %2 gånger";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Skapar en lista som innehåller ett valt värde upprepat ett bestämt antalet gånger.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "sätter in objektet i början av en lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Sätter in objektet vid en specificerad position i en lista.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "sätter in objektet på en slumpad position i en lista.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Sätter in ett slumpat objekt i en lista.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Sammanfoga en textlista till en text, som separeras av en avgränsare.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Dela upp text till en textlista och bryt vid varje avgränsare.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Returnerar kvoten av de två talen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Returnerar differensen mellan de två talen.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Returnerar produkten av de två talen.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Returnerar arcustangens av punkt (X, Y) i grader från -180 till 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://sv.wikipedia.org/wiki/Matematisk_konstant";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Begränsa ett tal till att mellan de angivna gränsvärden (inkluderande).";
...
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://sv.wikipedia.org/wiki/Modulär_aritmetik";
Blockly.Msg.MATH_MODULO_TITLE = "resten av %1 ÷ %2";
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Returnerar kvoten från divisionen av de två talen.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  "Returnerar medianen av talen i listan.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Returnerar ett slumpmässigt element från listan.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://sv.wikipedia.org/wiki/Slumptalsgenerator";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Ger tillbaka ett slumpat heltal mellan två värden, inkluderande.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Returnera den naturliga logaritmen av ett tal.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Returnerar logaritmen för bas 10 av ett tal.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://sv.wikipedia.org/wiki/Trigonometrisk_funktion";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  'Kör den användardefinierade funktionen "%1".';
...
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
  "https://sv.wikipedia.org/wiki/Funktion_%28programmering%29";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP =
  "Lägg till en inmatning till funktionen.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Returnerar en kopia av texten i ett annat skiftläge.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Räkna hur många gånger en text förekommer inom en annan text.";
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP =
  "Lägg till ett föremål till texten.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "få textdel från bokstav # från slutet";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Ger tillbaka indexet för den första/sista förekomsten av första texten i den andra texten.  Ger tillbaka %1 om texten inte hittas.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Returnerar sant om den angivna texten är tom.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Skapa en textbit genom att sammanfoga ett valfritt antal föremål.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Skriv den angivna texten, talet eller annat värde.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Ersätt alla förekomster av en text inom en annan text.";
...
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://sv.wikipedia.org/wiki/Str%C3%A4ng_%28data%29";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Returnerar en kopia av texten med borttagna mellanrum från en eller båda ändar.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  'En variabel med namnet "%1" finns redan.';
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  'En variabel med namnet "%1" finns redan för en annan typ: "%2".';
