...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Campurkan dua warna sekali pada nisbah yang ditentukan (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "teruskan dengan lelaran gelung seterusnya";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Keluar dari gelung pengandung.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Langkau seluruh gelung yang tinggal dan bersambung dengan lelaran seterusnya.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Amaran: Blok ini hanya boleh digunakan dalam satu gelung.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Tambah yang terakhir, alihkan semua keadaan ke blok jika.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Lakukan beberapa perintah apabila nilainya palsu (false).";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Lakukan beberapa perintah apabila nilainya benar (true).";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Kembalikan senarai panjang 0, yang tidak mengandungi rekod data";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Wujudkan senarai dengan apa jua nombor item.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Kembalikan item dalam kedudukan yang ditetapkan dalam senarai.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Alihkan dan kembalikan item mengikut spesifikasi posisi dalam senarai.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Alihkan item pada posisi mengikut spesifikasi dalam senarai.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Menyatakan indeks kejadian pertama/terakhir item berkenaan dalam senarai. Menyatakan %1 jika item berkenaan tidak ditemui.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Masukkan item pada posisi yand ditentukan dalam senarai.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Masukkan item pada posisi yang ditentukan dalam senarai.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Cantumkan senarai teks menjadi satu teks, dipecahkan oleh delimiter.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Pecahkan teks kepada senarai teks, berpecah di setiap delimiter.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD =
  "Kembalikan jumlah kedua-dua bilangan.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://ms.wikipedia.org/wiki/Pemalar_matematik";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://ms.wikipedia.org/wiki/Punca_kuasa_dua";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://ms.wikipedia.org/wiki/Fungsi_trigonometri";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://ms.wikipedia.org/wiki/Fungsi";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Tambah, alih keluar atau susun semula input pada fungsi ini.";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  "Tukar nama semua pembolehubah '%1' kepada:";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Kembalikan Indeks kejadian pertama/terakhir dari teks pertama ke dalam teks kedua.  Kembalikan %1 Jika teks tidak ditemui.";
