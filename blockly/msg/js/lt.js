...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Negalima ištrinti kintamojo '%1', nes jis yra dalis funkcijos '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Sumaišo dvi spalvas su pateiktu santykiu (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Spalvą galima sudaryti iš raudonos, žalios ir mėlynos dedamųjų. Kiekvienos intensyvumas nuo 0 iki 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "šį kartą praleisti likusius veiksmus ir tęsti kartojimą";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Nutraukia (artimiausią) vykstantį kartojimą.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Praleidžia žemiau išvardintus kartojimo veiksmus (ir tęsia darbą nuo kartojimo pradinio veiksmo).";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Atsargiai: šis blokas gali būt naudojamas tik kartojimo bloko viduje.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  'Kartok veiksmus, kol kintamasis "%1" paeiliui gauna kiekvieną sąrašo reikšmę.';
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Imama kintamoji '%1' reikšmė nuo pradinio skaičiaus iki pabaigos skaičiaus, skaičiuojant nustatytais intervalais ir atliekant nustatytus blokus.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Pridėti sąlygą „jei“ blokui.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Pridėti veiksmų vykdymo variantą/"šaką", kai netenkinama nė viena sąlyga.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Galite pridėt/pašalinti/pertvarkyti  sąlygų "šakas".';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Jei sąlyga tenkinama, atlikti jai priklausančius veiksmus, o jei ne -- atlikti kitus nurodytus veiksmus.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Jei pirma sąlyga tenkinama, atlikti jai priklausančius veiksmus, O jei ne, tikrinti antrą sąlygą -- ir jei ši tenkinama, atlikti jos veiksmus.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Jei pirma sąlyga tenkinama, atlikti jai priklausančius veiksmus, O jei ne, tikrinti antrą sąlygą -- ir jei ši tenkinama, atlikti jos veiksmus. Kitais atvejais -- atlikti paskutinio bloko veiksmus.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Leidžia atlikti išvardintus veiksmus kelis kartus.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Kartoja veiksmus, kol bus pasiekta nurodyta sąlyga.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Kartoja veiksmus, kol sąlyga tenkinama.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ši funkcija turi pasikartojančias įvestis";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Negalite naudoti tuščio kintamojo pavadinimo.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Grąžina sąrašą, ilgio 0, neturintį duomenų";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "sąrašas";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Pridėti, pašalinti arba paskirstyti skyrius, kad pertvarkyti šį teksto bloką.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Sukurti sąrašą iš bet kokio skaičiaus elementų.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Grąžina pirmąjį sąrašo elementą.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Gražina objektą į nurodyta poziciją sąraše.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Grąžina paskutinį elementą iš sąrašo.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Grąžina atsitiktinį elementą iš sąrašo.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Sukuria nurodytos sąrašo dalies kopiją.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Įterpia objektą į sąrašo pradžią.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Įterpią objektą į nurodytą poziciją sąraše.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Įterpia objektą į atsitiktinę sąrašo vietą.";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP =
  'Reikšmė gali būti "teisinga"/"Taip" arba "klaidinga"/"Ne".';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Grįžti tiesa, jei pirmoji įvestis didesnė nei antroji įvestis.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Grįžti tiesa, jei pirma įvestis didesnė arba lygi antrajai įvesčiai.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Grįžti tiesa, jei pirma įvestis mažesnė nei antra įvestis.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Grįžti tiesa, jei pirma įvestis mažesnė arba lygi antrajai įvesčiai.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Grįžti tiesa, jeigu abi įvestys ne lygios tarpusavyje.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Grįžti tiesa, jei įvestis klaidinga. Grįžti klaidinga, jei įvestis teisinga.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Grįžti tiesa, jei bent viena įvestis teisinga.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Grąžina pirmą skaičių pakeltą laipsniu pagal antrą skaičių.";
...
Blockly.Msg.MATH_CHANGE_TOOLTIP =
  "Prideda skaičių prie kintamojo '%1'. Kai skaičius neigiamas - gaunasi atimtis.";
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://en.wikipedia.org/wiki/Mathematical_constant";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Grįžti viena iš pagrindinių konstantų: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (begalybė).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Apriboti skaičių, kad būtų tarp nustatytų ribų (imtinai).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Patikrina skaičiaus savybę: (ne)lyginis/pirminis/sveikasis/teigiamas/neigiamas/dalus iš x.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Grįžti vidurkiu (aritmetinis vidurkis) iš skaitinių reikšmių sąraše.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Grąžinti sąrašą dažniausių elementų sąraše.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Grąžinti atsitiktinį elementą iš sąrašo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Grįžti standartine pakraipa iš sąrašo.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Atsitiktinė trupmena nuo 0 (imtinai) iki 1 (neimtinai).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Grįžti atsitiktinį sveikąjį skaičių tarp dviejų nustatytų ribų, imtinai.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP =
  "Suapvalinti skaičių į žemesnę ar aukštesnę reikšmę.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS =
  "Skaičiaus modulis - reikšmė be ženklo (panaikina minusą).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Grįžti 10 pagrindinių logaritmų iš skaičiaus.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://lt.wikipedia.org/wiki/Trigonometrinės_funkcijos";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Sukuria procedūrą - komandą, kuri nepateikia jokio rezultato (tik atlieka veiksmus).";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Sukuria funkciją - komandą, kuri ne tik atlieka veiksmus bet ir pateikia (grąžina/duoda) rezultatą.";
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Ši komanda turi du vienodus gaunamų duomenų pavadinimus.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Suskaičiuoti, kiek kartų šis tekstas kartojasi kitame tekste.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Grąžina pirmą/paskutinę pirmo teksto reikšmę antrame tekste. Grąžina %1, jei tekstas nerastas.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Grįžti tiesa, jei numatytas tekstas tuščias.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Sukurti teksto fragmentą sujungiant bet kokį skaičių fragmentų.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "teksto %1 ilgis";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Suranda teksto simbolių kiekį (įskaitant ir tarpus)";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Spausdinti nurodytą tekstą, skaičių ar kitą reikšmę.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Pašalinti visas teksto dalis kitame tekste.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Grąžina teksto kopiją, pašalinus tarpus iš vieno ar abiejų kraštų.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Kintamasis, pavadinimu '%1', jau egzistuoja kaip kitas tipas: '%2'.";
