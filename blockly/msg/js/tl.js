...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Paghalo ng dalawang kulay kasama ng ibinigay na proporsyon (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "gumawa ng kulay ng may espisipikong dami ng kulay pula, berde, at asul. lahat ng halaga ay dapat sa pagitan ng 0 at 100.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Para sa bawat item sa isang list, i-set ang variable ng '%1' sa mga item, at pagkatapos ay gumawa ng ilang mga statements.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Mag Add ng final, kunin lahat ng condition sa if block.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Mag Add, remove o kaya mag reorder ng sections para maayos ang if block.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "kung ang value ay true,  gagawin ang do statements.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Kung ang value ay true, gagawin ang unang block ng do statements. Kung hindi, gagawin ang pangalawang block ng statement.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Kung ang unang value ay true, gagawin ang first block ng statement. Kung hindi, kung ang second value ay true, gagawin ang second block ng statement.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Kung ang first value ay true, gagawin ang first block ng statement. Kung hindi true ang second value, gagawin ang second block ng statement. Kung wala sa mga values ay true, gagawin ang last block ng statements.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "gumawa ng ilang pangungusap ng ilang ulit.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Habang ang value ay false, gagawin ang ibang statements.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Habang ang value ay true, gagawin ang ibang statements.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Gumawa ng list na may kahit anong number ng items.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Ibalik ang item sa itinakdang posisyon sa list.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Nag tatanggal at nag babalik ng mga items sa tinukoy na posisyon sa list.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Nag tatanggal ng item sa tinukoy na posisyon sa list.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Pagbalik ng index ng una/huli pangyayari ng item sa list. Pagbalik ng %1 kung ang item ay hindi makita.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Nagbabalik ng true kung ang list ay walang laman.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Nag singit ng item sa tinukoy na posistion sa list.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Pag set ng item sa tinukoy na position sa isang list.";
