...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Impossibile deler le variabile '%1' perque illo face parte del definition del function '%2'";
Blockly.Msg.CHANGE_VALUE_TITLE = "Cambiar valor:";
Blockly.Msg.CLEAN_UP = "Rangiar le blocos";
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Blocos plicate contine advertimentos.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Misce duo colores con un ration specificate (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Crear un color con le quantitate specificate de rubie, verde e blau. Tote le valores debe esser inter 0 e 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continuar con le proxime iteration del bucla";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Escappar del bucla continente.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Saltar le resto de iste bucla e continuar con le proxime iteration.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Attention: Iste bloco pote solmente esser usate in un bucla.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Pro cata elemento in un lista, mitter lo in le variabile '%1' e exequer certe instructiones.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Mitter in le variabile '%1' le valores ab le numero initial usque al numero final, con passos secundo le intervallo specificate, e exequer le blocos specificate.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'Adder un condition al bloco "si".';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Adder un condition final de reserva al bloco "si".';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Adde, remove o reordina sectiones pro reconfigurar iste bloco "si".';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Si un valor es ver, exequer le prime bloco de instructiones. Si non, exequer le secunde bloco de instructiones.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Si le prime valor es ver, exequer le prime bloco de instructiones. Si non, si le secunde valor es ver, exequer le secunde bloco de instructiones.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Si le prime valor es ver, exequer le prime bloco de instructiones. Si non, si le secunde valor es ver, exequer le secunde bloco de instructiones. Si necun del valores es ver, exequer le ultime bloco de instructiones.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Exequer certe instructiones plure vices.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Iste function ha entratas duplicate.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Non es possibile usar un nomine de variabile vacue.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Retorna un lista, de longitude 0, sin datos.";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lista";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Adde, remove o reordina sectiones pro reconfigurar iste bloco de listas.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Crear un lista con un numero qualcunque de elementos.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Retorna le prime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Retorna le elemento presente al position specificate in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Retorna le ultime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Retorna un elemento aleatori in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Remove e retorna le prime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Remove e retorna le elemento presente al position specificate in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Remove e retorna le ultime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Remove e retorna un elemento aleatori in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Remove le prime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Remove le elemento presente al position specificate in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Remove le ultime elemento in un lista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Remove un elemento aleatori in un lista.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Retorna le indice del prime/ultime occurrentia del elemento in le lista. Retorna %1 si le elemento non es trovate.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "crear lista con elemento %1 repetite %2 vices";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Crea un lista que contine le valor fornite, repetite le numero specificate de vices.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Insere le elemento al initio de un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Insere le elemento al position specificate in un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Adjunge le elemento al fin de un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Insere le elemento a un position aleatori in un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Defini le valor del prime elemento in un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Defini le valor del elemento al position specificate in un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Defini le valor del ultime elemento in un lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Defini le valor de un elemento aleatori in un lista.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alphabetic, ignorar majuscula/minuscula";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Unir un lista de textos, separate per un delimitator, in un sol texto.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Divider texto in un lista de textos, separante lo a cata delimitator.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://ia.wikipedia.org/wiki/Inequalitate_(mathematica)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Retornar ver si le duo entratas es equal.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Retornar ver si le prime entrata es major que le secunde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Retornar ver si le prime entrata es major que o equal al secunde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Retornar ver si le prime entrata es minor que le secunde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Retornar ver si le prime entrata es minor que o equal al secunde.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Retornar ver si le duo entratas non es equal.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Retornar ver si le entrata es false. Retornar false si le entrata es ver.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Retornar ver si ambe entratas es ver.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Retornar ver si al minus un del entratas es ver.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Verificar le condition in 'test'. Si le condition es ver, retorna le valor de 'si ver'; si non, retorna le valor de 'si false'.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://ia.wikipedia.org/wiki/Arithmetica";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD = "Retornar le summa del duo numeros.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Retornar le quotiente del duo numeros.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Retornar le differentia del duo numeros.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Retornar le producto del duo numeros.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Retornar le prime numero elevate al potentia del secunde numero.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2"; // untranslated
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 de X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Retornar le arco tangente del puncto (X, Y) in grados de -180 a 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://ia.wikipedia.org/wiki/Constante_mathematic";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Retornar un del constantes commun: π (3,141…), e (2,718…), φ (1,618…), sqrt(2) (1,414…), sqrt(½) (0,707…) o ∞ (infinite).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Limitar un numero a esser inter le limites specificate (incluse).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Verificar si un numero es par, impare, prime, integre, positive, negative, o divisibile per un certe numero. Retorna ver o false.";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Retornar le resto del division del duo numeros.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Retornar le media arithmetic del valores numeric in le lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Retornar le numero le plus grande in le lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN = "Retornar le numero median del lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Retornar le numero le plus parve in le lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Retornar un lista del elemento(s) le plus commun in le lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Retornar un elemento aleatori del lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Retornar le deviation standard del lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Retornar le summa de tote le numeros in le lista.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Retornar un numero integre aleatori inter le duo limites specificate, incluse.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Retornar le cosino de un grado (non radiano).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Retornar le sino de un grado (non radiano).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Retornar le tangente de un grado (non radiano).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Executar le function '%1' definite per le usator.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine"; // untranslated
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Executar le function '%1' definite per le usator e usar su resultato.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Crea un function que non retorna un valor.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Crea un function que retorna un valor.";
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Attention: Iste function ha parametros duplicate.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Si un valor es ver, alora retornar un secunde valor.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Attention: Iste bloco pote solmente esser usate in le definition de un function.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Adder, remover o reordinar le entratas pro iste function.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Retornar un copia del texto con differente majusculas/minusculas.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Retorna le littera presente al position specificate.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Contar quante vices un texto occurre intra un altere texto.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Adde, remove o reordina sectiones pro reconfigurar iste bloco de texto.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "prender subcatena ab le prime littera";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "prender subcatena ab le fin ab le littera №";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "prender subcatena ab le littera №";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = ""; // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Retorna le parte specificate del texto.";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST =
  "cercar le prime occurrentia del texto";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "cercar le ultime occurrentia del texto";
Blockly.Msg.TEXT_INDEXOF_TITLE = "in le texto %1 %2 %3";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Retorna le indice del prime/ultime occurrentia del prime texto in le secunde texto. Retorna %1 si le texto non es trovate.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Crear un pecia de texto uniente un certe numero de elementos.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "longitude de %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Retorna le numero de litteras (incluse spatios) in le texto fornite.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Scriber le texto, numero o altere valor specificate.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Reimplaciar tote le occurrentias de un texto intra un altere texto.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Inverte le ordine del characteres in le texto.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Retornar un copia del texto con spatios eliminate de un extremitate o ambes.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Mitte iste variabile al valor del entrata.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Un variabile con le nomine '%1' jam existe.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Un variabile con le nomine '%1' jam existe pro un altere typo: '%2'.";
