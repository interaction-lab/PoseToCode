...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "'%1' চলক অপসারণ করা যাবে না কারণ এটি '%2' কার্যপ্রণালীর সংজ্ঞার অংশ";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "প্রদত্ত অনুপাত(০.০ - ১.০) অনুসারে দুটি রং একসাথে মিশ্রিত করুন।";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "একটি রং তৈরি করুন নির্দিষ্ট পরিমাণে লাল, সবুজ এবং নীল রং মিশ্রিত করে। প্রত্যেকটির মান অবশ্যই ০ থেকে ১০০ এর মধ্যে হতে হবে।";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "সংশ্লিষ্ট প্রবেশপথ থেকে চলে অাসুন";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "এই প্রবেশপথের অবশিষ্ট অংশ বাদ দিন এবং পরবর্তী প্রচেষ্টা চালিয়ে যান।";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "সর্তকীবার্তা: এই ব্লকটি শুধুমাত্র লুপের মধ্যে ব্যবহার করা যাবে।";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "কোন তালিকায় প্রতিবারের জন্য, আইটেমের সাথে চলক '%1' বসান এবং কিছু বিবরণ দিন।";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "চলক %1 প্রস্তুত করুন, শুরু থেকে শেষ পর্যন্ত সংখ্যা গ্রহন করতে যা নির্দেশিত বিরতি গণনা করছে এবং নির্দেশিত ব্লক সমূহ সম্পন্ন করতে।";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "যদি একটি মূল্যমাস সত্য হয়, তবে কিছু বিবরণ দিন";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "যদি একটি মূল্যমান সত্য হয়, তবে বিবৃতিসমূহের প্রথম ব্লকটা অন্যথায় বিবৃতির দ্বিতীয় ব্লক।";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "যদি প্রথম মূল্যমান সঠিক হয়, তবে বর্ণিত প্রথম ব্লকটি সম্পন্ন করুন। অন্যথায়, দ্বিতীয় মূল্যমান সঠিক হয়, দ্বিতীয় ব্লক সম্পন্ন করুন।";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "যখন একটি মূল্যমান মিথ্যা, তখন কিছু বিবৃতি দিন।";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "যখন একটি মূল্যমান সঠিক, তখন কিছু বিবরণ দিন।";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "'%2' চলকের '%1'টি ব্যবহার অপসারণ করবেন?";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "অাপনি চলকের নাম খালি রাখতে পারেননা।";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "পাঠাবে একটি তালিকা, দের্ঘ্য হবে ০, কোন উপাত্ত থাকবে না";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "যেকোন সংখ্যক পদ নিয়ে একটি তালিকা তৈরি করুন।";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "এলোমেলোভাবে তালিকার যেকোন একটি পদ পাঠাবে।";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "অপসারণ করুন এবং তালিকার প্রথম পদটি পাঠান।";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "অপসারণ করুন এবং তালিকার শেষ পদটি পাঠান।";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "অপসারণ করুন এবং তালিকার এলোমেলো একটি পদ পাঠান।";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "তালিকার প্রথম পদটি অপসারণ করা হয়েছে।";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "তালিকার শেষ পদটি অপসারণ করা হয়েছে।";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "তালিকা থেকে এলোমেলো একটি পদ অপসারণ করা হয়েছে।";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "পাঠাবে সত্য যদি প্রথম ইনপুট দ্বিতীয় ইনপুট থেকে বড় হয়।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "পাঠাবে সত্য যদি প্রথম ইনপুট দ্বিতীয় ইনপুট থেকে বড় অথবা সমান হয়।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "পাঠাবে সত্য যদি প্রথম ইনপুট দ্বিতীয় ইনপুট থেকে ছোট হয়।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "পাঠাবে সত্য যদি প্রথম ইনপুট দ্বিতীয় ইনপুট থেকে ছোট অথবা সমান হয়।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "পাঠাবে সত্য যদি উভয় ইনপুটই সমান না হয়।";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "পাঠাবে সত্য যদি ইনপুট মিথ্যা হয়। পাঠাবে মিথ্যা যদি ইনপুট সত্য হয়।";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "পাঠাবে সত্য যদি উভয় ইনপুটই সত্য হয়।";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "তালিকা থেকে এলোমেলোভাবে একটি পদ পাঠাবে।";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "আউটপুট ছাড়া একটি ক্রিয়া তৈরি করুন।";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "যদি মান সত্য হয় তাহলে দ্বিতীয় মান পাঠাবে।";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "'%1' নামের চলক '%2' ধরনের চলকের জন্য পূর্ব থেকেই অাছে।";
