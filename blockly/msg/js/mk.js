...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Променливата '%1' не може се избрише бидејќи е дел од определението на функцијата '%2'";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Создајте боја со укажаните износи на црвена, зелена и сина. Сите вредности мора да бидат помеѓу 0 и 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "продолжи со следното повторување на јамката";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Излези од содржечката јамка.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Променливата „%1“ да ги земе вредностите од почетниот до завршниот број, броејќи според укажаниот интервал и ги исполнува укажаните блокови.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Додава, отстранува или прередува делови за прераспоредување на овој блок „ако“.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Ако вредноста е вистинита, исполни некои наредби.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Не можете да искористите празно име за променлива.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Додај, отстрани или пререди ги деловите за прераспоредување на овој блок „список“.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Дава вистина ако обата вноса се еднакви.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Дава вистина ако првиот внос е поголем од вториот.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Дава вистина ако првиот внос е поголем или еднаков на вториот.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Дава вистина ако првиот внос е помал од вториот.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Дава вистина ако првиот внос е помал или еднаков на  вториот.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Дава вистина ако обата вноса не се еднакви.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Дава вистина ако вносот е невистинит. Дава невистина ако вносот е вистинит.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Дава вистина ако обата вноса се вистинити.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Дава вистина ако барем еден од вносовите е вистинит.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://mk.wikipedia.org/wiki/Аритметика";
...
Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter?uselang=mk";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://mk.wikipedia.org/wiki/Математичка_константа";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Дава една од вообичаените константи: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), или ∞ (бесконечност).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Проверува дали бројот е парен, непарен, прост, цел, позитивен, негативен или делив со некој број. Дава вистина или невистина.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://mk.wikipediа.org/wiki/Тригонометриски_функции";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://mk.wikipedia.org/wiki/Потпрограма";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Додај, отстрани или пренареди ги влезните параметри за оваа функција.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Додај, отстрани или пререди ги деловите за прераспоредување на овој блок „текст“.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Променлива со име '%1' веќе постои за друг тип: '%2'.";
