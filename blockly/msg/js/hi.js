...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "चर '%1' को नहीं हटा सकता क्योंकि यह फ़ंक्शन '%2' की परिभाषा का हिस्सा है";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "दिए गए अनुपात (0.0 - 1.0) के साथ दो रंगों का मिश्रण करता है।";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "लाल, हरा और नीले की निर्दिष्ट मात्रा के साथ एक रंग बनायें। सभी मान ० से १०० के बीच होने चाहिए।";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "फंदे की अगली यात्रा के साथ जारी रखें";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "भीतरी फंदे से बाहर निकलें।";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "बाकी बचे फंदे को छोड़ें, और अगली यात्रा जारी रखें।";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "सावधान: ये ब्लॉक केवल लूप के अंदर इस्तेमाल किया जा सकता है।";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "सूची के प्रत्येक वस्तु के लिए, वस्तु में चर का मान '%1' रखें और बाद में कुछ कथन लिखें।";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "क्या चर '%1' प्रारंभ संख्या से अंत संख्या तक मानों को लेता है, निर्दिष्ट अंतराल के अनुसार गिनती करता है, और निर्दिष्ट रुकावटों को करता है।";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "एक शर्त जोड़ें यदि ब्लॉक है।";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "यदि ब्लॉक है तो इसके लिए एक अंतिम, कैच-सभी स्थिति जोड़ें।";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "भाग को समनरूप बनाने के लिए जोङें, हटाएं, या पुनः व्यवस्थित करें यदि यह बंद है।";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "यदि एक मान सत्य है तो कथनों का प्रथम खण्ड बनायें। अन्यथा कथनों का दूसरा भाग निर्मित करें।";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "यदि पहले मान सही है, तो बयानों का पहला खंड करें। अन्यथा, यदि दूसरा मान सत्य है, तो बयानों का दूसरा खंड करें।";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "यदि पहला मान सही है, तो बयानों का पहला खंड करें। अन्यथा, यदि दूसरा मान सत्य है, तो बयानों का दूसरा खंड करें। यदि कोई भी मान सही नहीं है, तो बयानों का अंतिम खंड करें।";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "जब तक मान गलत है, तब तक कुछ विवरण चलाएँ।";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "जब तक मान सही है, तब तक कुछ विवरण चलाएँ।";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "आप रिक्त चर नाम उपयोग नहीं कर सकते";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "0 लंबाई की, कोई भी डेटा ना रखने वाली एक सूची लौटती है";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "सूची";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "इस सूची ब्लॉक को पुन: आकार देने के लिए वर्गों को जोड़ें, निकालें, या पुन: क्रमित करें।";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "अंत से # से उप-सूची प्राप्त करें";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "सूची में आइटम की पहली/अंतिम घटना का सूचक देता है। यदि आइटम नहीं मिला है तो %1 रिटर्न होता है।";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "निर्धारित मान की बार-बार दोहराई गई एक सूची बनाता है।";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "ग्रंथों की एक सूची में शामिल करें, जो एक सीमांकक से अलग हो।";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "ग्रंथों की सूची में पाठ को विभाजित करें, प्रत्येक सीमांकक पर तोड़कर।";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "ट्रू रिटर्न करें यदि दोनो इनपुट इक दूसरे के बराबर हों।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "ट्रू रिटर्न करें यदि पहला इनपुट दूसरे इनपुट से बड़ा हो।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "ट्रू रिटर्न करें यदि पहला इनपुट दूसरे इनपुट से बड़ा हो या बराबर हो।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "ट्रू रिटर्न करें यदि पहला इनपुट दूसरे इनपुट से छोटा हो।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "ट्रू रिटर्न करें यदि पहला इनपुट दूसरे इनपुट से छोटा हो या बराबर हो।";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "ट्रू रिटर्न करें यदि दोनो इनपुट इक दूसरे के बराबर नहीं हों।";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "ट्रू रिटर्न करता है यदि इनपुट फॉल्स है। फॉल्स रिटर्न करता है यदि इनपुट ट्रू है।";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "ट्रू रिटर्न करें यदि दोनो इनपुट ट्रू हों।";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "ट्रू रिटर्न करें यदि दोनो मे से इक इनपुट ट्रू हो।";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "'परीक्षण' में हालत की जांच करें। यदि स्थिति सही है, तो 'सच' मान लौटाता है; अन्यथा वापस लौटता 'अगर झूठा'मान देता है।";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "सामान्य स्थिरांक में से एक को वापस लौटें:π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (infinity)।";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "एक संख्या को निर्दिष्ट सीमा (सम्मिलित) के बीच बाधित करें।";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "जांचें कि क्या कोई संख्या एक सम, विषम, मुख्य, संपूर्ण, सकारात्मक, नकारात्मक है या यदि वह निश्चित संख्या से विभाजित है। वास्तविक या गलत रिटर्न देता है।";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "सूची में संख्यात्मक मानों का औसत (अंकगणित माध्य) लौटें।";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "सूची मे सबसे आम आइटम(s) की सूची रिटर्न करें।";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "सूची की सभी संख्याओं का योग रिटर्न करें।";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "0.0 (समावेशी) और 1.0 (विशिष्ट) के बीच एक यादृच्छिक अंश पर लौटें।";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "दो निर्दिष्ट सीमाओं, समावेशी के बीच एक यादृच्छिक पूर्णांक लौटें।";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "डिग्री का टैन्जन्ट रिटर्न करें (रेडियन नही)";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "यूज़र द्वारा वर्णन किया गया फ़ंक्शन '%1' चलाएँ।";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "यूज़र द्वारा वर्णन किया गया फ़ंक्शन '%1' चलाएँ और उसका आउटपुट इस्तेमाल करें।";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "बिना आउटपुट वाला एक फ़ंक्शन बनाता है।";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "सावधान: इस फ़ंक्शन मे डुप्लिकेट पैरामीटर हैं।";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "यदि एक मान ट्रू है तो, दूसरा मान रिटर्न करें।";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "सावधान: ये ब्लॉक फ़ंक्शन परिभाषा के अंदर ही इस्तेमाल किया जा सकता।";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "इस फ़ंक्शन में इनपुट जोड़ें, निकालें, या पुन: क्रमित करें।";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "टेक्स्ट की कॉपी भिन्न केस (अक्षर से संबंधित) मे रिटर्न करें।";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "गिने, कितनी बार कुछ पाठ कुछ अन्य पाठ के अंदर समाहित होता है।";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST =
  "टेक्स्ट पहली बार जहाँ आया है उसे ढूढ़े";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "टेक्स्ट आखरी बार जहाँ आया है उसे ढूढ़े";
Blockly.Msg.TEXT_INDEXOF_TITLE = "पाठ %1 %2 %3 में";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "दूसरे पाठ में पहले पाठ की पहली/अंतिम घटना का सूचक देता है। यदि पाठ नहीं मिला है तो %1 रिटर्न होता है।";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "ट्रू रिटर्न करता है यदि दिया गया टेक्स्ट खाली है।";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "किसी भी संख्या के मदों को एक साथ जोड़ कर पाठ का एक टुकड़ा बनाएं।";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "%1 की लंबाई";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "दिए गये टेक्स्ट मे अक्षरों की संख्या रिटर्न करता है (खाली स्थान मिला के)।";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "दिया गया टेक्स्ट प्रिंट करें, संख्या या अन्य मान।";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_BOTH =
  "रिक्त स्थान को इस टेक्स्ट के दोनों तरफ से निकालें";
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT =
  "रिक्त स्थान को इस टेक्स्ट के बायें तरफ से निकालें";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT =
  "रिक्त स्थान को इस टेक्स्ट के दाईं तरफ से निकालें";
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "एक या दोनों सिरों से हटाए गए रिक्त स्थान के साथ पाठ की एक प्रति लौटाएं।";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "'%1' नाम का एक चर पहले से '%2' प्रकार के अन्य चर के लिए मौजूद है।";
