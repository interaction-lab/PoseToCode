...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "No podem esborrar la variable '%1' perquè forma part de la definició de la funció '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Barreja dos colors amb una proporció donada (0,0 - 1,0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Crear un color amb les quantitats especificades de vermell, verd i blau. Tots els valors han de ser entre 0 i 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continuar amb la següent iteració del bucle";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Sortir del bucle interior.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Ometre la resta d'aquest bucle, i continuar amb la següent iteració.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Advertència: Aquest bloc només es pot utilitzar dins d'un bucle.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Per a cada element en la llista, desar l'element dins la variable '%1', i llavors executar unes sentències.";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "comptar amb %1 des de %2 fins a %3 en increments de %4";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Fer que la variable "%1" prengui els valors des del nombre inicial fins al nombre final, incrementant a cada pas l\'intèrval indicat, i executar els blocs especificats.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Afegeix una condició al bloc 'si'.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Afegeix una condició final, que recull qualsevol altra possibilitat, al bloc 'si'.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Afegeix, esborra o reordena seccions per reconfigurar aquest bloc 'si'.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "si no";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "si no, si";
Blockly.Msg.CONTROLS_IF_MSG_IF = "si";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Si un valor és cert, llavors executar unes sentències.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Si un valor és cert, llavors executar el primer bloc de sentències. En cas contrari, executar el segon bloc de sentències.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Si el primer valor és cert, llavors executar el primer bloc de sentències. En cas contrari, si el segon valor és cert, executar el segon bloc de sentències.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Si el primer valor és cert, llavors executar el primer bloc de sentències. En cas contrari, si el segon valor és cert, executar el segon bloc de sentències. Si cap dels valors és cert, executar l'últim bloc de sentències.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Executar unes sentències diverses vegades.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Mentre un valor sigui fals, llavors executar unes sentències.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Mentre un valor sigui cert, llavors executar unes sentències.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Esborrar '%1' crides de la variable '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Aquesta funció té entrades duplicades.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "No es pot fer servir un nom de variable buit.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Retorna una llista, de longitud 0, que no conté cap dada.";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "llista";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Afegeix, esborra o reordena seccions per reconfigurar aquest bloc de llista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Retorna l'element de la posició especificada a la llista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Retorna un element a l'atzar d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Esborra i retorna el primer element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Esborra i retorna l'element de la posició especificada de la llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Esborra i retorna l'últim element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Esborra i retorna un element a l'atzar d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Esborra el primer element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Esborra l'element de la posició especificada de la llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Esborra l'últim element d'una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Esborra un element a l'atzar d'una llista.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST =
  "recupera sub-llista des del principi";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "recupera sub-llista des de # des del final";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Retorna l'índex de la primera/última aparició d'un element a la llista. Retorna %1 si no s'hi troba l'element.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "crea llista amb element %1 repetit %2 vegades";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Crea una llista formada pel valor donat, repetit tantes vegades com s'indiqui.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Insereix l'element a la posició especificada d'una llista.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Insereix l'element en una posició a l'atzar d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Modifica el primer element d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Modifica l'element de la posició especificada d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Modifica l'últim element d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Modifica un element a l'atzar d'una llista.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Ajunta una llista de textos en un text, separats per un delimitador.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Parteix el text en una llista de textos, trencant-lo a cada delimitador.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://ca.wikipedia.org/wiki/Inequaci%C3%B3";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Retorna cert si totes dues entrades són iguals.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Retorna cert si la primera entrada és més gran que la segona entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Retorna cert si la primera entrada és més gran o igual a la segona entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Retorna cert si la primera entrada és més petita que la segona entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Retorna cert si la primera entra és més petita o igual a la segona entrada.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Retorna cert si totes dues entrades són diferents.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Retorna cer si totes dues entrades són certes.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Comprova la condició de 'condició'. Si la condició és certa, retorna el valor 'si és cert'; en cas contrari, retorna el valor 'si és fals'.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://ca.wikipedia.org/wiki/Aritm%C3%A8tica";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD = "Retorna la suma dels dos nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Retorna el quocient dels dos nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Retorna la diferència entre els dos nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Retorna el producte del dos nombres.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Retorna el primer nombre elevat a la potència indicada pel segon nombre.";
Blockly.Msg.MATH_ATAN2_HELPURL =
  "https://ca.wikipedia.org/wiki/Inverses_de_les_funcions_trigonom%C3%A8triques#L'arctangent_amb_dos_arguments";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 de X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Torna l'arctangent del punt (X,Y) en graus de -180 a 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://ca.wikipedia.org/wiki/Constant_matem%C3%A0tica";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Retorna una de les constants més habituals: π (3,141…), e (2,718…), φ (1,618…), sqrt(2) (1,414…), sqrt(½) (0,707…), o ∞ (infinit).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Limita un nombre perquè estigui entre els límits especificats (inclosos).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Comprova si un nombre és parell, senar, enter, positium negatiu, o si és divisible per un cert nombre. Retorna cert o fals.";
Blockly.Msg.MATH_IS_WHOLE = "és enter";
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://ca.wikipedia.org/wiki/Residu_%28aritm%C3%A8tica%29";
Blockly.Msg.MATH_MODULO_TITLE = "residu de %1 ÷ %2";
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Retorna el residu de dividir els dos nombres.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Retorna la mitjana (mitjana aritmètica) dels valors numèrics de la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Retorna el nombre més gran de la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN = "Retorna la mediana de la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Retorna el nombre més petit de la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Retorna una llista dels elements que apareixen més vegades a la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Retorna un element aleatori de la lllista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Retorna la desviació estàndard de la llista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Retorna la suma de tots els nombres de la llista.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Retorna una fracció aleatòria entre 0,0 (inclòs) i 1,0 (exclòs).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Retorna un nombre aleatori entre els dos límits especificats, inclosos.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP =
  "Retorna ''e'' elevat a la potència del nombre indicat.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 =
  "Retorna 10 elevat a la potència del nombre indicat.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://ca.wikipedia.org/wiki/Funci%C3%B3_trigonom%C3%A8trica";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://ca.wikipedia.org/wiki/Procediment_%28Programació%29";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Executa la funció definida per usuari '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://ca.wikipedia.org/wiki/Procediment_%28Programació%29";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Executa la funció definida per l'usuari '%1' i utilitza la seva sortida.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Advertència: Aquesta funció té paràmetres duplicats.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Si el valor és cert, llavors retorna un segon valor.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Advertència: Aquest bloc només es pot utilitzar dins de la definició d'una funció.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Afegir, eliminar o canviar l'ordre de les entrades per aquesta funció.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Retorna una còpia del text amb diferents majúscules/minúscules.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Recupera la lletra de la posició especificada.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Compta quantes vegades hi ha un text dins d'un altre text.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Afegeix, esborrar o reordenar seccions per reconfigurar aquest bloc de text.";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END =
  "fins a la lletra núm.# des del final";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "recupera subcadena des de la primera lletra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "recupera subcadena des de la lletra núm.# des del final";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "recupera subcadena des de la lletra núm.#";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = ""; // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Recupera una part especificada del text.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Retorna l'índex de la primera/última aparició del primer text dins el segon. Retorna %1 si no es troba el text.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Retorna cert si el text proporcionat està buit.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Crea un tros de text per unió de qualsevol nombre d'elements.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "llargària de %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Retorna el nombre de lletres (espais inclosos) en el text proporcionat.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Imprimir el text, el nombre o altre valor especificat.";
Blockly.Msg.TEXT_PROMPT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#getting-input-from-the-user"; // untranslated
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Demana que l'usuari introdueixi un nombre.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT =
  "Demana que l'usuari introdueixi un text.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Substitueix totes les aparicions d'un text dins d'un altre text.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Inverteix l'ordre dels caràcters en el text.";
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://ca.wikipedia.org/wiki/Cadena_%28inform%C3%A0tica%29";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Retorna una còpia del text on s'han esborrat els espais d'un o dels dos extrems.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Modifica aquesta variable al valor introduït.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Ja existeix una variable anomenada '%1'.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Una variable anomenada '%1' ja existeix per al tipus '%2'.";
