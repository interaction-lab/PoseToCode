...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Varoitus: Tätä lohkoa voi käyttää vain silmukan sisällä.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Suorita joukko lausekkeita useampi kertaa.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Poistetaanko %1 käyttöä muuttujalta '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Tällä toiminnolla on päällekkäisiä syötteitä.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Et voi käyttää tyhjää muuttujan nimeä.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Listää, poista tai järjestele uudestaan osioita tässä lohkossa.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Palauta ensimmäinen kohde listalta.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Palauta kohde annetusta kohdasta listaa.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Poistaa kohteen listalta annetusta kohtaa.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "hae osalista alkaen kohdasta (lopusta laskien)";
...
Blockly.Msg.LISTS_INDEX_FROM_END_TOOLTIP =
  "Numero %1 tarkoittaa listan viimeistä kohdetta.";
Blockly.Msg.LISTS_INDEX_FROM_START_TOOLTIP =
  "Numero %1 tarkoittaa listan ensimmäistä kohdetta.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Palauttaa kohteen ensimmäisen/viimeisen esiintymän kohdan listassa. Palauttaa %1 jos kohdetta ei löydy.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Lisää kohteen listan kärkeen.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Lisää kohteen annettuun kohtaan listassa.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Asettaa kohteen annettuun kohtaan listassa.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "aakkosjärjestyksessä, välittämättä kirjainkoosta";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Yhdistä luettelon tekstit yhdeksi tekstiksi, erotettuina välimerkillä.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Jaa teksti osiin erotinmerkin perusteella ja järjestä osat listaksi.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://fi.wikipedia.org/wiki/Ep%C3%A4yht%C3%A4l%C3%B6";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Palauta tosi, jos syötteet ovat keskenään samat.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Palauttaa tosi, jos ensimmäinen syöte on suurempi, kuin toinen.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Palauttaa tosi, jos ensimmäinen syöte on pienempi, kuin toinen.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Palauttaa tosi, jos syötteet eivät ole keskenään samoja.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Palauttaa tosi, jos syöte on epätosi. Palauttaa epätosi, jos syöte on tosi.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Palauttaa tosi, jos kummatkin syötteet ovat tosia.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Palauttaa tosi, jos ainakin yksi syötteistä on tosi.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Palauta pisteen (X,Y) arkustangentti välillä -180–180.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://fi.wikipedia.org/wiki/Satunnaisluku";
...
Blockly.Msg.MATH_RANDOM_INT_TITLE =
  "Palauttaa satunnaisen kokonaisluvun väliltä %1-%2";
...
Blockly.Msg.MATH_ROUND_HELPURL =
  "https://fi.wikipedia.org/wiki/Py%C3%B6rist%C3%A4minen";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://fi.wikipedia.org/wiki/Neli%C3%B6juuri";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://fi.wikipedia.org/wiki/Trigonometrinen_funktio";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://fi.wikipedia.org/wiki/Aliohjelma";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Suorittaa käyttäjän määrittelemä funktio '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://fi.wikipedia.org/wiki/Aliohjelma";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Suorittaa käyttäjän määrittelemän funktion '%1' ja käyttää sen tuotosta.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Luo funktio, jolla ei ole tuotosta.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Lisää, poista tai järjestele uudelleen tämän toiminnon tulot.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Laske kuinka monta kertaa jokin teksti esiintyy jossakin toisessa tekstissä.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "hae osa alkaen ensimmäisestä kirjaimesta";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "hae osa alkaen kirjaimesta nro (lopusta laskien)";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "hae osa alkaen kirjaimesta nro";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Palauttaa ensin annetun tekstin ensimmäisen/viimeisen esiintymän osoitteen toisessa tekstissä. Palauttaa osoitteen %1 jos tekstiä ei löytynyt.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Palauttaa tosi, jos annettu teksti on tyhjä.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Kehottaa käyttäjää syöttämään numeron.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "Kehottaa käyttäjää syöttämään tekstiä.";
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER =
  "käyttäen annettua viestiä, kehottaa syöttämään numeron";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT =
  "käyttäen annettua viestiä, kehottaa syöttämään tekstiä";
...
Blockly.Msg.TEXT_REPLACE_MESSAGE0 =
  "Korvaa teksti %1 tekstillä %2 tekstissä %3";
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Korvaa tietyn tekstin ilmentymät tekstin sisällä.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Muuttaa tekstin kirjainten järjestyksen toisin päin.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Muuttuja nimeltä '%1' on jo olemassa toiselle tyypille: '%2'.";
