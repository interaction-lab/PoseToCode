...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Utwórz kolor składający sie z podanej ilości czerwieni, zieleni i błękitu. Zakres wartości: 0 do 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Uwaga: Ten klocek może być użyty tylko wewnątrz pętli.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Przypisz zmiennej '%1' kolejno wartość każdego elementu listy, a następnie wykonaj kilka instrukcji.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Zmiennej '%1' przypisuje wartości z podanego zakresu z podanym interwałem i wykonuje zadane bloki.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Dodaj, usuń lub zmień kolejność czynności, żeby zmodyfikować ten klocek „jeśli”.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Jeśli warunek jest spełniony, wykonaj zadane czynności.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Jeśli warunek jest spełniony, wykonaj pierwszy blok instrukcji.  W przeciwnym razie, wykonaj drugi blok instrukcji.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Jeśli pierwszy warunek jest spełniony, wykonaj pierwszy blok instrukcji.  W przeciwnym razie, jeśli drugi warunek jest spełniony, wykonaj drugi blok instrukcji.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Jeśli pierwszy warunek jest spełniony, wykonaj pierwszy blok czynności.  W przeciwnym razie jeśli drugi warunek jest spełniony, wykonaj drugi blok czynności.  Jeżeli żaden z warunków nie zostanie spełniony, wykonaj ostatni blok czynności.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Dopóki wyrażenie jest nieprawdziwe, wykonaj zadane czynności.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Dopóki wyrażenie jest prawdziwe, wykonaj zadane czynności.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ta funkcja ma zduplikowane wejścia.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Nie możesz utworzyć funkcji bez nazwy.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Zwraca listę o długości 0, nie zawierającą danych";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lista";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Dodaj, usuń lub zmień kolejność sekcji aby przekonfigurować blok tej listy.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Utwórz listę z dowolną ilością elementów.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Zwraca element z konkretnej pozycji na liście.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Usuwa i zwraca element z określonej pozycji na liście.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Usuwa element z określonej pozycji na liście.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST =
  "utwórz listę podrzędną od pierwszego";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "utwórz listę podrzędną z # od końca";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Zwraca indeks pierwszego/ostatniego wystąpienia elementu z listy. Zwraca %1, jeśli nie zostanie znaleziony.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Tworzy listę zawierającą podaną wartość powtórzoną żądaną ilość razy.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Wstawia element na żądanej pozycji listy.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Ustawia pierwszy element na liście.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Ustawia element w określonym miejscu na liście.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Ustawia ostatni element na liście.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Ustawia losowy element na liście.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabetycznie, ignoruj wielkość liter";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Rozdziela tekst zgodnie z separatorem tworząc listę z powstałych elementów.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Zwraca "prawda", jeśli wejścia są identyczne.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Zwraca "prawda" jeśli pierwsze wejście jest większe od drugiego.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  'Zwraca "prawda", jeśli pierwsze wejście jest większe lub równe drugiemu.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'Zwraca "prawda" jeśli pierwsze wejście jest mniejsze od drugiego.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  'Zwraca "prawda", jeśli pierwsze wejście jest mniejsze lub równe drugiemu.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Zwraca "prawda", jeśli wejścia nie są identyczne.';
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  'Zwraca "prawda", jeśli wejściu jest "fałsz". Zwraca "fałsz", jeśli na wejściu jest "prawda".';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Zwraca "prawda" jeśli na obydwóch wejściach jest "prawda".';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Zwraca "prawda" jeśli co najmniej na jednyk wejściu jest "prawda".';
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Sprawdź warunek w „test”. Jeśli warunek jest prawdziwy, to zwróci „jeśli prawda”; jeśli nie jest prawdziwy to zwróci „jeśli fałsz”.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Zwraca arcus tangens punktu (X, Y) w stopniach od -180 do 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://pl.wikipedia.org/wiki/Stała_(matematyka)";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Zwróć jedną wspólną stałą: π (3.141), e (2.718...), φ (1.618...), sqrt(2) (1.414...), sqrt(½) (0.707...) lub ∞ (nieskończoność).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Ogranicz liczbę, aby była w określonych granicach (włącznie).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  'Sprawdź, czy liczba jest parzysta, nieparzysta, pierwsza, całkowita, dodatnia, ujemna, lub czy jest podzielna przez podaną liczbę. Zwraca wartość "prawda" lub "fałsz".';
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Zwróć resztę z dzielenia dwóch liczb przez siebie.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Zwróć listę najczęściej występujących elementów w liście.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Zwróć losową liczbę całkowitą w ramach dwóch wyznaczonych granic, włącznie.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Zwraca logarytm dziesiętny danej liczby.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ROOT =
  "Zwróć pierwiastek kwadratowy danej liczby.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Zwróć wartość cosinusa o stopniu (nie w radianach).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Zwróć wartość sinusa o stopniu (nie w radianach).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Zwróć tangens o stopniu (nie w radianach).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Uruchom zdefiniowaną przez użytkownika funkcję '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://pl.wikipedia.org/wiki/Podprogram";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Uruchom zdefiniowaną przez użytkownika funkcję '%1' i użyj jej wyjścia.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Tworzy funkcję nie posiadającą wyjścia.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Dodaj, usuń lub zmień kolejność wejść tej funkcji.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Zwraca kopię tekstu z odwruconą wielkością liter.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Liczy ile razy dany tekst występuje w innym tekście.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Dodaj, usuń lub zmień kolejność sekcji, aby zmodyfikować klocek tekstowy.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "pobierz podciąg od pierwszej litery";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "pobierz podciąg od # litery od końca";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Zwraca indeks pierwszego/ostatniego wystąpienia pierwszego tekstu w drugim tekście. Zwraca wartość %1, jeśli tekst nie został znaleziony.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Zwraca prawda (true), jeśli podany tekst jest pusty.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Tworzy fragment tekstu, łącząc ze sobą dowolną liczbę tekstów.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Zastąp wszystkie wystąpienia danego tekstu innym.";
...
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://pl.wikipedia.org/wiki/Tekstowy_typ_danych";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Zwraca kopię tekstu z usuniętymi spacjami z jednego lub z obu końców tekstu.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Wartości zmiennej i  wejście będą identyczne.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "Zmienna o nazwie '%1' już istnieje.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Zmienna o nazwie '%1' już istnieje i jest typu '%2'.";
