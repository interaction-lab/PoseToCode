...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Ne povas forigi la variablon '%1' ĉar ĝi estas parto de la difino de la funkcio '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Kunmiksas du kolorojn laŭ specifita proporcio (0,0 - 1,0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Kreas koloron kun specifita kvanto de ruĝo, verdo, kaj bluo. Ĉiuj valoroj devas esti inter 0 kaj 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "daŭrigi je la venonta ripeto de la ciklo";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Eliri el la enhava ciklo.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Pretersalti la ceteron de tiu ĉi ciklo kaj daŭrigi je la venonta ripeto.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Averto: tiu ĉi bloko uzeblas nur ene de ciklo.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Pri ĉiu elemento en listo, difinas la variablon '%1' al la elemento, kaj faras kelkajn ordonojn.";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "kalkuli kun variablo %1 ekde %2 ĝis %3 per diferenco %4";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Varias la variablon '%1', ekde la komenca nombro ĝis la fina nombro, laŭ la specifita diferenco; dume rulas la specifitajn blokojn.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Aldoni kondiĉon al la bloko 'se'";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Aldoni 'aliokaze' kondiĉon al la 'se' bloko.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Aldoni, forigi aŭ reorganizi partojn por reagordi la 'se'-blokon.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Plenumi la unuan blokon de ordonoj se la valoro estas vero, se ne, la duan.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Se la unua valoro estas vero, do faras la unuan blokon de ordonoj. Alie, se la dua valoro estas vero, do faras la duan blokon de ordonoj.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Se la unua valoro estas vero, do faras la unuan blokon de ordonoj. Alie, se la dua valoro estas vero, do faras la duan blokon de ordonoj. Se neniu el la du valoroj estas vero, do faras la lastan blokon de ordonoj.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Plenumi ordonojn dum valoro egalas malvero.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Plenumi ordonojn dum la valoro egalas veron.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Ĉu forigi %1 uzojn de la variablo '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ĉi tiu funkcio havas du samnomajn enirojn.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "La nomo de la variablo devas esti ne malplena.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Liveri liston, de longo 0, sen datenaj rikordoj";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "listo";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Aldoni, forigi aŭ ordigi partojn por reagordi la listan blokon.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Krei liston kun ajna nombro de elementoj.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "La unua elemento en la listo esto liverita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Liveri la elementon ĉe la specifita pozicio en listo.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Liveri la lastan elementon en la listo.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Hazarda elemento en la listo estos liverita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "La unua elemento en la listo estos liverita kaj forigita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Liveri kaj forigi la elementon en la specifita pozicio de la listo.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Forigi kaj liveri la lastan elementon en listo.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Hazarda elemento en la listo estos liverita kaj forigita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "La unua elemento en la listo estos forigita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "La elemento en la specifita pozicio en la listo estos forigita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "La lasta elemento en la listo estos forigita.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Hazarda elemento en la listo estos forigita.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST =
  "akiri subliston ekde la unua elemento";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "akiri subliston ekde elemento de inversa numero";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START =
  "akiri subliston ekde elemento de numero";
Blockly.Msg.LISTS_GET_SUBLIST_TAIL = ""; // untranslated
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Kreas kopion de la specifita parto de listo.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "La indekso de la unua/lasta apero de la elemento en la listo estos liverita. %1 estos liverita se la elemento ne estas trovita.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "krei liston kun elemento %1 ripetita %2 fojojn";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Listo kun la specifita nombro de elementoj, kiuj havos la donitan valoron, estos kreita.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Antaŭaldonas la elementon ĉe la komenco de listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Enigas la elementon ĉe specifita pozicio en listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Postaldonas la elementon ĉe la fino de listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Enigas la elementon hazarde en listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Difinas la unua elementon en listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Difinas la elementon ĉe la specifita pozicio en listo";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Difinas la lastan elementon en listo.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Difinas hazardan elementon en listo.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Kunigas liston de tekstoj en unu tekston, kun apartigilo inter la elementoj.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Disdividas tekston en liston da tekstoj, laŭ apartigilo.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://eo.wikipedia.org/wiki/Neegala%C4%B5o_(pli_granda,_malpli_granda)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Liveri veron, se la du eniroj egalas.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Liveri veron, se la unua eniro estas pli granda ol la dua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Vero estos liverita, se la unua eniro estas pli granda aŭ egala al la dua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Liveri veron, se la unua eniro estas pli malgranda ol la dua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Vero estos liverita, se la unua eniro estas pli eta aŭ egala al la dua.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Liveri veron, se la du eniroj ne egalas.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Liveri veron, se la eniro egalas malveron. Liveri malveron, se la eniro egalas veron.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Liveri veron, se la du eniroj egalas veron.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Liveri veron, se almenaŭ unu el la eniroj egalas veron.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Kontroli la kondiĉon en 'testo'. Se la kondiĉo egalas veron, liveri la valoron 'se estas vero', aliokaze liveri la valoron 'se estas malvero'.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://eo.wikipedia.org/wiki/Aritmetiko";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD = "Liveri la sumon de la du nombroj.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Liveri la kvocienton de la du nombroj.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Liveri la diferencon inter la du nombroj.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "La produto de la du numeroj estos liverita.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Livero la tian potencon de la unua nombro, kia la dua nombro estas";
Blockly.Msg.MATH_ATAN2_HELPURL =
  "https://eo.wikipedia.org/wiki/Inversa_trigonometria_funkcio#Duargumenta_varianto_de_tangentarko";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 de X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Liveras la arkotangenton de punkto (X, Y) en gradoj inter -180 kaj 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://eo.wikipedia.org/wiki/Matematika_konstanto";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Liveras unu el la ofte uzataj konstantoj: π (3,141…), e (2,718…), φ (1,618…), √2 (1,414…), √½ (0,707…), aŭ ∞ (malfinio).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "La nombro estos limigita tiel ke ĝi egalas la limojn aŭ troviĝas inter ili.";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Vero aŭ malvero estos liverita, depende de la rezulto de kontrolo, ĉu nombro estas para, nepara, pozitiva, negativa, aŭ dividebla de iu nombro.";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Liveri la reston de la divido de la du nombroj.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Liveri la aritmetikan meznombron de la nombroj en la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Liveri la plej grandan nombron en la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  "Liveras la medianan nombron en la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Liveri la plej malgrandan nombron en la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Liveras liston de la plej ofta(j) elemento(j) en la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Liveri hazardan elementon el la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Liveri la norman devion de la listo.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Liveri la sumon de ĉiuj nombroj en la listo.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Liveras hazardan frakcion inter 0,0 (inkluzive) kaj 1,0 (ekskluzive).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Nombro estos hazarde liverita, tiel ke ĝi egalas la limojn aŭ troviĝas inter ili.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://eo.wikipedia.org/wiki/Kvadrata_radiko";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://eo.wikipedia.org/wiki/Trigonometria_funkcio";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Liveras la kosinuson de angulo en gradoj (ne radianoj).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Liveras la sinuson de angulo en gradoj (ne radianoj).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Liveras la tangenton de angulo en gradoj (ne radianoj).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://eo.wikipedia.org/wiki/Subprogramo";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Ruli la uzanto-difinitan funkcion '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://eo.wikipedia.org/wiki/Subprogramo";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Ruli la uzanto-difinitan funkcion '%1' kaj uzi ĝian eliron.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Aldoni, forigi, aŭ reorganizi enirojn je ĉi tiu funkcio.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Liveras kopion de la teksto je alia usklo.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Kalkuli kiomfoje iu teksto okazas en iu alia teksto.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Aldonu, forigu, aŭ reorganizu partojn por reagordi la tekstan blokon.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "akiri subsignoĉenon ekde la unua litero";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "akiri subsignoĉenon ekde litero de inversa numero";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "akiri subsignoĉenon ekde litero de numero";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = ""; // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Liveri specifitan parto de la teksto.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Liveras indekson de la unua/lasta okazo de la unua teksto en la dua teksto. Liveras %1 se la unua teksto ne okazas en la dua teksto.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Liveras veron, se la provizita teksto estas malplena.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Krei pecon de teksto per kunigi ajnan nombron de eroj.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "longo de %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Liveras la nombron de literoj (inkluzive de spacetoj) en la provizita teksto.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Presi la specifitan tekston, nombron aŭ alian valoron.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Anstataŭigi ĉiujn okazojn de iu teksto en alia teksto.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Inversigi la ordon de la skribsignoj en la teksto.";
...
Blockly.Msg.TEXT_TRIM_OPERATOR_LEFT =
  "forigi spacetojn for de maldekstra fino de";
Blockly.Msg.TEXT_TRIM_OPERATOR_RIGHT =
  "forigi spacetojn for de dekstra fino de";
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Liveras kopion de teksto, de kies fino(j) spacetoj foriĝis.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Jam ekzistas variablo kun la nomo '%1' por alia tipo: '%2'.";
