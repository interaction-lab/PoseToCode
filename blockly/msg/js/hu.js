...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "A(z) „%1” változó nem törölhető, mert része a(z) „%2” függvény definíciójának.";
...
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Az összecsukott blokk figyelmeztetéseket tartalmaz.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "folytatja a következővel";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Megszakítja az utasítást tartalmazó ciklust.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Kihagyja a ciklus további részét, és elölről kezdi a következő elemmel.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Figyelem: Ez a blokk csak cikluson belül használható.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "A '%1' változó minden lépésben megkapja a lista adott elemének értékét, és végrehajt vele néhány utasítást.";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "számolj %1 értékével %2 és %3 között %4 lépésközzel";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "A(z) '%1' változó felveszi a kezdőérték és a végérték közötti értékeket a meghatározott lépésközzel. Eközben a meghatározott blokkokat hajtja végre.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Feltétel hozzáadása a ha blokkhoz.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Végső feltétel hozzáadása a ha blokkhoz.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "A ha blokk testreszabásához bővítsd, töröld vagy rendezd át a részeit.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Ha a kifejezés igaz, akkor végrehajtja az utasításokat.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Ha a kifejezés igaz, akkor végrehajtja az első utasításblokkot. Különben a második utasításblokk kerül végrehajtásra.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Ha az első kifejezés igaz, akkor végrehajtja az első utasításblokkot. Különben, ha a második kifejezés igaz, akkor végrehajtja a második utasítás blokkot.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Megadott kódrészlet ismételt végrehajtása.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Amíg a feltétel hamis, végrehajtja az utasításokat.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "A(z) „%2” változó %1 használatának törlése?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ennek a függvénynek kettőzött bemenete van.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Nem használhat üres változónevet.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "A lista megadott sorszámú elemét adja eredményül.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Az első elem kivétele a listából.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "A megadott sorszámú elem kivétele a listából.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Az utolsó elem kivétele a listából.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Véletlenszerűen választott elem kivétele a listából.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "A megadott sorszámú elem törlése a listából.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "A megadott elem első vagy utolsó előfordulásával tér vissza. Ha nem talál ilyen elemet, akkor %1 a visszatérési érték.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "Lista készítése %1 elemet %2 alkalommal hozzáadva";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Beszúrás a megadott sorszámú elem elé a listában.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "A megadott sorszámú elem cseréje a listában.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "betűrendben nagybetű figyelmen kívül hagyásával";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "A lista elemeit összefűzi szöveggé a határoló karaktereket is felhasználva.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Listát készít a határoló karaktereknél törve a szöveget.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://hu.wikipedia.org/wiki/Egyenl%C5%91tlens%C3%A9g";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  'Kiértékeli a megvizsgálandó kifejezést. Ha a kifejezés igaz, visszatér az "érték, ha igaz" értékkel, különben az "érték, ha hamis" értékkel.';
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://hu.wikipedia.org/wiki/Matematikai_m%C5%B1velet";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Az első számnak a második számmal megegyező hatványa.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Az (X,Y) pont arkusz tangens értéke fokban -180 és 180 között.";
Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://hu.wikipedia.org/wiki/JavaScript#Aritmetikai_oper.C3.A1torok";
Blockly.Msg.MATH_CHANGE_TITLE = "növeld %1 értékét %2 -vel";
Blockly.Msg.MATH_CHANGE_TOOLTIP =
  'A "%1" változó értékének növelése egy számmal.';
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://hu.wikipedia.org/wiki/Matematikai_konstans";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Ellenőrzi, hogy a szám páros, páratlan, prím, egész, pozitív vagy negatív-e, illetve osztható-e a másodikkal. Igaz, vagy hamis értéket ad eredményül.";
Blockly.Msg.MATH_IS_WHOLE = "egész";
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://hu.wikipedia.org/wiki/Eg%C3%A9szr%C3%A9sz#Als.C3.B3_eg.C3.A9szr.C3.A9sz";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "A lista elemeinek átlagát adja eredményül.";
...
Blockly.Msg.MATH_ROUND_HELPURL =
  "https://hu.wikipedia.org/wiki/Eg%C3%A9szr%C3%A9sz#Kerek.C3.ADt.C3.A9s";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://hu.wikipedia.org/wiki/Gy%C3%B6kvon%C3%A1s";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Eljárás (nem ad vissza eredményt).";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Figyelem: Ez a blokk csak függvénydefiníción belül használható.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Bemenetek hozzáadása, eltávolítása vagy átrendezése ehhez a függvényhez.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "A szöveg előfordulásainak megszámolása egy másik szövegben.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "szövegben válaszd ki a hátulról a(z)";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST =
  "szövegben az első előfordulásának helye";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "szövegben az utolsó előfordulásának helye";
Blockly.Msg.TEXT_INDEXOF_TITLE = "A(z) %1 %2 %3 szövegnek";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "A keresett szöveg első vagy utolsó előfordulásával tér vissza.  %1 esetén a szövegrészlet nem található.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Megejelníti a megadott kaakterláncot üzenetként a képernyőn.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "A szöveg összes előfordulásának cseréje egy másik szöveggel.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Megfordítja a karakterek sorrendjét a szövegben.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Egy „%1” nevű változó már létezik egy másik típussal: „%2”.";
