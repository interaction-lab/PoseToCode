...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "As peul nen eliminesse la variàbil '%1' përchè a l'é part ëd la definission dla fonsion '%2'";
...
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Ij blòch sarà a conten-o dj'avertense.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "A mës-cia doi color ansema con un rapòrt dàit (0,0 - 1,0).";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continué con l'iterassion sucessiva dla liassa";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Seurte da la liassa anglobanta.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Atension: Ës blòch a peul mach esse dovrà andrinta a na liassa.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Gionté na condission final ch'a cheuj tut al blòch si.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Gionté, gavé o riordiné le session për cinfiguré torna ës blòch si.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "dësnò";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "dësnò si";
Blockly.Msg.CONTROLS_IF_MSG_IF = "si";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Si un valor a l'é ver, antlora eseguì chèiche anstrussion.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Cand un valor a l'é fàuss, eseguì chèiche anstrussion.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Cand un valor a l'é ver, eseguì chèiche anstrussion.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Eliminé %1 utilisassion ëd la variàbil '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Costa imission a dj'imission duplicà.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "A peul nen dovré un nòm ëd variàbil veuid.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Smon-e na lista, ëd longheur 0, ch'a conten gnun-a argistrassion";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Creé na lista con un nùmer qualsëssìa d'element.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "A smon l'ìndes ëd la prima/ùltima ocorensa dl'element ant la lista. A smon %1 se l'element a l'é nen trovà.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "creé na lista con l'element %1 arpetù %2 vire";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "A crea na lista ch'a consist dël valor dàit arpetù ël nùmer ëspessificà ëd vire.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "A anseriss l'element al prinsipi ëd na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "A anseriss l'element a la posission ëspessificà an na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Gionté l'element a la fin ëd na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "A anseriss l'element a l'ancàpit an na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "A fissa ël prim element an na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "A fissa l'element a la posission ëspessificà an na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "A fissa l'ùltim element an na lista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "A fissa n'element a l'ancàpit an na lista.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabétich, ignorand ël caràter minùscol o majùscol";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Gionze na lista ëd test ant un test sol, separandje con un separator.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Divide un test an na lista ëd test, tajand a minca 'n separator.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Rësponde ver si le doe imission a son uguaj.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Rësponde ver si la prima imission a l'é pi granda che la sconda.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Rësponde ver si la prima imission a l'é pi granda o ugual a la sconda.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Rësponde ver si la prima imission a l'é pi cita dla sconda.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Rësponde ver si la prima imission a l'é pi cita o ugual a la sconda.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Rësponde ver si le doe imission a son nen uguaj.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Rësponde ver se tute doe j'imission a son vere.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Rësponde ver se almanch un-a d'imission a l'é vera.";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Limité un nùmer a esse antra le limitassion ëspessificà (comprèise).";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "A smon la resta ëd la division dij doi nùmer.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "A smon la media (aritmética) dij valor numérich ant la lista.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "A smon na lista dj'element pi frequent ëd la lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "A smon n'element a l'ancàpit da la lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "A smon la deviassion ëstàndard ëd la lista.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "A smon la soma ëd tuti ij nùmer ant la lista.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "A smon na frassion aleatòria antra 0,0 (comprèis) e 1,0 (esclus).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "A smon n'antregh aleatòri antra ij doi lìmit ëspessificà, comprèis.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "A smon ël logaritm an base 10 d'un nùmer.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "A smon ël cosen ëd n'àngol an gré (pa an radiant).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "A smon ël sen ëd n'àngol an gré (pa an radiant).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "A smon la tangenta ëd n'àngol an gré (pa an radiant).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Eseguì la fonsion '%1' definìa da l'utent.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Eseguì la fonsion '%1' definìa da l'utent e dovré sò arzultà.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Atension: Costa fonsion a l'ha dij paràmeter duplicà.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Se un valor a l'é ver, antlora smon-e un second valor.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Atension: Ës blòch a podria esse dovrà mach an na definission ëd fonsion.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Gionté, gavé o riordiné j'imission ëd sa fonsion.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "A smon la litra ant la posission ëspessificà.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Conté vàire vire un test dàit a compariss an n'àutr test.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Gionté, gavé o riordiné le session për configuré torna ës blòch ëd test.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "oten-e la sota-stringa da la prima litra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "oten-e la sota-stringa da la litra # da la fin";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "oten-e la sota-stringa da la litra #";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "A smon l'ìndes dla prima/ùltima ocorensa dël prim test ant ël second test. A smon %1 se ël test a l'é nen trovà.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Creé un tòch ëd test an gionzend un nùmer qualsëssìa d'element.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "longheur ëd %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "A smon ël nùmer ëd litre (spassi comprèis) ant ël test fornì.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Smon-e ël test, ël nùmer o n'àutr valor ëspessificà.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Rampiassé tute j'ocorense d'un test con n'àutr.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "A smon na còpia dël test con jë spassi gavà da n'estremità o da tute doe.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Fissé costa variàbil ugual al valor d'imission.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Na variàbil con ël nòm '%1' a esist già.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Na variàbil ciamà '%1' a esist già për n'àutra sòrt: '%2'.";
