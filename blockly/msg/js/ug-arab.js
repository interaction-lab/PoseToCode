...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Blends two colours together with a given ratio (0.0 - 1.0)."; // untranslated
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Create a colour with the specified amount of red, green, and blue. All values must be between 0 and 100."; // untranslated
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  " كىيىنكى قېتىم داۋاملىق ئايلىنىشن";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "ئۇنىڭ دەۋرىي ئۈزۈلۈش ئۆز ئىچىگە ئالىدۇ .";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "بۇ ئايلىنىشنىڭ قالغان قىسمى ئاتلاپ ئۆتۈپ كېتىدۇ ، ھەمدە داۋاملىق كېلەر قېتىملىق ئىتېراتسىيە .";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "ئاگاھلاندۇرۇش : بۇ پەقەت بىر ئايلىنىش دەۋرى ئىچىدە ئىشلىتىشكە بولىدۇ .";
...
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  "بۇ بىلمەيمىز جۈملە بۆلىكى قوشۇلۇپ بىر if شەرتى .";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "ئەڭ ئاخىرقى قوشۇش ، ھەممە ئەھۋالنى ئۆز ئىچىگە ئالىدۇ بايرىمىدا بىلمەيمىز ifپارچىلىرى .";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "كۆپۈيۈپ كىتىدۇ، ئۆچۈرۈش ياكى قايتا تىزىلغان بايرام « if （ سۆزىنىڭ پارچە قايتىدىن تەقسىملەش .";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "ئەگەر قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئىككىنچى جۈملىسى ئىجرا قىلىندى .";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "ئەگەر تۇنجى قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئەگەر ئىككىنچى قىممىتى ، ئۇنداقتا ئىككىنچى پارچىنىڭ جۈملە .";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "ئەگەر تۇنجى قىممىتى ھەقىقەتەن ، ئۇنداقتا نىڭ بىر جۈملە . ئۇنداق بولمايدىكەن، ئەگەر ئىككىنچى قىممىتى ، بولسا ئىجرا قىلىش جۈملىسى ئىشككى پارچە . ئەگەر قىممىتى يوق ، ئۇنداقتا ئەڭ ئاخىرقى بىر جۈملىسى .";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://zh.wikipedia.org/wiki/Forئايلىنىش";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "While a value is false, then do some statements."; // untranslated
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "While a value is true, then do some statements."; // untranslated
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "ئۆچۈرۈش “%2” ئۆزگەرگۈچى مىقدار%1 ئىشلىتىلىش ئورنى بارمۇ؟";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "بۇنىڭدا مەزمۇننى قايتا كىرگۈزۈش ئىقتىدارى بار .";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "سىز ئۆزگەرگۈچى مىقدار نامى ئىشلىتىشكە بولمايدۇ .";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "ھەرب بويىچە تىزىل، چوڭ كىچىك يېزىلىش ھېساپ قىلىنمايدۇ";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "ئەگەر ئىككى دانە كىرگۈزۈش نەتىجىسى تەڭ بولسا ، راستىنلا كەينىگە قايتسا.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "ئەگەر تۇنجى كىرگۈزۈش نەتىجىسى ئىشككىنچى چوڭ بولسا راستىنلا كەينىگە قايتسا .";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "ئەگەر تۇنجى كىرگۈزۈش نەتىجىدە ئىشككىنچى كىچىك بولسا راستىنلا كەينىگە قايتسا .";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "ئەگەر تۇنجى كىرگۈزۈش نەتىجىدە ئىشككىنچى كىچىك بولسا راستىنلا كەينىگە قايتسا .";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "ئەگەر تۇنجى كىرگۈزۈش نەتىجىسى ئىككىنچى كىرگۈزۈش نەتىجىسى تىن تۆۋەن ياكى شۇنىڭغا تەڭ بولسا راستىنلا كەينىگە قايتسا .";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "ئەگەر ئىككى دانە كىرگۈزۈش نەتىجىسى تەڭ بولمايدۇ ، بەك كەلدى .";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Returns true if the input is false. Returns false if the input is true."; // untranslated
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Return true if both inputs are true."; // untranslated
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Check the condition in 'test'. If the condition is true, returns the 'if true' value; otherwise returns the 'if false' value."; // untranslated
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://zh.wikipedia.org/wiki/ئارىفمېتىكىلىق";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Return the quotient of the two numbers."; // untranslated
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Return the difference of the two numbers."; // untranslated
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Return the product of the two numbers."; // untranslated
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Return the first number raised to the power of the second number."; // untranslated
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://zh.wikipedia.org/wiki/ماتېماتىكا تۇراقلىق سانى";
...
Blockly.Msg.MATH_ROUND_HELPURL =
  "https://zh.wikipedia.org/wiki/سانلىق قىممەت تۈزىتىش";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://zh.wikipedia.org/wiki/كۋادرات يىلتىز";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Return the natural logarithm of a number."; // untranslated
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Return the base 10 logarithm of a number."; // untranslated
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://zh.wikipedia.org/wiki/ترىگونومېتىرىيىلىك فۇنكسىيە";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  'بارلىق بۆلەك “%1" ئۆزگەرگۈچى مىقدار قايتا ناملىنىپ :';
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "ئىسىملىك“%1” ئۆزگەرگۈچى مىقدار مەۋجۇت بولۇپ تۇرىدۇ ، لېكىن يەنە بىر ئۆزگەرگۈچى مىقدار تىپى بولۇش سۈپىتى بىلەن “%2” مەۋجۇت .";
