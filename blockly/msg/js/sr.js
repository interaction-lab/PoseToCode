...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Није могуће избрисати променљиву „%1” јер је део дефиниције функције „%2”";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Меша две боје заједно са датим односом (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Направите боју са одређеном количином црвене, зелене и плаве. Све вредности морају бити између 0 и 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Прескочи остатак ове петље, и настави са следећом итерацијом(понављанјем).";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Упозорење: Овај блок може да се употреби само унутар петље.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Имај промењиву "%1" узми вредности од почетног броја до задњег броја, бројећи по одређеном интервалу, и изврши одређене блокове.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Додајте услов блоку „ако“.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Додај коначни, catch-all  (ухвати све) услове иф блока.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Додај, уклони, или преуреди делове како бих реконфигурисали овај иф блок.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "ако је вредност тачна, онда изврши неке наредбе-изјаве.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Ако је прва вредност тачна, онда изврши први блок наредби, у супротном, ако је друга вредност тачна , изврши други блок наредби. Ако ни једна од вредности није тачна, изврши последнји блок наредби.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Док је вредност нетачна, извршава неке наредбе.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Док је вредност тачна, извршава неке наредбе.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Избрисати %1 употребу променљиве „%2”?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ова функција има дуплиране уносе.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Не можете да користите празно име променљиве.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Додајте, избришите, или преуредите делове како би се реорганизовали овај блок листе.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Направите списак са било којим бројем ставки.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Враћа индекс прве/последње појаве ставке на списку. Враћа %1 ако ставка није пронађена.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "Направити списак са ставком %1 која се понавља %2 пута";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Прави листу која се састоји од задане вредности коју понавлјамо одређени број шута.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "азбучно, игнориши мала и велика слова";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Спаја списак текстова у један текст, раздвојених граничником.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Раздваја текст у списак текстова, преламањем на сваком граничнику.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Враћа вредност „тачно“ ако су оба улаза једнака.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Враћа вредност „тачно“ ако је први унос већи од другог.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Враћа вредност „тачно“ ако је први унос већи или једнак другом.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Враћа вредност „тачно“ ако је први унос мањи од другог.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Враћа вредност „тачно“ ако је први унос мањи или једнак другом.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Враћа вредност „тачно“ ако су оба уноса неједнака.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Враћа вредност „тачно“ ако је унос нетачан. Враћа вредност „нетачно“ ако је унос тачан.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Проверите услов у „проба”. Ако је услов тачан, тада враћа „ако је тачно” вредност; у другом случају враћа „ако је нетачно” вредност.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+";
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://sr.wikipedia.org/wiki/Аритметика";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://sr.wikipedia.org/wiki/Математичка_константа";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Враћа једну од заједничких константи: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), или ∞ (бесконачно).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Ограничава број на доње и горње границе (укључиво).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Проверава да ли је број паран, непаран, прост, цео, позитиван, негативан, или дељив са одређеним бројем. Враћа „тачно” или „нетачно”.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Враћа просек (аритметичку средину) бројева са списка.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Враћа списак најчешћих ставки на списку.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://sr.wikipedia.org/wiki/Генератор_случајних_бројева";
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "случајни разломак";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Враћа случајни разломак између 0.0 (укључиво) и 1.0 (искључиво).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Враћа случајно одабрани цели број између две одређене границе, уклјучиво.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://sr.wikipedia.org/wiki/Квадратни_корен";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://sr.wikipedia.org/wiki/Тригонометријске_функције";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://sr.wikipedia.org/wiki/Потпрограм";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Покреће кориснички дефинисану функцију „%1”.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://sr.wikipedia.org/wiki/Потпрограм";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Покреће кориснички дефинисану функцију „%1” и користи њен излаз.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Враћа примерак текста са другачијом величином слова.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Броји колико пута се неки текст појављује унутар неког другог текста.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Додај, уклони, или другачије поредај одјелке како би изнова поставили овај текст блок.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "преузми подниску из слова # са краја";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Враћа индекс првог/задњег појављивања првог текста у другом тексту. Враћа %1 ако текст није пронађен.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Враћа „тачно” ако је достављени текст празан.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Прикажите одређени текст, број или другу вредност на екрану.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Замена свих појава неког текста унутар неког другог текста.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Враћа копију текста са уклонјеним простором са једног од два краја.";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET =
  "Направи блок за преузимање вредности из „%1”";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Поставља променљиву тако да буде једнака улазу.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "Променљива под именом ’%1’ већ постоји.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Променљива под именом ’%1’ већ постоји за други тип: ’%2’.";
