...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Nuk mund të fshihet variabla '%1' sepse është pjesë e definicionit të funksionit '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Perzien dy ngjyra së bashku me një raport të dhënë (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP =
  "Zgjidhni një ngjyrë në mënyrë të rastësishme.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK =
  "dil nga nje faze perseritese";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "vazhdo me elementin tjeter te nje faze perseritese";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Paralajmërim: Ky bllok mund të përdoret vetëm brenda unazës.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Shto një përfundues, që i mbërrin të gjitha kushtet në bllokun nëse.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Shto, fshij, ose rirregullo sektoret për ta rikonfiguruar këte bllok nëse.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Nëse një vlerë është e saktë, atëherë ekzekuto disa fjali.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Përderisa një vlerë është e pasaktë, atëherë ekzekuto disa fjali.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Përderisa një vlerë është e saktë, atëherë ekzekuto disa fjali.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Fshi përdorimin %1 të variablës '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ky funksion ka inpute të dyfishta.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Nuk mund të përdorni variabël pa emër.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Krijo një listë me ndonjë numbër të sendeve.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Kthen indeksin e ndodhjes së parë/fudit të sendit në listë. Kthen %1 nëse teksti nuk është gjetur.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Kthehet i saktë nëse lista është e zbraztë.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "krijo listën me sendin %1 të përsëritur %2 herë";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabetike, injoro madhësinë e shkronjave";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Ngjit një listë tekstesh në një, të ndara me ndarës.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Ndaj tekstin në një listë tekstesh, duke ndarë në secilin ndarës.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Ktheje të saktë nëse të dy hyrjet janë të barabarta me njëra-tjetrën.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Ktheje të saktë nëse hyrja e parë është më e madhe se hyrja e dytë.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Ktheje të saktë nëse hyrja e parë është më e vogël se hyrja e dytë.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Ktheje të saktë nëse të dy hyrjet nuk janë të barabarta me njëra-tjetrën.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Kthehet të saktë nëse të dy hyrjet janë të sakta.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Kthehet e saktë nëse së paku njëra nga hyrjet është e saktë.";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Vëni një numër që të jetë në mes të kufive të specifikuara(përfshirëse).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Kthen mesatarën (kuptimi aritmetik) i vlerave numerike të listës.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Kthe listën e sendit(eve) më të zakonshme të listës.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP =
  "Rrumbullakësimi i numrit të lartë ose të ulët.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Kthen 10 logaritmet bazë të një numri.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Kthe kosinusin e nje grade (jo ne radiant).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Kthe kosinusin e nje kendi (jo ne radiant).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Lësho funksionin e definuar nga përdoruesi '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Lëho funksionin e definuar nga përdoruesi '%1' dhe përdor daljen e tij.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Paralajmërim: Ky funksion ka parametra të dyfishuar.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Nëse një vlerë është e saktë, atëherë kthe një vlerë të dytë.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Shto, hiq, ose rirendit inputet e këtij funksioni.";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  "Ndrysho emrin e te gjitha '%1' variablave ne :";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Kthe nje shkronje nga nje pozicion i caktuar.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Numrin sa herë paraqitet një tekst brenda një teksti tjetër.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Shto, fshij, ose rirregullo sektoret për ta rikonfiguruar këtë bllok teksti.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "merr vlerat qe vazhdojne me shkronjen e pare";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "merr nenvargun nga shkronja # nga fundi";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "Merr nenvargun nga shkronja #";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = ""; // untranslated
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Pergjigjet me nje pjese te caktuar teksti.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Pergjigjet me indeksin e pare/fundit te rastisjes se tekstit te pare ne tekstin e dyte. Pergjigjet me %1 ne qofte se teksti nuk u gjet.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Kthehet e vertete neqoftese teksti i dhene eshte bosh.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Krijo nje pjese te tekstit duke bashkuar se bashku disa sende";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "gjatesi %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Pergjigjet me nje numer shkronjash (duke perfshire hapesire) ne tekstin e dhene.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Printo tekstin e caktuar, numer ose vlere tjeter.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Zëvendëso të gjitha paraqitjet e një teksti brenda një teksti tjetër.";
...
Blockly.Msg.VARIABLES_GET_TOOLTIP =
  "Pergjigjet me nje vlere te kesaj variable.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Vendos kete variable te jete e barabarte me te dhenat ne hyrje.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Një variabël e quajtur '%1' tashmë ekziston.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Një variabël me emrin '%1' veç ekziston për një tip tjetër: '%2'.";
