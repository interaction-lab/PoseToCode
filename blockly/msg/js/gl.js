...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Mestura dúas cores ca proporción indicada (0.0 - 1.0).";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Esta función ten entradas duplicadas.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Retona verdadeiro se a listaxe atópase baleira.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabética, iñorar maiúsculas/minúsculas";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://gl.wikipedia.org/wiki/Constante_matemática";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Retorna unha das constantes comúns: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ou ∞ (infinito).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Verifica se un número é par, impar, primo, enteiro, positivo, negativo, ou se é divisíbel por outro número.  Retorna verdadeiro ou falso.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Retorna a suma de tódolos números da listaxe.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP =
  "Arredonda un número cara enriba ou cara abaixo.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://gl.m.wikipedia.org/wiki/Función_trigonométrica";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Retorna a tanxente dun grao (non radiano).";
