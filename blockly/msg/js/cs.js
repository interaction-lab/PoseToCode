...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Upozornění: Tento blok může být použit pouze uvnitř smyčky.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Přidej konečnou podmínku zahrnující ostatní případy do bloku "pokud".';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Přidej, odstraň či uspořádej sekce k přenastavení tohoto bloku "pokud".';
...
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://cs.wikipedia.org/wiki/Cyklus_pro";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Dokud je hodnota nepravdivá, prováděj určité příkazy.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Dokud je hodnota pravdivá, prováděj určité příkazy.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Přidat, odebrat nebo změnit pořadí oddílů tohoto seznamu bloku.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Získá položku z určené pozice v seznamu.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Odstraní a získá položku z určené pozice v seznamu.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Odstraní a vrátí náhodnou položku v seznamu.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Odstraní první položku v seznamu.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Vrací index prvního/posledního výskytu položky v seznamu. Vrací %1, pokud položka nebyla nalezena.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Vrátí hodnotu pravda, pokud je seznam prázdný.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Spojit seznam textů do jednoho textu, rozdělaného oddělovači.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Rozdělit text do seznamu textů, lámání na oddělovačích.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://cs.wikipedia.org/wiki/Nerovnost_(matematika)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Vrátí hodnotu pravda, pokud se oba vstupy rovnají jeden druhému.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Navrátí hodnotu pravda, pokud první vstup je větší než druhý vstup.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Navrátí hodnotu pravda, pokud je první vstup menší než druhý vstup.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Vrátí hodnotu pravda, pokud se oba vstupy nerovnají sobě navzájem.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Vrátí hodnotu pravda, pokud oba dva vstupy jsou pravdivé.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Vrátí hodnotu pravda, pokud alespoň jeden ze vstupů má hodnotu pravda.";
Blockly.Msg.LOGIC_TERNARY_CONDITION = "test";
Blockly.Msg.LOGIC_TERNARY_HELPURL =
  "https://cs.wikipedia.org/wiki/Ternární operátor (programování)";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://cs.wikipedia.org/wiki/Aritmetika";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Vrátí první číslo umocněné na druhé číslo.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Vraťte jednu z následujících konstant: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (nekonečno).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Omezí číslo tak, aby bylo ve stanovených mezích (včetně).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Vrátí seznam nejčastějších položek seznamu.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM =
  "náhodné číslo mezi 0 (včetně) do 1";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Vrátí náhodné číslo mezi 0,0 (včetně) až 1,0";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Vrací náhodné celé číslo mezi dvěma určenými mezemi, včetně mezních hodnot.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://cs.wikipedia.org/wiki/Druhá_odmocnina";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
  "https://cs.wikipedia.org/w/index.php?title=Funkce_(programování)";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Upozornění: Tato funkce má duplicitní parametry.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Varování: Tento blok může být použit pouze uvnitř definici funkce.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Přidat, odebrat nebo změnit pořadí vstupů této funkce.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Vrátí kopii textu s jinou velikostí písmen.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Přidat, odebrat nebo změnit pořadí oddílů tohoto textového bloku.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "získat podřetězec od prvního písmene";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "získat podřetězec od písmene # od konce";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "získat podřetězec od písmene #";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Vrátí index prvního/posledního výskytu prvního textu v druhém textu.  Pokud text není nalezen, vypíše %1.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Vytvoří kousek textu spojením libovolného počtu položek.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "délka %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Vrátí počet písmen (včetně mezer) v zadaném textu.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Tisk zadaného textu, čísla nebo jiné hodnoty.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT =
  "Výzva pro uživatele k zadání nějakého textu.";
...
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://cs.wikipedia.org/wiki/Textov%C3%BD_%C5%99et%C4%9Bzec";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Vrátí kopii textu s odstraněnými mezerami z jednoho nebo obou konců.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Proměnná pojmenovaná jako '%1' již existuje pro jiný typ: '%2'.";
