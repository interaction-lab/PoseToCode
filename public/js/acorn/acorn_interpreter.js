...
const mod$$inline_58 = function (a) {
    ...
    for (; f < S; ) {
      ...
      if (a === 32) ++f;
        ...
        if (((a = k.charCodeAt(f + 1)), a === 42)) {
          ...
          const b = f;
          const d = k.indexOf("*/", (f += 2));
          d === -1 && c(f - 2, "Unterminated comment");
          f = d + 2;
          if (n.locations) {
            Y.lastIndex = b;
            for (let g = void 0; (g = Y.exec(k)) && g.index < f; )
      ...
      else if (a >= 5760 && Bb.test(String.fromCharCode(a))) ++f;
      else break;
    }
  }
  function m(a) {
    switch (a) {
      ...
      case 63:
        return ++f, g(ya);
      case 48:
        if (((a = k.charCodeAt(f + 1)), a === 120 || a === 88))
          return (
            (f += 2),
            (a = B(16)),
            a == null && c(x + 2, "Expected hexadecimal number"),
      ...
      case 47:
        return (
          (a = k.charCodeAt(f + 1)),
          R ? (++f, (a = K())) : (a = a === 61 ? t(U, 2) : t(za, 1)),
          a
        );
      case 37:
      case 42:
        return (
          (a = k.charCodeAt(f + 1)), (a = a === 61 ? t(U, 2) : t(Cb, 1)), a
        );
      case 124:
      case 38:
        return (
      ...
      case 94:
        return (
          (a = k.charCodeAt(f + 1)), (a = a === 61 ? t(U, 2) : t(Fb, 1)), a
        );
      case 43:
      case 45:
        return (
          (b = k.charCodeAt(f + 1)),
          b === a
            ? b == 45 && k.charCodeAt(f + 2) == 62 && na.test(k.slice(M, f))
              ? ((f += 3), h(), l(), (a = z()))
              : (a = t(Gb, 2))
            : (a = b === 61 ? t(U, 2) : t(Hb, 1)),
          a
      ...
      case 62:
        return (
          ...
          (d = 1),
          b === a
            ? ((d = a === 62 && k.charCodeAt(f + 2) === 62 ? 3 : 2),
              (a = k.charCodeAt(f + d) === 61 ? t(U, d + 1) : t(Ib, d)))
            : b == 33 &&
              a == 60 &&
              k.charCodeAt(f + 2) == 45 &&
              k.charCodeAt(f + 3) == 45
  ...
  function z(a) {
    ...
    if (a) return K();
    if (f >= S) return g(pa);
    let b = k.charCodeAt(f);
    if (la(b) || b === 92) return Ya();
    a = m(b);
    if (!1 === a) {
  ...
  function B(a, b) {
    for (var c = f, d = 0, e = 0, g = b == null ? Infinity : b; e < g; ++e) {
    ...
    return f === c || (b != null && f - c !== b) ? null : d;
  }
  function P(a) {
    const b = f;
    let d = !1;
    const e = k.charCodeAt(f) === 48;
    a || B(10) !== null || c(b, "Invalid number");
    k.charCodeAt(f) === 46 && (++f, B(10), (d = !0));
    a = k.charCodeAt(f);
    if (a === 69 || a === 101)
      (a = k.charCodeAt(++f)),
        (a !== 43 && a !== 45) || ++f,
        B(10) === null && c(b, "Invalid number"),
        (d = !0);
    la(k.charCodeAt(f)) && c(f, "Identifier directly after number");
    a = k.slice(b, f);
    let h;
  ...
  function ma(a) {
    a = B(16, a);
    a === null && c(x, "Bad character escape sequence");
    return a;
  }
  function $a() {
    ca = !1;
  ...
  function Ya() {
    ...
    ca ||
      (Lb(a)
        ? (b = Ca[a])
        : ((n.forbidReserved && (n.ecmaVersion === 3 ? Mb : Nb)(a)) ||
            (C && bb(a))) &&
    ...
    switch (a) {
      ...
      case eb:
        ...
        for (var e = 0; e < w.length; ++e) {
          var g = w[e];
          if (b.label == null || g.name === b.label.name) {
      ...
      case hb:
        ...
        if (p === La)
          return (
            ...
            a.declarations.length === 1 && u(ta) ? jb(b, a) : Ka(b, a)
          );
        a = A(!1, !0);
        ...
        for (r(); !u(T); ) {
          ...
          u(aa)
            ...
            ? ((g = d = !0),
              ...
              (e.value = Na(y(), !1)))
            : N();
          if (e.key.type === "Identifier" && (C || d)) {
            for (let f = 0; f < a.properties.length; ++f) {
              const l = a.properties[f];
              if (l.key.name === e.key.name) {
                let m =
                  h == l.kind ||
                  (g && l.kind === "init") ||
                  (h === "init" && (l.kind === "get" || l.kind === "set"));
                m && !C && h === "init" && l.kind === "init" && (m = !1);
  ...
  var Ab = (a.getLineInfo = function (a, b) {
    for (var c = 1, d = 0; ; ) {
      Y.lastIndex = d;
      const e = Y.exec(a);
  ...
  var V = { type: "name" };
  var pa = { type: "eof" };
  var Ha = { keyword: "break" };
  var Pa = { keyword: "case", beforeExpr: !0 };
  var qb = { keyword: "catch" };
  var eb = { keyword: "continue" };
  var fb = { keyword: "debugger" };
  var nb = { keyword: "default" };
  var gb = { keyword: "do", isLoop: !0 };
  var lb = { keyword: "else", beforeExpr: !0 };
  var sb = { keyword: "finally" };
  var hb = { keyword: "for", isLoop: !0 };
  var Ma = { keyword: "function" };
  var kb = { keyword: "if" };
  var mb = { keyword: "return", beforeExpr: !0 };
  var Oa = { keyword: "switch" };
  var ob = { keyword: "throw", beforeExpr: !0 };
  var pb = { keyword: "try" };
  var La = { keyword: "var" };
  var Ja = { keyword: "while", isLoop: !0 };
  var tb = { keyword: "with" };
  var yb = { keyword: "new", beforeExpr: !0 };
  var ub = { keyword: "this" };
  var vb = { keyword: "null", atomValue: null };
  var wb = { keyword: "true", atomValue: !0 };
  var xb = { keyword: "false", atomValue: !1 };
  var ta = { keyword: "in", binop: 7, beforeExpr: !0 };
  var Ca = {
    break: Ha,
    case: Pa,
    catch: qb,
  ...
  var ja = { type: "[", beforeExpr: !0 };
  var ka = { type: "]" };
  var Z = { type: "{", beforeExpr: !0 };
  var T = { type: "}" };
  var I = { type: "(", beforeExpr: !0 };
  var E = { type: ")" };
  var L = {
    type: ",",
    beforeExpr: !0,
  };
  var J = { type: ";", beforeExpr: !0 };
  var aa = { type: ":", beforeExpr: !0 };
  var xa = { type: "." };
  var ya = { type: "?", beforeExpr: !0 };
  var za = { binop: 10, beforeExpr: !0 };
  var Aa = { isAssign: !0, beforeExpr: !0 };
  var U = { isAssign: !0, beforeExpr: !0 };
  var Gb = { postfix: !0, prefix: !0, isUpdate: !0 };
  var Xa = { prefix: !0, beforeExpr: !0 };
  var Va = { binop: 1, beforeExpr: !0 };
  var Wa = { binop: 2, beforeExpr: !0 };
  var Db = { binop: 3, beforeExpr: !0 };
  var Fb = { binop: 4, beforeExpr: !0 };
  var Eb = { binop: 5, beforeExpr: !0 };
  var Kb = { binop: 6, beforeExpr: !0 };
  var Jb = { binop: 7, beforeExpr: !0 };
  var Ib = { binop: 8, beforeExpr: !0 };
  var Hb = {
    binop: 9,
    prefix: !0,
    beforeExpr: !0,
  };
  var Cb = { binop: 10, beforeExpr: !0 };
  a.tokTypes = {
    bracketL: ja,
    bracketR: ka,
    braceL: Z,
  ...
  for (const zb in Ca) a.tokTypes["_" + zb] = Ca[zb];
  var Mb = d(
  ...
  var Nb = d("class enum extends super const export import");
  var bb = d(
    "implements interface let package private protected public static yield"
  );
  var sa = d("eval arguments");
  var Lb = d(
  ...
  var na = /[\n\r\u2028\u2029]/;
  var Y = /\r\n|[\n\r\u2028\u2029]/g;
  var la = (a.isIdentifierStart = function (a) {
    return a < 65
      ? a === 36
      : a < 91
      ? !0
      ...
      : a < 123
      ? !0
      : a >= 170 && Za.test(String.fromCharCode(a));
  });
  var ab = (a.isIdentifierChar = function (a) {
    return a < 48
      ? a === 36
      : a < 58
      ? !0
      ...
      : a < 123
      ? !0
      : a >= 170 && Pb.test(String.fromCharCode(a));
  });
  let ca;
  var Ia = { kind: "loop" };
  var Ob = { kind: "switch" };
...
function u(a, b) {
  typeof a === "string" && (a = acorn.parse(a, ha));
  this.Ha = a.constructor;
  const c = new this.Ha({ options: {} });
  for (d in a) c[d] = d === "body" ? a[d].slice() : a[d];
  this.fa = c;
  this.kb = b;
  this.wa = !1;
  this.U = [];
  ...
  let e, g;
  for (g in this)
    typeof this[g] === "function" &&
      (e = g.match(d)) &&
      (this.pb[e[1]] = this[g].bind(this));
...
var ha = { Ca: 5 };
const ya = { configurable: !0, enumerable: !0, writable: !1 };
const B = { configurable: !0, enumerable: !1, writable: !0 };
const E = { configurable: !0, enumerable: !1, writable: !1 };
const za = { configurable: !1, enumerable: !0, writable: !0 };
const Aa = { STEP_ERROR: !0 };
const Ba = { SCOPE_REFERENCE: !0 };
const Ia = { VALUE_IN_DESCRIPTOR: !0 };
const Ja = { REGEXP_TIMEOUT: !0 };
const Ka = [];
let La = null;
const Ma = [
...
function db(a, b) {
  ...
  const d = /^[A-Za-z_$][\w$]*$/;
  let e = function (g) {
    const n = arguments.length ? String(arguments[arguments.length - 1]) : "";
    let p = Array.prototype.slice.call(arguments, 0, -1).join(",").trim();
    if (p) {
      p = p.split(/\s*,\s*/);
    ...
    try {
      ...
      I(a, a.da, "Invalid code: " + ja.message);
    }
    C.body.length !== 1 && I(a, a.da, "Invalid code in function body.");
  ...
  e = function (g, n) {
    ...
    n !== null &&
      ...
      (n instanceof F
        ? (p.A = yc(a, n))
        : I(a, a.g, "CreateListFromArrayLike called on non-object"));
    p.Ra = !1;
  };
  N(a, a.H, "apply", e);
  e = function (g) {
    const n = a.j[a.j.length - 1];
    n.Z = this;
    n.G = c(g);
    n.A = [];
    for (let p = 1; p < arguments.length; p++) n.A.push(arguments[p]);
    n.Ra = !1;
  };
  N(a, a.H, "call", e);
  a.U.push(
...
function eb(a, b) {
  function c(e) {
    (void 0 !== e && e !== null) ||
      I(a, a.g, "Cannot convert '" + e + "' to object");
  }
  let d = function (e) {
    if (void 0 === e || e === null) return zc(a) ? this : a.h(a.B);
    if (!(e instanceof F)) {
      const g = a.h(Pb(a, e));
      g.data = e;
      return g;
  ...
  d = function (e) {
    if (e === null) return a.h(null);
    e instanceof F ||
      I(a, a.g, "Object prototype may only be an Object or null");
    return a.h(e);
  };
  ...
  d = function (e, g, n) {
    g = String(g);
    e instanceof F || I(a, a.g, "Object.defineProperty called on non-object");
    n instanceof F || I(a, a.g, "Property description must be an object");
    !e.a[g] &&
      e.preventExtensions &&
      I(a, a.g, "Can't define property '" + g + "', object is not extensible");
  ...
  d = function (e, g) {
    e instanceof F ||
      I(a, a.g, "Object.getOwnPropertyDescriptor called on non-object");
    g = String(g);
    if (g in e.a) {
      const n = Object.getOwnPropertyDescriptor(e.a, g);
      const p = e.L[g];
      const z = e.O[g];
      const A = a.h(a.B);
      p || z
        ? (a.setProperty(A, "get", p), a.setProperty(A, "set", z))
        : (a.setProperty(A, "value", n.value),
          a.setProperty(A, "writable", n.writable));
      a.setProperty(A, "configurable", n.configurable);
      a.setProperty(A, "enumerable", n.enumerable);
      return A;
    }
  };
  a.setProperty(a.m, "getOwnPropertyDescriptor", a.b(d, !1), B);
  d = function (e) {
    c(e);
    return Pb(a, e);
  };
...
function Fb(a, b) {
  let c = function (d) {
    const e = zc(a) ? this : Ac(a);
    let g = arguments[0];
    if (arguments.length === 1 && typeof g === "number")
      isNaN(Na(g)) && I(a, a.$a, "Invalid array length"), (e.a.length = g);
    else {
  ...
  c = function (d, e) {
    const g = Array.prototype.splice.apply(this.a, arguments);
    return T(a, g);
  };
  N(a, a.l, "splice", c);
  c = function (d, e) {
    return T(a, Array.prototype.slice.call(this.a, d, e));
  };
  N(a, a.l, "slice", c);
  c = function (d) {
  ...
  c = function (d) {
    ...
    for (p = 0; p < arguments.length; p++)
      if (((n = arguments[p]), U(a, n, a.l))) {
        z = a.u(n, "length");
        for (let A = 0; A < z; A++) Bc(a, n, A) && (e[g] = a.u(n, A)), g++;
      } else e[g] = n;
    return T(a, e);
  };
  N(a, a.l, "concat", c);
...
function Gb(a, b) {
  ...
  for (let d = 0; d < c.length; d++) N(a, a.w, c[d], String.prototype[c[d]]);
  c = function (e, g, n) {
    g = g ? a.J(g) : void 0;
    n = n ? a.J(n) : void 0;
    return String(this).localeCompare(e, g, n);
  };
  N(a, a.w, "localeCompare", c);
  c = function (e, g, n) {
    const p = String(this);
    g = g ? Number(g) : void 0;
    if (U(a, e, a.C) && ((e = e.data), Cc(a, e, n), a.REGEXP_MODE === 2)) {
      if (La)
        (e = Dc(
          a,
          "string.split(separator, limit)",
          { string: p, separator: e, limit: g },
          e,
          n
        )),
          e !== Ja && n(T(a, e));
  ...
  c = function (e, g) {
    ...
    if (a.REGEXP_MODE === 2)
      if (La)
        (n = Dc(a, "string.match(regexp)", { string: n, regexp: e }, e, g)),
          n !== Ja && g(n && T(a, n));
      else {
        const p = a.X();
        const z = Uc(a, e, p, g);
  ...
  c = function (e, g) {
    ...
    if (a.REGEXP_MODE === 2) {
      if (La)
        (n = Dc(a, "string.search(regexp)", { string: n, regexp: e }, e, g)),
          n !== Ja && g(n);
      else {
        const p = a.X();
        const z = Uc(a, e, p, g);
...
function Ib(a, b) {
  ...
  for (let d = 0; d < c.length; d++) a.setProperty(a.S, c[d], Number[c[d]], E);
  c = function (e) {
    try {
...
function Jb(a, b) {
  let c = function (g, n) {
    if (!zc(a)) return Date();
    const p = [null].concat(Array.from(arguments));
...
function Kb(a, b) {
  ...
  c = function (d, e) {
    ...
    if (a.REGEXP_MODE === 2) {
      if (La) {
        var p = Dc(a, "regexp.exec(string)", { string: d, regexp: n }, n, e);
      ...
      (p = n.exec(d)), a.setProperty(this, "lastIndex", n.lastIndex), e(g(p));
  };
  Vc(a, a.C, "exec", c);
}
function Lb(a, b) {
...
function Mb(a, b) {
  ...
  for (
    var d = "E LN2 LN10 LOG2E LOG10E PI SQRT1_2 SQRT2".split(" "), e = 0;
    e < d.length;
    e++
  )
...
function Nb(a, b) {
  ...
  c = function (e, g, n) {
    g && g.F === "Function"
      ? I(a, a.g, "Function replacer on JSON.stringify not supported")
      : g && g.F === "Array"
      ? ((g = yc(a, g)),
        (g = g.filter(function (z) {
          return typeof z === "string" || typeof z === "number";
        })))
      : (g = null);
    typeof n !== "string" && typeof n !== "number" && (n = void 0);
    e = a.J(e);
    try {
...
function Dc(a, b, c, d, e) {
  const g = { timeout: a.REGEXP_THREAD_TIMEOUT };
  try {
...
function Cc(a, b, c) {
  if (a.REGEXP_MODE === 0) var d = !1;
  else if (a.REGEXP_MODE === 1) d = !0;
  else if (La) d = !0;
  else if (typeof Worker === "function" && typeof URL === "function") d = !0;
...
function Xc(a, b, c) {
  ...
  c
    ? ((c = a.h(a.B)),
      a.setProperty(d, "prototype", c, B),
      a.setProperty(c, "constructor", d, B))
    : (d.Hb = !0);
...
q.b = function (a, b) {
  const c = Xc(this, a.length, b);
  c.Ga = a;
  a.id = this.Sa++;
  return c;
};
q.eb = function (a) {
  const b = Xc(this, a.length, !0);
  b.Ma = a;
  a.id = this.Sa++;
  return b;
};
q.ua = function (a) {
  ...
  if (a instanceof Date)
    return (b = this.h(this.Za)), (b.data = new Date(a.valueOf())), b;
  if (typeof a === "function") {
    const c = this;
    return this.b(function () {
      let e = Array.prototype.slice.call(arguments).map(function (g) {
        return c.J(g);
      });
      e = a.apply(c, e);
      return c.ua(e);
  ...
  if (Array.isArray(a)) {
    ...
    for (var d = 0; d < a.length; d++)
      d in a && this.setProperty(b, d, this.ua(a[d]));
    return b;
  }
  b = this.h(this.B);
...
q.J = function (a, b) {
  ...
  c = b || { Va: [], Fa: [] };
  let d = c.Va.indexOf(a);
  if (d !== -1) return c.Fa[d];
  c.Va.push(a);
  if (U(this, a, this.l)) {
    var e = [];
    c.Fa.push(e);
    ...
    for (g in ((e = {}), c.Fa.push(e), a.a))
      g !== "__proto__" && ((d = a.a[g]), (e[g] = this.J(d, c)));
  }
  c.Va.pop();
  c.Fa.pop();
  return e;
...
function T(a, b) {
  for (
    var c = Ac(a), d = Object.getOwnPropertyNames(b), e = 0;
    e < d.length;
    e++
  )
...
q.u = function (a, b) {
  ...
  b = String(b);
  (void 0 !== a && a !== null) ||
    I(this, this.g, "Cannot read property '" + b + "' of " + a);
  if (typeof a === "object" && !(a instanceof F))
    throw TypeError("Expecting native value or pseudo object");
  if (b === "length") {
    if (U(this, a, this.w)) return String(a).length;
  } else if (b.charCodeAt(0) < 64 && U(this, a, this.w)) {
    var c = Oa(b);
    if (!isNaN(c) && c < String(a).length) return String(a)[c];
  }
  do if (a.a && b in a.a) return (c = a.L[b]) ? ((this.I = !0), c) : a.a[b];
  while ((a = Pb(this, a)));
};
function Bc(a, b, c) {
  if (!(b instanceof F))
  ...
  c = String(c);
  if (c === "length" && U(a, b, a.w)) return !0;
  if (U(a, b, a.w)) {
    const d = Oa(c);
    if (!isNaN(d) && d < String(b).length) return !0;
  }
  do if (b.a && c in b.a) return !0;
  while ((b = Pb(a, b)));
  return !1;
}
q.setProperty = function (a, b, c, d) {
  ...
  b = String(b);
  (void 0 !== a && a !== null) ||
    I(this, this.g, "Cannot set property '" + b + "' of " + a);
  if (typeof a === "object" && !(a instanceof F))
    throw TypeError("Expecting native value or pseudo object");
  d &&
    ("get" in d || "set" in d) &&
  ...
  let e = !this.j || Ob(this).P;
  if (a instanceof F) {
    if (U(this, a, this.w)) {
      var g = Oa(b);
      if (b === "length" || (!isNaN(g) && g < String(a).length)) {
        e &&
          I(
            this,
            this.g,
    ...
    if (!a.preventExtensions || b in a.a) {
      if (d) {
        ...
        "writable" in d &&
          ((e.writable = d.writable), delete a.L[b], delete a.O[b]);
        "value" in d
          ? ((e.value = d.value), delete a.L[b], delete a.O[b])
          : c !== Ia && ((e.value = c), delete a.L[b], delete a.O[b]);
        try {
    ...
    e && I(this, this.g, "Can't create property '" + b + "' on '" + a + "'");
};
function N(a, b, c, d) {
...
function $c(a, b) {
  ...
  (c.type === "UnaryExpression" && c.operator === "typeof") ||
...
function ad(a, b, c) {
  ...
  if (d === a.M && (!e || Bc(a, d.object, b)))
    return a.setProperty(d.object, b, c);
  I(a, a.ab, b + " is not defined");
}
function Pa(a, b, c) {
  if (b.type === "VariableDeclaration")
    for (var d = 0; d < b.declarations.length; d++)
      a.setProperty(c.object, b.declarations[d].id.name, void 0, za);
  else {
    if (b.type === "FunctionDeclaration") {
      a.setProperty(c.object, b.id.name, xc(a, b, c), za);
      return;
    }
    if (b.type === "FunctionExpression" || b.type === "ExpressionStatement")
      return;
  }
    ...
    if (n && typeof n === "object") {
      if (Array.isArray(n))
        for (d = 0; d < n.length; d++)
          n[d] && n[d].constructor === e && Pa(a, n[d], c);
      else {
        n.constructor === e && Pa(a, n, c);
      }
    }
  }
}
...
function dd(a, b, c, d) {
  ...
  const e = a.j;
  a: for (; e.length > 0; e.pop()) {
    const g = e[e.length - 1];
    switch (g.node.type) {
      case "TryStatement":
        g.T = { type: b, value: c, label: d };
        return;
      case "CallExpression":
      case "NewExpression":
        if (b === 3) {
    ...
    if (b === 1) {
      if (d ? g.labels && g.labels.indexOf(d) !== -1 : g.N || g.Jb) {
        e.pop();
        return;
      }
    } else if (b === 2 && (d ? g.labels && g.labels.indexOf(d) !== -1 : g.N))
      return;
  }
  U(a, c, a.v)
    ? ((b = {
  ...
  if (this.F === "Array") {
    ...
    try {
      for (var b = [], c = 0; c < this.a.length; c++) {
        var d = this.a[c];
        b[c] = d instanceof F && a.indexOf(d) !== -1 ? "..." : d;
      }
    } finally {
      a.pop();
    }
...
u.prototype.stepArrayExpression = function (a, b, c) {
  ...
  let d = b.o || 0;
  b.Ba
    ? (this.setProperty(b.Ba, d, b.value), d++)
    : ((b.Ba = Ac(this)), (b.Ba.a.length = c.length));
  for (; d < c.length; ) {
...
u.prototype.stepAssignmentExpression = function (a, b, c) {
  ...
  if (!b.pa) {
    ...
    if (
      !b.na &&
      c.operator !== "=" &&
      ((a = bd(this, b.ra)), (b.$ = a), this.I)
    )
      return (b.na = !0), ed(this, a, b.ra);
    b.pa = !0;
  ...
  if (b.ia) a.pop(), (a[a.length - 1].value = b.Wa);
    ...
    if ((c = cd(this, b.ra, d)))
      return (b.ia = !0), (b.Wa = d), fd(this, c, b.ra, d);
    a.pop();
...
u.prototype.stepBinaryExpression = function (a, b, c) {
  ...
  switch (c.operator) {
    ...
    case "in":
      b instanceof F ||
        I(this, this.g, "'in' expects an object, not '" + b + "'");
      c = Bc(this, b, d);
      break;
    case "instanceof":
      U(this, b, this.H) ||
        I(this, this.g, "Right-hand side of instanceof is not an object");
...
u.prototype.stepCallExpression = function (a, b, c) {
  ...
  if (b.ha === 1) {
    ...
    if (Array.isArray(d)) {
      if (
        ((b.Z = bd(this, d)),
        d[0] === Ba ? (b.yb = d[1] === "eval") : (b.G = d[0]),
        (d = b.Z),
        this.I)
      )
        return (b.ha = 1), ed(this, d, b.value);
    } else b.Z = d;
    b.A = [];
    b.o = 0;
  }
  ...
  if (b.Ra)
    a.pop(),
      (a[a.length - 1].value =
        b.isConstructor && typeof b.value !== "object" ? b.G : b.value);
  else {
    b.Ra = !0;
    ...
    if ((a = d.node)) {
      ...
      for (var g = 0; g < a.params.length; g++)
        this.setProperty(
          c.object,
          a.params[g].name,
          b.A.length > g ? b.A[g] : void 0
        );
      e = Ac(this);
      for (g = 0; g < b.A.length; g++) {
        this.setProperty(e, g, b.A[g]);
      }
    ...
    if (d.eval)
      if (((d = b.A[0]), typeof d !== "string")) b.value = d;
      else {
        try {
...
u.prototype.stepCatchClause = function (a, b, c) {
  if (b.K) a.pop();
    ...
    return (
      (b.K = !0),
      (a = Zc(this, b.scope)),
      this.setProperty(a.object, c.param.name, b.Qb),
      new v(c.body, a)
    );
};
u.prototype.stepConditionalExpression = function (a, b, c) {
  let d = b.ba || 0;
  if (d === 0) return (b.ba = 1), new v(c.test, b.scope);
  if (d === 1) {
    b.ba = 2;
  ...
  a.pop();
  c.type === "ConditionalExpression" && (a[a.length - 1].value = b.value);
};
...
u.prototype.stepForInStatement = function (a, b, c) {
  if (
    !b.Db &&
    ((b.Db = !0), c.left.declarations && c.left.declarations[0].init)
  )
    return (
      b.scope.P &&
        I(
      ...
      new v(c.left, b.scope)
    );
  if (!b.oa)
    return (b.oa = !0), b.ca || (b.ca = b.value), new v(c.right, b.scope);
    ...
    a: for (;;) {
      if (b.i instanceof F) {
        for (b.ka || (b.ka = Object.getOwnPropertyNames(b.i.a)); ; ) {
          ...
          if (void 0 === d) break;
          if (
            Object.prototype.hasOwnProperty.call(b.i.a, d) &&
            !b.Xa[d] &&
            ((b.Xa[d] = !0),
  ...
  if (!b.hb)
    if (((b.hb = !0), (a = c.left), a.type === "VariableDeclaration"))
      b.ca = [Ba, a.declarations[0].id.name];
    else return (b.ca = null), (b = new v(a, b.scope)), (b.ga = !0), b;
  b.ca || (b.ca = b.value);
  if (!b.ia && ((b.ia = !0), (a = b.Ea), (d = cd(this, b.ca, a))))
    return fd(this, d, b.ca, a);
  b.Ea = void 0;
  b.hb = !1;
  b.ia = !1;
...
u.prototype.stepForStatement = function (a, b, c) {
  ...
  else if (d === 3 && ((b.ba = 1), c.update)) return new v(c.update, b.scope);
};
...
u.prototype.stepObjectExpression = function (a, b, c) {
  let d = b.o || 0;
  let e = c.properties[d];
  if (b.i) {
    var g = e.key;
    if (g.type === "Identifier") var n = g.name;
    else if (g.type === "Literal") n = g.value;
...
u.prototype.stepSwitchStatement = function (a, b, c) {
  ...
  b.V === 1 && ((b.V = 2), (b.Pb = b.value), (b.Pa = -1));
  for (;;) {
    const d = b.Ta || 0;
    const e = c.cases[d];
    if (b.ta || !e || e.test)
      if (e || b.ta || b.Pa === -1)
        if (e) {
          if (!b.ta && !b.qb && e.test)
            return (b.qb = !0), new v(e.test, b.scope);
          if (b.ta || b.value === b.Pb) {
            b.ta = !0;
            const g = b.o || 0;
            if (e.consequent[g])
              return (
                (b.Jb = !0), (b.o = g + 1), new v(e.consequent[g], b.scope)
              );
          }
          b.qb = !1;
          b.o = 0;
...
u.prototype.stepTryStatement = function (a, b, c) {
  ...
  if (b.T && b.T.type === 4 && !b.Cb && c.handler)
    return (
      (b.Cb = !0),
      (a = new v(c.handler, b.scope)),
      (a.Qb = b.T.value),
      (b.T = void 0),
      a
    );
...
u.prototype.stepUnaryExpression = function (a, b, c) {
  if (!b.K)
    return (
      (b.K = !0),
      (a = new v(c.argument, b.scope)),
      (a.ga = c.operator === "delete"),
      a
    );
  a.pop();
  let d = b.value;
  if (c.operator === "-") d = -d;
    ...
    if (Array.isArray(d)) {
      ...
      try {
        ...
        b.scope.P
          ? I(this, this.g, "Cannot delete property '" + d + "' of '" + e + "'")
          : (c = !1);
      }
    }
    d = c;
  } else if (c.operator === "typeof") {
    d = d && d.F === "Function" ? "function" : typeof d;
  } else if (c.operator === "void") d = void 0;
...
u.prototype.stepUpdateExpression = function (a, b, c) {
  ...
  if (b.ia) a.pop(), (a[a.length - 1].value = b.Wa);
    ...
    c = c.prefix ? e : d;
    if ((d = cd(this, b.sa, e)))
      return (b.ia = !0), (b.Wa = c), fd(this, d, b.sa, e);
    a.pop();
    a[a.length - 1].value = c;
  }
};
