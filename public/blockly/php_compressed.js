...
(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    // Browser
    root.Blockly.PHP = factory(root.Blockly);
  }
  ...
  Blockly.PHP.multiline_quote_ = function (a) {
    return a.split(/\n/g).map(Blockly.PHP.quote_).join(' . "\\n" .\n');
  };
  Blockly.PHP.scrub_ = function (a, b, c) {
    ...
    if (!a.outputConnection || !a.outputConnection.targetConnection) {
      ...
      e &&
        ((e = Blockly.utils.string.wrap(e, Blockly.PHP.COMMENT_WRAP - 3)),
        (d += Blockly.PHP.prefixLines(e, "// ") + "\n"));
      for (var f = 0; f < a.inputList.length; f++)
        a.inputList[f].type == Blockly.INPUT_VALUE &&
          (e = a.inputList[f].connection.targetBlock()) &&
          (e = Blockly.PHP.allNestedComments(e)) &&
          (d += Blockly.PHP.prefixLines(e, "// "));
    }
  ...
  Blockly.PHP.getAdjusted = function (a, b, c, d, e) {
    ...
    a =
      0 < c
        ? Blockly.PHP.valueToCode(a, b, Blockly.PHP.ORDER_ADDITION) || f
        : 0 > c
        ? Blockly.PHP.valueToCode(a, b, Blockly.PHP.ORDER_SUBTRACTION) || f
        : d
        ? Blockly.PHP.valueToCode(a, b, Blockly.PHP.ORDER_UNARY_NEGATION) || f
        : Blockly.PHP.valueToCode(a, b, e) || f;
    if (Blockly.isNumber(a)) (a = Number(a) + c), d && (a = -a);
      ...
      if (0 < c) {
        ...
        0 > c && ((a = a + " - " + -c), (g = Blockly.PHP.ORDER_SUBTRACTION));
      d &&
        ((a = c ? "-(" + a + ")" : "-" + a),
        (g = Blockly.PHP.ORDER_UNARY_NEGATION));
      g = Math.floor(g);
      e = Math.floor(e);
      g && e >= g && (a = "(" + a + ")");
    }
  ...
  Blockly.PHP.colour_picker = function (a) {
    return [
      Blockly.PHP.quote_(a.getFieldValue("COLOUR")),
      Blockly.PHP.ORDER_ATOMIC,
    ];
  };
  Blockly.PHP.colour_random = function (a) {
    return [
      Blockly.PHP.provideFunction_("colour_random", [
  ...
  Blockly.PHP.colour_rgb = function (a) {
    ...
    return [
      Blockly.PHP.provideFunction_("colour_rgb", [
  ...
  Blockly.PHP.colour_blend = function (a) {
    var b =
        Blockly.PHP.valueToCode(a, "COLOUR1", Blockly.PHP.ORDER_COMMA) ||
        "'#000000'",
      c =
        Blockly.PHP.valueToCode(a, "COLOUR2", Blockly.PHP.ORDER_COMMA) ||
        "'#000000'";
    a = Blockly.PHP.valueToCode(a, "RATIO", Blockly.PHP.ORDER_COMMA) || 0.5;
    return [
      Blockly.PHP.provideFunction_("colour_blend", [
        "function " +
  ...
  Blockly.PHP.lists_create_with = function (a) {
    for (var b = Array(a.itemCount_), c = 0; c < a.itemCount_; c++)
      b[c] =
        Blockly.PHP.valueToCode(a, "ADD" + c, Blockly.PHP.ORDER_COMMA) ||
        "null";
    b = "array(" + b.join(", ") + ")";
  ...
  Blockly.PHP.lists_isEmpty = function (a) {
    return [
      "empty(" +
        (Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_FUNCTION_CALL) ||
          "array()") +
        ")",
      Blockly.PHP.ORDER_FUNCTION_CALL,
    ];
  ...
  Blockly.PHP.lists_indexOf = function (a) {
    ...
    return [
      ("FIRST" == a.getFieldValue("END")
        ? Blockly.PHP.provideFunction_("indexOf", [
            "function " +
              Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
              "($haystack, $needle) {",
  ...
  Blockly.PHP.lists_getIndex = function (a) {
    ...
    switch (a.getFieldValue("WHERE") || "FROM_START") {
      case "FIRST":
        if ("GET" == b) {
          var c =
            Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_MEMBER) ||
            "array()";
        ...
        if ("GET_REMOVE" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) ||
              "array()"),
            ["array_shift(" + c + ")", Blockly.PHP.ORDER_FUNCTION_CALL]
          );
        if ("REMOVE" == b)
          return (
            (c =
        ...
        if ("GET" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) ||
              "array()"),
            ["end(" + c + ")", Blockly.PHP.ORDER_FUNCTION_CALL]
          );
        if ("GET_REMOVE" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) ||
              "array()"),
            ["array_pop(" + c + ")", Blockly.PHP.ORDER_FUNCTION_CALL]
          );
        if ("REMOVE" == b)
          return (
            (c =
        ...
        if ("GET" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_MEMBER) ||
              "array()"),
            [c + "[" + d + "]", Blockly.PHP.ORDER_MEMBER]
          );
        if ("GET_REMOVE" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_COMMA) ||
              "array()"),
            [
              "array_splice(" + c + ", " + d + ", 1)[0]",
              Blockly.PHP.ORDER_FUNCTION_CALL,
            ]
          );
        if ("REMOVE" == b)
        ...
        if ("GET" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_COMMA) ||
              "array()"),
            (d = Blockly.PHP.getAdjusted(a, "AT", 1, !0)),
            [
              "array_slice(" + c + ", " + d + ", 1)[0]",
              Blockly.PHP.ORDER_FUNCTION_CALL,
            ]
      ...
      case "RANDOM":
        ...
        if ("GET" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_get_random_item", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "($list) {",
        ...
        if ("GET_REMOVE" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_get_remove_random_item", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "(&$list) {",
        ...
        if ("REMOVE" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_remove_random_item", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "(&$list) {",
  ...
  Blockly.PHP.lists_setIndex = function (a) {
    var b = a.getFieldValue("MODE") || "GET",
      ...
      d =
        Blockly.PHP.valueToCode(a, "TO", Blockly.PHP.ORDER_ASSIGNMENT) ||
        "null";
    switch (c) {
      case "FIRST":
        if ("SET" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_MEMBER) ||
              "array()"),
            c + "[0] = " + d + ";\n"
          );
        if ("INSERT" == b)
          return (
            (c =
              Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_COMMA) ||
              "array()"),
            "array_unshift(" + c + ", " + d + ");\n"
          );
        break;
      case "LAST":
        ...
        if ("SET" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_set_last_item", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "(&$list, $value) {",
      ...
      case "FROM_END":
        ...
        if ("SET" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_set_from_end", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "(&$list, $at, $value) {",
        ...
        if ("INSERT" == b)
          return (
            (b = Blockly.PHP.provideFunction_("lists_insert_from_end", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
                "(&$list, $at, $value) {",
      ...
      case "RANDOM":
        c =
          Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_REFERENCE) ||
          "array()";
        c.match(/^\$\w+$/)
          ? (a = "")
          : ((a = Blockly.PHP.variableDB_.getDistinctName(
              "tmp_list",
              Blockly.VARIABLE_CATEGORY_NAME
            )),
            (e = a + " = &" + c + ";\n"),
            (c = a),
            (a = e));
        e = Blockly.PHP.variableDB_.getDistinctName(
          "tmp_x",
          Blockly.VARIABLE_CATEGORY_NAME
        );
      ...
      if (b.match(/^\$\w+$/) || ("FROM_END" != c && "FROM_START" == d)) {
        ...
        switch (d) {
          case "FROM_START":
            ...
            c = a + " - ";
            c =
              Blockly.isNumber(String(e)) || String(e).match(/^\(.+\)$/)
                ? c + e
                : c + ("(" + e + ")");
            c += " + 1";
            break;
        ...
        (e = Blockly.PHP.getAdjusted(a, "AT1")),
          ...
          (b =
            Blockly.PHP.provideFunction_("lists_get_sublist", [
              "function " +
                Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.PHP.lists_sort = function (a) {
    ...
    return [
      Blockly.PHP.provideFunction_("lists_sort", [
        "function " +
          Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
          "($list, $type, $direction) {",
        "  $sortCmpFuncs = array(",
  ...
  Blockly.PHP.controls_if = function (a) {
    ...
    Blockly.PHP.STATEMENT_PREFIX &&
      (c += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, a));
    do {
      var d =
        Blockly.PHP.valueToCode(a, "IF" + b, Blockly.PHP.ORDER_NONE) || "false";
      var e = Blockly.PHP.statementToCode(a, "DO" + b);
      Blockly.PHP.STATEMENT_SUFFIX &&
        (e =
          Blockly.PHP.prefixLines(
            Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a),
            Blockly.PHP.INDENT
          ) + e);
      c += (0 < b ? " else " : "") + "if (" + d + ") {\n" + e + "}";
      ++b;
    } while (a.getInput("IF" + b));
    if (a.getInput("ELSE") || Blockly.PHP.STATEMENT_SUFFIX)
      (e = Blockly.PHP.statementToCode(a, "ELSE")),
        Blockly.PHP.STATEMENT_SUFFIX &&
          (e =
            Blockly.PHP.prefixLines(
              Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a),
  ...
  Blockly.PHP.logic_ternary = function (a) {
    var b =
        Blockly.PHP.valueToCode(a, "IF", Blockly.PHP.ORDER_CONDITIONAL) ||
        "false",
      c =
        Blockly.PHP.valueToCode(a, "THEN", Blockly.PHP.ORDER_CONDITIONAL) ||
        "null";
    a =
      Blockly.PHP.valueToCode(a, "ELSE", Blockly.PHP.ORDER_CONDITIONAL) ||
      "null";
  ...
  Blockly.PHP.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES")
        ...
        : Blockly.PHP.valueToCode(a, "TIMES", Blockly.PHP.ORDER_ASSIGNMENT) ||
          "0",
      c = Blockly.PHP.statementToCode(a, "DO");
    c = Blockly.PHP.addLoopTrap(c, a);
    a = "";
    var d = Blockly.PHP.variableDB_.getDistinctName(
        "count",
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      e = b;
    ...
    var b = "UNTIL" == a.getFieldValue("MODE"),
      c =
        Blockly.PHP.valueToCode(
          a,
          "BOOL",
          b ? Blockly.PHP.ORDER_LOGICAL_NOT : Blockly.PHP.ORDER_NONE
        ) || "false",
  ...
  Blockly.PHP.controls_for = function (a) {
    var b = Blockly.PHP.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
      ),
      c =
        Blockly.PHP.valueToCode(a, "FROM", Blockly.PHP.ORDER_ASSIGNMENT) || "0",
    ...
    if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
      ...
      (a = ""),
        ...
        c.match(/^\w+$/) ||
          Blockly.isNumber(c) ||
          ((g = Blockly.PHP.variableDB_.getDistinctName(
            b + "_start",
            Blockly.VARIABLE_CATEGORY_NAME
          )),
          (a += g + " = " + c + ";\n")),
        ...
        d.match(/^\w+$/) ||
          Blockly.isNumber(d) ||
          ((c = Blockly.PHP.variableDB_.getDistinctName(
            b + "_end",
            Blockly.VARIABLE_CATEGORY_NAME
          )),
          (a += c + " = " + d + ";\n")),
        (d = Blockly.PHP.variableDB_.getDistinctName(
          b + "_inc",
          Blockly.VARIABLE_CATEGORY_NAME
        )),
        (a += d + " = "),
  ...
  Blockly.PHP.controls_forEach = function (a) {
    var b = Blockly.PHP.variableDB_.getName(
      ...
      c =
        Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_ASSIGNMENT) ||
        "[]",
      d = Blockly.PHP.statementToCode(a, "DO");
    d = Blockly.PHP.addLoopTrap(d, a);
  ...
  Blockly.PHP.controls_flow_statements = function (a) {
    var b = "";
    Blockly.PHP.STATEMENT_PREFIX &&
      (b += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, a));
    Blockly.PHP.STATEMENT_SUFFIX &&
      (b += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a));
    if (Blockly.PHP.STATEMENT_PREFIX) {
      ...
      c &&
        ...
        (b += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, c));
    }
  ...
  Blockly.PHP.math_number = function (a) {
    ...
    var b =
      0 <= a ? Blockly.PHP.ORDER_ATOMIC : Blockly.PHP.ORDER_UNARY_NEGATION;
  ...
  Blockly.PHP.math_single = function (a) {
    ...
    if ("NEG" == b)
      return (
        (a =
          Blockly.PHP.valueToCode(a, "NUM", Blockly.PHP.ORDER_UNARY_NEGATION) ||
          "0"),
        "-" == a[0] && (a = " " + a),
    ...
    a =
      "SIN" == b || "COS" == b || "TAN" == b
        ? Blockly.PHP.valueToCode(a, "NUM", Blockly.PHP.ORDER_DIVISION) || "0"
        : Blockly.PHP.valueToCode(a, "NUM", Blockly.PHP.ORDER_NONE) || "0";
    switch (b) {
      case "ABS":
        var c = "abs(" + a + ")";
        break;
  ...
  Blockly.PHP.math_number_property = function (a) {
    ...
    if ("PRIME" == c)
      return [
        Blockly.PHP.provideFunction_("math_isPrime", [
    ...
    switch (c) {
      ...
      case "DIVISIBLE_BY":
        (a =
          Blockly.PHP.valueToCode(a, "DIVISOR", Blockly.PHP.ORDER_MODULUS) ||
          "0"),
          (d = b + " % " + a + " == 0");
    }
  ...
  Blockly.PHP.math_change = function (a) {
    var b =
      Blockly.PHP.valueToCode(a, "DELTA", Blockly.PHP.ORDER_ADDITION) || "0";
    return (
      Blockly.PHP.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
  ...
  Blockly.PHP.math_on_list = function (a) {
    ...
    switch (b) {
      case "SUM":
        a =
          Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_FUNCTION_CALL) ||
          "array()";
        a = "array_sum(" + a + ")";
        break;
      case "MIN":
      ...
      case "AVERAGE":
        ...
        a =
          Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_NONE) ||
          "array()";
        a = b + "(" + a + ")";
        break;
      case "MEDIAN":
      ...
      case "STD_DEV":
        ...
        break;
      case "RANDOM":
        b = Blockly.PHP.provideFunction_("math_random_list", [
  ...
  Blockly.PHP.math_modulo = function (a) {
    var b =
      Blockly.PHP.valueToCode(a, "DIVIDEND", Blockly.PHP.ORDER_MODULUS) || "0";
  ...
  Blockly.PHP.math_constrain = function (a) {
    ...
    a =
      Blockly.PHP.valueToCode(a, "HIGH", Blockly.PHP.ORDER_COMMA) || "Infinity";
    return [
      "min(max(" + b + ", " + c + "), " + a + ")",
      Blockly.PHP.ORDER_FUNCTION_CALL,
    ];
  ...
  Blockly.PHP.math_random_int = function (a) {
    ...
    return [
      Blockly.PHP.provideFunction_("math_random_int", [
  ...
  Blockly.PHP.math_atan2 = function (a) {
    ...
    return [
      "atan2(" +
        (Blockly.PHP.valueToCode(a, "Y", Blockly.PHP.ORDER_COMMA) || "0") +
        ", " +
        b +
        ") / pi() * 180",
  ...
  Blockly.PHP.procedures_defreturn = function (a) {
    for (
      ...
      (c = c.name),
        -1 == a.getVars().indexOf(c) &&
          b.push(
            Blockly.PHP.variableDB_.getName(c, Blockly.VARIABLE_CATEGORY_NAME)
          );
    ...
    d = Blockly.PHP.variableDB_.getName(
    ...
    Blockly.PHP.STATEMENT_PREFIX &&
      (c += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, a));
    Blockly.PHP.STATEMENT_SUFFIX &&
      (c += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a));
    c && (c = Blockly.PHP.prefixLines(c, Blockly.PHP.INDENT));
    var g = "";
    Blockly.PHP.INFINITE_LOOP_TRAP &&
      (g = Blockly.PHP.prefixLines(
        Blockly.PHP.injectId(Blockly.PHP.INFINITE_LOOP_TRAP, a),
        Blockly.PHP.INDENT
      ));
    var k = Blockly.PHP.statementToCode(a, "STACK"),
    ...
    e = a.getVars();
    for (f = 0; f < e.length; f++)
      m[f] = Blockly.PHP.variableDB_.getName(
        e[f],
        Blockly.VARIABLE_CATEGORY_NAME
      );
    b =
  ...
  Blockly.PHP.procedures_callreturn = function (a) {
    for (
      ...
      c[e] =
        Blockly.PHP.valueToCode(a, "ARG" + e, Blockly.PHP.ORDER_COMMA) ||
        "null";
  ...
  Blockly.PHP.procedures_ifreturn = function (a) {
    var b =
      "if (" +
      (Blockly.PHP.valueToCode(a, "CONDITION", Blockly.PHP.ORDER_NONE) ||
        "false") +
      ") {\n";
    Blockly.PHP.STATEMENT_SUFFIX &&
      (b += Blockly.PHP.prefixLines(
        Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a),
        Blockly.PHP.INDENT
      ));
    a.hasReturnValue_
  ...
  Blockly.PHP.text = function (a) {
    return [
      Blockly.PHP.quote_(a.getFieldValue("TEXT")),
      Blockly.PHP.ORDER_ATOMIC,
    ];
  };
  Blockly.PHP.text_multiline = function (a) {
    return [
      Blockly.PHP.multiline_quote_(a.getFieldValue("TEXT")),
      Blockly.PHP.ORDER_ATOMIC,
    ];
  };
  Blockly.PHP.text_join = function (a) {
    ...
    if (1 == a.itemCount_)
      return [
        Blockly.PHP.valueToCode(a, "ADD0", Blockly.PHP.ORDER_NONE) || "''",
        Blockly.PHP.ORDER_FUNCTION_CALL,
      ];
    if (2 == a.itemCount_) {
      var b =
        Blockly.PHP.valueToCode(a, "ADD0", Blockly.PHP.ORDER_ATOMIC) || "''";
  ...
  Blockly.PHP.text_append = function (a) {
    ...
    a =
      Blockly.PHP.valueToCode(a, "TEXT", Blockly.PHP.ORDER_ASSIGNMENT) || "''";
    return b + " .= " + a + ";\n";
  };
  ...
  Blockly.PHP.text_indexOf = function (a) {
    ...
    return [
      Blockly.PHP.provideFunction_(
        "FIRST" == a.getFieldValue("END") ? "text_indexOf" : "text_lastIndexOf",
        [
          "function " +
            Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
            "($text, $search) {",
    ...
    var b = a.getFieldValue("WHERE") || "FROM_START",
      c =
        Blockly.PHP.valueToCode(
          a,
          "VALUE",
          "RANDOM" == b ? Blockly.PHP.ORDER_NONE : Blockly.PHP.ORDER_COMMA
        ) || "''";
    switch (b) {
      case "FIRST":
      ...
      case "FROM_START":
        return (
          (a = Blockly.PHP.getAdjusted(a, "AT")),
          ["substr(" + c + ", " + a + ", 1)", Blockly.PHP.ORDER_FUNCTION_CALL]
        );
      case "FROM_END":
        return (
          (a = Blockly.PHP.getAdjusted(a, "AT", 1, !0)),
          ["substr(" + c + ", " + a + ", 1)", Blockly.PHP.ORDER_FUNCTION_CALL]
        );
      case "RANDOM":
        return [
          Blockly.PHP.provideFunction_("text_random_letter", [
  ...
  Blockly.PHP.text_getSubstring = function (a) {
    var b =
        Blockly.PHP.valueToCode(a, "STRING", Blockly.PHP.ORDER_FUNCTION_CALL) ||
        "''",
      c = a.getFieldValue("WHERE1"),
      d = a.getFieldValue("WHERE2");
    if ("FIRST" != c || "LAST" != d) {
      ...
      a = Blockly.PHP.getAdjusted(a, "AT2");
      b =
        Blockly.PHP.provideFunction_("text_get_substring", [
          "function " +
            Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
  ...
  Blockly.PHP.text_changeCase = function (a) {
    ...
    if ("UPPERCASE" == a.getFieldValue("CASE")) var c = "strtoupper(" + b + ")";
    else
      "LOWERCASE" == a.getFieldValue("CASE")
        ? (c = "strtolower(" + b + ")")
        : "TITLECASE" == a.getFieldValue("CASE") &&
          (c = "ucwords(strtolower(" + b + "))");
    return [c, Blockly.PHP.ORDER_FUNCTION_CALL];
  };
  Blockly.PHP.text_trim = function (a) {
    var b = { LEFT: "ltrim", RIGHT: "rtrim", BOTH: "trim" }[
  ...
  Blockly.PHP.text_print = function (a) {
    return (
      "print(" +
      (Blockly.PHP.valueToCode(a, "TEXT", Blockly.PHP.ORDER_NONE) || "''") +
      ");\n"
    );
  };
  ...
  Blockly.PHP.text_count = function (a) {
    var b =
      Blockly.PHP.valueToCode(a, "TEXT", Blockly.PHP.ORDER_MEMBER) || "''";
  ...
  Blockly.PHP.variables_set = function (a) {
    var b =
      Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_ASSIGNMENT) || "0";
    return (
      Blockly.PHP.variableDB_.getName(
        a.getFieldValue("VAR"),
        Blockly.VARIABLE_CATEGORY_NAME
