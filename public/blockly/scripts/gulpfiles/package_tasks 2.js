...
function packageUMD(namespace, dependencies) {
  return gulp.umd({
    ...
    template: path.join(
      __dirname,
      `${blocklyRoot}/scripts/package/templates/umd.template`
    ),
  });
}
...
function packageCommonJS(namespace, dependencies) {
  return gulp.umd({
    ...
    template: path.join(
      __dirname,
      `${blocklyRoot}/scripts/package/templates/node.template`
    ),
  });
}
...
function packageSources() {
  return gulp
    .src(["core/**/**.js", "blocks/**.js", "generators/**/**.js"], {
      base: ".",
    })
...
function packageBlockly() {
  return gulp
    .src("scripts/package/blockly.js")
    .pipe(
      packageUMD("Blockly", [
        {
          name: "Blockly",
...
function packageBlocks() {
  return gulp
    .src("scripts/package/blocks.js")
    .pipe(
      packageUMD("Blockly.Blocks", [
        {
          name: "Blockly",
...
function packageBrowser() {
  return gulp
    .src("scripts/package/browser/index.js")
    .pipe(
      packageUMD("Blockly", [
        {
          name: "Blockly",
...
function packageCore() {
  return gulp
    .src("scripts/package/browser/core.js")
    .pipe(
      packageUMD("Blockly", [
        {
          name: "Blockly",
...
function packageNode() {
  return gulp
    .src("scripts/package/node/index.js")
    .pipe(
      packageCommonJS("Blockly", [
        {
          name: "Blockly",
          cjs: "./core",
        },
...
function packageNodeCore() {
  return gulp
    .src("scripts/package/node/core.js")
    .pipe(
      packageCommonJS("Blockly", [
        {
          name: "Blockly",
...
function packageGenerator(file, rename, namespace) {
  return gulp
    .src(`scripts/package/${rename}`)
    .pipe(
      packageUMD(`Blockly${namespace}`, [
        {
          name: "Blockly",
          amd: "./core",
          cjs: "./core",
...
function packageMedia() {
  return gulp.src("./media/*").pipe(gulp.dest(`${packageDistribution}/media`));
}
...
function packageJSON(cb) {
  ...
  fs.writeFileSync(
    `${packageDistribution}/package.json`,
...
function packageDTS() {
  return gulp
    .src(["./typings/*.d.ts", "./typings/msg/*.d.ts"], { base: "./typings" })
    .pipe(gulp.dest(`${packageDistribution}`));
}
