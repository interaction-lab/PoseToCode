...
Blockly.ToolboxCategory.prototype.createRowContentsContainer_ = function () {
  ...
  Blockly.utils.dom.addClass(
    contentsContainer,
    this.cssConfig_.rowcontentcontainer
  );
...
Blockly.ToolboxCategory.prototype.updateFlyoutContents = function (contents) {
  ...
  if (typeof contents === "string") {
    ...
    this.toolboxItemDef_.contents = Blockly.utils.toolbox.convertFlyoutDefToJsonArray(
      contents
    );
  }
  this.parseContents_(
