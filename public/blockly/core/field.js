 ...
 * @protected
 */
Blockly.Field.prototype.positionTextElement_ = function (
  xOffset,
  contentWidth
) {
  if (!this.textElement_) {
  ...
  this.textElement_.setAttribute(
    "x",
    this.sourceBlock_.RTL ? this.size_.width - contentWidth - xOffset : xOffset
  );
  this.textElement_.setAttribute(
    "y",
...
Blockly.Field.prototype.updateMarkers_ = function () {
  const workspace = /** @type {!Blockly.WorkspaceSvg} */ (this.sourceBlock_
    .workspace);
