 ...
 * @package
 */
Blockly.blockRendering.PathObject.prototype.setCursorSvg = function (
  cursorSvg
) {
  if (!cursorSvg) {
    this.cursorSvg = null;
 ...
 * @package
 */
Blockly.blockRendering.PathObject.prototype.setMarkerSvg = function (
  markerSvg
) {
  if (!markerSvg) {
    this.markerSvg = null;
