...
Blockly.PHP.lists_create_with = function (block) {
  ...
  for (let i = 0; i < block.itemCount_; i++) {
    code[i] =
      Blockly.PHP.valueToCode(block, "ADD" + i, Blockly.PHP.ORDER_COMMA) ||
      "null";
  }
...
Blockly.PHP.lists_repeat = function (block) {
  ...
  const functionName = Blockly.PHP.provideFunction_("lists_repeat", [
  ...
  const element =
    Blockly.PHP.valueToCode(block, "ITEM", Blockly.PHP.ORDER_COMMA) || "null";
  const repeatCount =
    Blockly.PHP.valueToCode(block, "NUM", Blockly.PHP.ORDER_COMMA) || "0";
...
Blockly.PHP.lists_length = function (block) {
  ...
  const functionName = Blockly.PHP.provideFunction_("length", [
  ...
  const list =
    Blockly.PHP.valueToCode(block, "VALUE", Blockly.PHP.ORDER_NONE) || "''";
...
Blockly.PHP.lists_isEmpty = function (block) {
  ...
  const argument0 =
    Blockly.PHP.valueToCode(block, "VALUE", Blockly.PHP.ORDER_FUNCTION_CALL) ||
    "array()";
...
Blockly.PHP.lists_indexOf = function (block) {
  ...
  const argument0 =
    Blockly.PHP.valueToCode(block, "FIND", Blockly.PHP.ORDER_NONE) || "''";
  const argument1 =
    Blockly.PHP.valueToCode(block, "VALUE", Blockly.PHP.ORDER_MEMBER) || "[]";
  ...
  if (block.getFieldValue("END") == "FIRST") {
    // indexOf
    var functionName = Blockly.PHP.provideFunction_("indexOf", [
      "function " +
    ...
    // lastIndexOf
    var functionName = Blockly.PHP.provideFunction_("lastIndexOf", [
      "function " +
        Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
        "($haystack, $needle) {",
      "  $last = " + errorIndex + ";",
  ...
  switch (where) {
    ...
    case "FROM_START":
      ...
      if (mode == "GET") {
        ...
        var list =
          Blockly.PHP.valueToCode(block, "VALUE", Blockly.PHP.ORDER_COMMA) ||
          "array()";
    ...
    case "FROM_END":
      if (mode == "GET") {
        ...
        var list =
          Blockly.PHP.valueToCode(block, "VALUE", Blockly.PHP.ORDER_NONE) ||
          "array()";
        var at = Blockly.PHP.getAdjusted(
          block,
          "AT",
          1,
          false,
...
Blockly.PHP.lists_setIndex = function (block) {
  ...
  const where = block.getFieldValue("WHERE") || "FROM_START";
  const value =
    Blockly.PHP.valueToCode(block, "TO", Blockly.PHP.ORDER_ASSIGNMENT) ||
    "null";
  ...
  function cacheList() {
    ...
    const listVar = Blockly.PHP.variableDB_.getDistinctName(
      "tmp_list",
  ...
  switch (where) {
    case "FIRST":
      if (mode == "SET") {
        var list =
          Blockly.PHP.valueToCode(block, "LIST", Blockly.PHP.ORDER_MEMBER) ||
          "array()";
        return list + "[0] = " + value + ";\n";
      } else if (mode == "INSERT") {
        var list =
          Blockly.PHP.valueToCode(block, "LIST", Blockly.PHP.ORDER_COMMA) ||
          "array()";
    ...
    case "LAST":
      var list =
        ...
        "array()";
      if (mode == "SET") {
        var functionName = Blockly.PHP.provideFunction_("lists_set_last_item", [
          "function " +
            Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
            "(&$list, $value) {",
    ...
    case "FROM_END":
      ...
      if (mode == "SET") {
        var functionName = Blockly.PHP.provideFunction_("lists_set_from_end", [
          "function " +
            Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
            "(&$list, $at, $value) {",
    ...
    case "RANDOM":
      var list =
        Blockly.PHP.valueToCode(block, "LIST", Blockly.PHP.ORDER_REFERENCE) ||
        "array()";
      var code = cacheList();
  ...
  if (where1 == "FIRST" && where2 == "LAST") {
    ...
    switch (where1) {
      case "FROM_START":
        ...
        break;
      case "FROM_END":
        var at1 = Blockly.PHP.getAdjusted(
          block,
          "AT1",
          1,
          false,
    ...
    switch (where2) {
      case "FROM_START":
        var at2 = Blockly.PHP.getAdjusted(
          block,
          "AT2",
          0,
          false,
    ...
    const functionName = Blockly.PHP.provideFunction_("lists_get_sublist", [
      "function " +
        Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.PHP.lists_sort = function (block) {
  ...
  const functionName = Blockly.PHP.provideFunction_("lists_sort", [
    "function " +
      Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
      "($list, $type, $direction) {",
    "  $sortCmpFuncs = array(",
...
Blockly.PHP.lists_split = function (block) {
  ...
  let value_input = Blockly.PHP.valueToCode(
    block,
    "INPUT",
    Blockly.PHP.ORDER_COMMA
  );
  const value_delim =
    Blockly.PHP.valueToCode(block, "DELIM", Blockly.PHP.ORDER_COMMA) || "''";
