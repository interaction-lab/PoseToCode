...
Blockly.JavaScript.math_on_list = function (block) {
  ...
  switch (func) {
    ...
    case "AVERAGE":
      ...
      var functionName = Blockly.JavaScript.provideFunction_("mathMean", [
        "function " +
    ...
    case "MEDIAN":
      ...
      var functionName = Blockly.JavaScript.provideFunction_("mathMedian", [
        "function " +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          "(myList) {",
    ...
    case "MODE":
      ...
      var functionName = Blockly.JavaScript.provideFunction_("mathModes", [
        "function " +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          "(values) {",
        "  var modes = [];",
    ...
    case "STD_DEV":
      ...
      break;
    case "RANDOM":
      var functionName = Blockly.JavaScript.provideFunction_("mathRandomList", [
        "function " +
          Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
          "(list) {",
