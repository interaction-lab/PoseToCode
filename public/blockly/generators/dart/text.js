...
Blockly.Dart.text_append = function (block) {
  ...
  const value =
    Blockly.Dart.valueToCode(block, "TEXT", Blockly.Dart.ORDER_NONE) || "''";
...
Blockly.Dart.text_charAt = function (block) {
  ...
  switch (where) {
    ...
    case "FROM_END":
      ...
      var functionName = Blockly.Dart.provideFunction_("text_get_from_end", [
        "String " +
    ...
    case "RANDOM":
      ...
      var functionName = Blockly.Dart.provideFunction_("text_random_letter", [
...
Blockly.Dart.text_getSubstring = function (block) {
  ...
  if (where1 == "FIRST" && where2 == "LAST") {
    ...
    const functionName = Blockly.Dart.provideFunction_("text_get_substring", [
      "String " +
        Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Dart.text_changeCase = function (block) {
  ...
  if (operator) {
    ...
    const functionName = Blockly.Dart.provideFunction_("text_toTitleCase", [
...
Blockly.Dart.text_trim = function (block) {
  ...
  const text =
    Blockly.Dart.valueToCode(block, "TEXT", Blockly.Dart.ORDER_UNARY_POSTFIX) ||
    "''";
...
Blockly.Dart.text_count = function (block) {
  const text =
    ...
    "''";
  const sub =
    Blockly.Dart.valueToCode(block, "SUB", Blockly.Dart.ORDER_NONE) || "''";
  // Substring count is not a native Dart function.  Define one.
  const functionName = Blockly.Dart.provideFunction_("text_count", [
    "int " +
      Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Dart.text_replace = function (block) {
  const text =
    ...
    "''";
  const from =
    Blockly.Dart.valueToCode(block, "FROM", Blockly.Dart.ORDER_NONE) || "''";
  const to =
    Blockly.Dart.valueToCode(block, "TO", Blockly.Dart.ORDER_NONE) || "''";
