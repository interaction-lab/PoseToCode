...
Blockly.Dart.controls_if = function (block) {
  ...
  do {
    conditionCode =
      Blockly.Dart.valueToCode(block, "IF" + n, Blockly.Dart.ORDER_NONE) ||
      "false";
...
Blockly.Dart.logic_ternary = function (block) {
  // Ternary operator.
  const value_if =
    Blockly.Dart.valueToCode(block, "IF", Blockly.Dart.ORDER_CONDITIONAL) ||
    "false";
  const value_then =
    Blockly.Dart.valueToCode(block, "THEN", Blockly.Dart.ORDER_CONDITIONAL) ||
    "null";
  const value_else =
    Blockly.Dart.valueToCode(block, "ELSE", Blockly.Dart.ORDER_CONDITIONAL) ||
    "null";
