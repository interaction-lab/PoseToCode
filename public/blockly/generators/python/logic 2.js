...
Blockly.Python.controls_if = function (block) {
  ...
  do {
    conditionCode =
      Blockly.Python.valueToCode(block, "IF" + n, Blockly.Python.ORDER_NONE) ||
      "False";
    branchCode =
      Blockly.Python.statementToCode(block, "DO" + n) || Blockly.Python.PASS;
...
Blockly.Python.logic_ternary = function (block) {
  // Ternary operator.
  const value_if =
    Blockly.Python.valueToCode(block, "IF", Blockly.Python.ORDER_CONDITIONAL) ||
    "False";
  const value_then =
    Blockly.Python.valueToCode(
      block,
