...
Blockly.Python.math_single = function (block) {
  ...
  if (operator == "SIN" || operator == "COS" || operator == "TAN") {
    ...
    arg =
      Blockly.Python.valueToCode(block, "NUM", Blockly.Python.ORDER_NONE) ||
      "0";
  }
...
Blockly.Python.math_number_property = function (block) {
  ...
  if (dropdown_property == "PRIME") {
    ...
    const functionName = Blockly.Python.provideFunction_("math_isPrime", [
  ...
  switch (dropdown_property) {
    ...
    case "NEGATIVE":
      ...
      break;
    case "DIVISIBLE_BY":
      var divisor = Blockly.Python.valueToCode(
        block,
        "DIVISOR",
        Blockly.Python.ORDER_MULTIPLICATIVE
      );
...
Blockly.Python.math_change = function (block) {
  ...
  Blockly.Python.definitions_.from_numbers_import_Number =
    "from numbers import Number";
  const argument0 =
    Blockly.Python.valueToCode(block, "DELTA", Blockly.Python.ORDER_ADDITIVE) ||
    "0";
...
Blockly.Python.math_constrain = function (block) {
  ...
  const argument0 =
    ...
    "0";
  const argument1 =
    Blockly.Python.valueToCode(block, "LOW", Blockly.Python.ORDER_NONE) || "0";
  const argument2 =
    Blockly.Python.valueToCode(block, "HIGH", Blockly.Python.ORDER_NONE) ||
    "float('inf')";
  const code =
...
Blockly.Python.math_random_int = function (block) {
  ...
  Blockly.Python.definitions_.import_random = "import random";
  const argument0 =
    Blockly.Python.valueToCode(block, "FROM", Blockly.Python.ORDER_NONE) || "0";
  const argument1 =
    Blockly.Python.valueToCode(block, "TO", Blockly.Python.ORDER_NONE) || "0";
