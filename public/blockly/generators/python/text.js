...
Blockly.Python.text_join = function (block) {
  ...
  switch (block.itemCount_) {
    ...
    case 1:
      var element =
        Blockly.Python.valueToCode(block, "ADD0", Blockly.Python.ORDER_NONE) ||
        "''";
    ...
    case 2:
      var element0 =
        ...
        "''";
      var element1 =
        Blockly.Python.valueToCode(block, "ADD1", Blockly.Python.ORDER_NONE) ||
        "''";
      var code =
        Blockly.Python.text.forceString_(element0) +
        " + " +
    ...
    default:
      ...
      var tempVar = Blockly.Python.variableDB_.getDistinctName(
        "x",
...
Blockly.Python.text_indexOf = function (block) {
  ...
  const substring =
    Blockly.Python.valueToCode(block, "FIND", Blockly.Python.ORDER_NONE) ||
    "''";
  const text =
...
Blockly.Python.text_charAt = function (block) {
  ...
  switch (where) {
    ...
    case "RANDOM":
      ...
      var functionName = Blockly.Python.provideFunction_("text_random_letter", [
...
Blockly.Python.text_getSubstring = function (block) {
  ...
  const text =
    Blockly.Python.valueToCode(block, "STRING", Blockly.Python.ORDER_MEMBER) ||
    "''";
  switch (where1) {
    case "FROM_START":
...
Blockly.Python.text_changeCase = function (block) {
  ...
  const text =
    Blockly.Python.valueToCode(block, "TEXT", Blockly.Python.ORDER_MEMBER) ||
    "''";
...
Blockly.Python.text_prompt_ext = function (block) {
  // Prompt function.
  const functionName = Blockly.Python.provideFunction_("text_prompt", [
...
Blockly.Python.text_count = function (block) {
  const text =
    ...
    "''";
  const sub =
    Blockly.Python.valueToCode(block, "SUB", Blockly.Python.ORDER_NONE) || "''";
...
Blockly.Python.text_replace = function (block) {
  const text =
    ...
    "''";
  const from =
    Blockly.Python.valueToCode(block, "FROM", Blockly.Python.ORDER_NONE) ||
    "''";
  const to =
    Blockly.Python.valueToCode(block, "TO", Blockly.Python.ORDER_NONE) || "''";
