...
Blockly.zelos.ConstantProvider.prototype.setDynamicProperties_ = function (
  ...
  this.SELECTED_GLOW_COLOUR =
    theme.getComponentStyle("selectedGlowColour") || this.SELECTED_GLOW_COLOUR;
...
Blockly.zelos.ConstantProvider.prototype.makeInsideCorners = function () {
  ...
  const innerTopRightCorner = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,1",
    radius,
    Blockly.utils.svgPaths.point(-radius, radius)
  ...
  const innerBottomRightCorner = Blockly.utils.svgPaths.arc(
    "a",
    "0 0,1",
    radius,
    Blockly.utils.svgPaths.point(radius, radius)
