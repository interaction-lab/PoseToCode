...
Blockly.DropDownDiv.createDom = function () {
  ...
  const container = Blockly.parentContainer || document.body;
...
Blockly.DropDownDiv.showPositionedByRect_ = function (
  ...
  while (workspace.options.parentWorkspace) {
    workspace = /** @type {!Blockly.WorkspaceSvg} */ (workspace.options
      .parentWorkspace);
  }
...
Blockly.DropDownDiv.show = function (
  ...
  const mainWorkspace = /** @type {!Blockly.WorkspaceSvg} */ (Blockly.getMainWorkspace());
  Blockly.DropDownDiv.rendererClassName_ = mainWorkspace
    .getRenderer()
    .getClassName();
...
Blockly.DropDownDiv.getPositionAboveMetrics_ = function (
  ...
  const arrowY =
    divSize.height -
    Blockly.DropDownDiv.BORDER_SIZE * 2 -
    Blockly.DropDownDiv.ARROW_SIZE / 2;
...
Blockly.DropDownDiv.hideWithoutAnimation = function () {
  ...
  /** @type {!Blockly.WorkspaceSvg} */ (Blockly.getMainWorkspace()).markFocused();
};
...
Blockly.DropDownDiv.positionInternal_ = function (
  ...
  const metrics = Blockly.DropDownDiv.getPositionMetrics_(
    primaryX,
    primaryY,
    secondaryX,
    secondaryY
