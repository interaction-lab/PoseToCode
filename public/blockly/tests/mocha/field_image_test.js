...
suite("Image Fields", function () {
  ...
  function assertValue(imageField, expectedValue, expectedText) {
    const actualValue = imageField.getValue();
    const actualText = imageField.getText();
  ...
  suite("Constructor", function () {
    ...
    test("With Alt", function () {
      const imageField = new Blockly.FieldImage("src", 1, 1, "alt");
      assertValue(imageField, "src", "alt");
    });
    test("Without Alt", function () {
      const imageField = new Blockly.FieldImage("src", 1, 1);
  ...
  suite("fromJson", function () {
    ...
    test("With Alt", function () {
      const imageField = Blockly.FieldImage.fromJson({
        src: "src",
        width: 1,
        height: 1,
        alt: "alt",
