...
suite("Extensions", function () {
  ...
  test("Definition before and after block type", function () {
    ...
    chai.assert.typeOf(
      Blockly.Extensions.ALL_.extensions_test_before,
      "function"
    );
    chai.assert.typeOf(
      Blockly.Extensions.ALL_.extensions_test_after,
      "function"
    );
  ...
  suite("Mixin", function () {
    ...
    suite("Mutator", function () {
      ...
      test("No dialog", function () {
        ...
        chai.assert.equal(block.mutationToDom(), "mutationToDomFn");
        chai.assert.isFalse(
          Object.prototype.hasOwnProperty.call(block, "compose")
        );
        chai.assert.isFalse(
          Object.prototype.hasOwnProperty.call(block, "decompose")
        );
      });
    });
  });
  ...
  suite("Error cases", function () {
    ...
    test("Mixin overwrites local value", function () {
      ...
      chai.assert.typeOf(
        Blockly.Extensions.ALL_.mixin_bad_inputList,
        "function"
      );
    ...
    suite("register", function () {
      test("Just a string", function () {
        ...
        chai.assert.isUndefined(
          Blockly.Extensions.ALL_.extension_just_a_string
        );
        chai.assert.throws(function () {
