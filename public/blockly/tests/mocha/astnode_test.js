...
suite("ASTNode", function () {
  ...
  suite("HelperFunctions", function () {
    ...
    test("getOutAstNodeForBlock_", function () {
      ...
      const newASTNode = node.getOutAstNodeForBlock_(
        this.blocks.statementInput2
      );
      chai.assert.equal(newASTNode.getLocation(), this.blocks.statementInput1);
    });
    ...
    test("findFirstFieldOrInput_", function () {
      ...
      const newASTNode = node.findFirstFieldOrInput_(
        this.blocks.statementInput4
      );
      chai.assert.equal(newASTNode.getLocation(), field);
    });
  ...
  suite("NavigationFunctions", function () {
    ...
    suite("Next", function () {
      ...
      test("fromBlockToNext", function () {
        ...
        const node = Blockly.ASTNode.createBlockNode(
      ...
      test("fromInputToInput", function () {
        const input = this.blocks.statementInput1.inputList[0];
        const inputConnection = this.blocks.statementInput1.inputList[1]
          .connection;
      ...
      test("fromInputToStatementInput", function () {
        ...
        const inputConnection = this.blocks.fieldAndInputs2.inputList[2]
          .connection;
        const node = Blockly.ASTNode.createInputNode(input);
        const nextNode = node.next();
        chai.assert.equal(nextNode.getLocation(), inputConnection);
      ...
      test("fromFieldToInput", function () {
        ...
        const inputConnection = this.blocks.statementInput1.inputList[0]
          .connection;
        const node = Blockly.ASTNode.createFieldNode(field);
        const nextNode = node.next();
        chai.assert.equal(nextNode.getLocation(), inputConnection);
      ...
      test("fromStackToStack", function () {
        const node = Blockly.ASTNode.createStackNode(
          this.blocks.statementInput1
        );
        const nextNode = node.next();
    ...
    suite("Previous", function () {
      ...
      test("fromInputToInput", function () {
        const input = this.blocks.fieldAndInputs2.inputList[2];
        const inputConnection = this.blocks.fieldAndInputs2.inputList[1]
          .connection;
        const node = Blockly.ASTNode.createInputNode(input);
        const prevNode = node.prev();
      ...
      test("fromFieldToInput", function () {
        const field = this.blocks.fieldAndInputs2.inputList[1].fieldRow[0];
        const inputConnection = this.blocks.fieldAndInputs2.inputList[0]
          .connection;
        const node = Blockly.ASTNode.createFieldNode(field);
        const prevNode = node.prev();
        chai.assert.equal(prevNode.getLocation(), inputConnection);
    ...
    suite("In", function () {
      ...
      test("fromInputToPrevious", function () {
        ...
        const previousConnection = this.blocks.statementInput3
          .previousConnection;
        const node = Blockly.ASTNode.createInputNode(input);
        const inNode = node.in();
      ...
      test("fromBlockToInput_DummyInputValue", function () {
        ...
        const inputConnection = this.blocks.dummyInputValue.inputList[1]
          .connection;
        const inNode = node.in();
    ...
    suite("Out", function () {
      ...
      test("fromPreviousToInput", function () {
        ...
        const inputConnection = this.blocks.statementInput2.inputList[1]
          .connection;
    ...
    suite("createFunctions", function () {
      ...
      test("createStatementConnectionNode", function () {
        const nextConnection = this.blocks.statementInput1.inputList[1]
          .connection;
        const inputConnection = this.blocks.statementInput1.inputList[1]
          .connection;
        const node = Blockly.ASTNode.createConnectionNode(nextConnection);
