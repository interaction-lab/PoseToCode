...
suite("Insert/Modify", function () {
  ...
  setup(function () {
    ...
    const toolbox = document.getElementById("toolbox-connections");
  ...
  suite("Marked Connection", function () {
    ...
    suite("Marker on next", function () {
      ...
      test("Cursor on compatible connection", function () {
        ...
        chai.assert.equal(
          this.stack_block_1.getNextBlock().id,
          "stack_block_2"
        );
      });
      test("Cursor on incompatible connection", function () {
        ...
        chai.assert.isTrue(Blockly.navigation.modify_());
        chai.assert.equal(
          this.stack_block_1.getNextBlock(),
          this.stack_block_2
        );
      });
      ...
      test("Cursor on block", function () {
        this.workspace
          .getCursor()
          .setCurNode(Blockly.ASTNode.createBlockNode(this.stack_block_2));
        chai.assert.isTrue(Blockly.navigation.modify_());
        chai.assert.equal(
          this.stack_block_1.getNextBlock().id,
          "stack_block_2"
    ...
    suite("Marker on previous", function () {
      ...
      test("Cursor on compatible connection", function () {
        ...
        chai.assert.isTrue(Blockly.navigation.modify_());
        chai.assert.equal(
          this.stack_block_1.getPreviousBlock().id,
          "stack_block_2"
        );
      });
      test("Cursor on incompatible connection", function () {
      ...
      test("Cursor on incompatible block", function () {
        this.workspace
          .getCursor()
          .setCurNode(Blockly.ASTNode.createBlockNode(this.row_block_1));
        assertModifyFails();
        chai.assert.isNull(this.stack_block_1.getPreviousBlock());
      });
    });
    ...
    suite("Marker on value input", function () {
      ...
      test("Cursor on block", function () {
        this.workspace
          .getCursor()
          .setCurNode(Blockly.ASTNode.createBlockNode(this.row_block_2));
        chai.assert.isTrue(Blockly.navigation.modify_());
        chai.assert.equal(this.row_block_2.getParent().id, "row_block_1");
      });
    });
    ...
    suite("Marked Statement input", function () {
      setup(function () {
        ...
        this.workspace
          .getMarker(Blockly.navigation.MARKER_NAME)
          .setCurNode(
            Blockly.ASTNode.createInputNode(this.statement_block_1.inputList[0])
          );
      });
      ...
      test("Cursor on stack", function () {
        this.workspace
          .getCursor()
          .setCurNode(Blockly.ASTNode.createStackNode(this.statement_block_2));
        chai.assert.isTrue(Blockly.navigation.modify_());
        chai.assert.equal(
  ...
  suite("Marked Block", function () {
    ...
    suite("Marked any block", function () {
      ...
      setup(function () {
        this.workspace
          .getMarker(Blockly.navigation.MARKER_NAME)
          .setCurNode(Blockly.ASTNode.createBlockNode(this.stack_block_1));
      });
      test("Cursor on workspace", function () {
        this.workspace
          .getCursor()
