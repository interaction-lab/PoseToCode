...
(function (root, factory) {
  ...
  Blockly.utils.isTargetInput = function (a) {
    return (
      ...
      (a.target.dataset && "true" == a.target.dataset.isTextInput)
    );
  };
  ...
  Blockly.utils.checkMessageReferences = function (a) {
    for (
      ...
      void 0 == c[f.slice(6, -1)] &&
        (console.warn("No message string for " + d[e] + " in " + a), (b = !1));
    }
    return b;
  };
  ...
  Blockly.Grid.createDom = function (a, b, c) {
    ...
    0 < b.length && 0 < b.spacing
      ...
      : Blockly.utils.dom.createSvgElement(Blockly.utils.Svg.LINE, {}, a);
    return a;
  };
  ...
  Blockly.utils.toolbox.validateToolbox_ = function (a) {
    ...
    if (
      b &&
      b != Blockly.utils.toolbox.FLYOUT_TOOLBOX_KIND &&
      b != Blockly.utils.toolbox.CATEGORY_TOOLBOX_KIND
    )
      throw Error(
  ...
  Blockly.utils.toolbox.convertFlyoutDefToJsonArray = function (a) {
    return a
      ? a.contents
        ...
        ? a
        : Blockly.utils.toolbox.xmlToJsonArray_(a)
      : [];
  };
    ...
    for (var d; (d = c[a]); a++)
      if (d.tagName) {
        ...
        "BLOCK" == f
          ? (e.blockxml = d)
          : "CATEGORY" == f &&
            (e.contents = Blockly.utils.toolbox.xmlToJsonArray_(d));
  ...
  Blockly.Xml.appendDomToWorkspace = function (a, b) {
    var c;
    Object.prototype.hasOwnProperty.call(b, "scale") &&
      (c = b.getBlocksBoundingBox());
    a = Blockly.Xml.domToWorkspace(a, b);
    if (c && c.top != c.bottom) {
      var d = c.bottom;
  ...
  Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    ...
    for (var g; (g = a.childNodes[e]); e++)
      if (g.nodeType != Blockly.utils.dom.NodeType.TEXT_NODE) {
        for (var h, k = (f = null), l = 0; (h = g.childNodes[l]); l++)
          h.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE &&
            ("block" == h.nodeName.toLowerCase()
              ? (f = h)
              : "shadow" == h.nodeName.toLowerCase() && (k = h));
        l = !1;
        ...
        switch (g.nodeName.toLowerCase()) {
          ...
          case "comment":
            ...
            isNaN(g) ||
              isNaN(h) ||
              (c.commentModel.size = new Blockly.utils.Size(g, h));
            f &&
              c.getCommentIcon &&
              !c.isInFlyout &&
              setTimeout(function () {
          ...
          case "statement":
            ...
            if (!h) {
              console.warn(
                "Ignoring non-existent input " + m + " in block " + d
              );
              break;
            }
            if (f)
              if (
                ...
                h.connection.connect(f.outputConnection);
              else if (f.previousConnection)
                h.connection.connect(f.previousConnection);
              else
                throw TypeError(
  ...
  Blockly.Tooltip.onMouseOver_ = function (a) {
    Blockly.Tooltip.blocked_ ||
      ((a = Blockly.Tooltip.getTargetObject_(a.currentTarget)),
      ...
      if (e.isShadow())
        ...
        for (g = d; g.nextConnection; ) {
          ...
          if (h && !h.isShadow()) g = h;
            ...
            e.workspace.connectionChecker.canConnect(
  ...
  Blockly.Connection.prototype.connect = function (a) {
    if (
      ...
      this.getConnectionChecker().canConnect(this, a, !1)
    ) {
  ...
  Blockly.Connection.prototype.setShadowDom = function (a) {
    ...
    a = this.targetBlock();
    a
      ? a.isShadow() && (a.dispose(!1), this.respawnShadow_())
      : this.respawnShadow_();
  };
  ...
  Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function () {
    ...
    this.wouldDeleteBlock_
      ? (a && setTimeout(a.closeLid.bind(a), 100),
        this.fireMoveEvent_(),
  ...
  Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_ = function () {
    ...
    this.wouldDeleteBlock_
      ? (this.draggingBlock_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setLidOpen(!0))
      : (this.draggingBlock_.setDeleteStyle(!1), a && a.setLidOpen(!1));
  };
  ...
  Blockly.ConnectionChecker.prototype.canConnect = function (a, b, c, d) {
    return (
      this.canConnectWithReason(a, b, c, d) == Blockly.Connection.CAN_CONNECT
    );
  };
  Blockly.ConnectionChecker.prototype.canConnectWithReason = function (
    ...
    return e != Blockly.Connection.CAN_CONNECT
      ? e
      : this.doTypeChecks(a, b)
      ? c && !this.doDragChecks(a, b, d || 0)
        ? Blockly.Connection.REASON_DRAG_CHECKS_FAILED
  ...
  Blockly.ConnectionChecker.prototype.doSafetyChecks = function (a, b) {
    ...
    if (a.isSuperior())
      var c = a.getSourceBlock(),
        d = b.getSourceBlock();
    else (d = a.getSourceBlock()), (c = b.getSourceBlock());
    return c == d
      ? Blockly.Connection.REASON_SELF_CONNECTION
      : b.type != Blockly.OPPOSITE_TYPE[a.type]
  ...
  Blockly.Workspace = function (a) {
    ...
    this.connectionChecker = new (Blockly.registry.getClassFromOptions(
      Blockly.registry.Type.CONNECTION_CHECKER,
      this.options
    ))(this);
    this.topBlocks_ = [];
  ...
  Blockly.Events.CommentChange = function (a, b, c) {
    ...
    a &&
      ((this.oldContents_ = "undefined" == typeof b ? "" : b),
  ...
  Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function () {
    ...
    this.wouldDeleteBubble_
      ? (this.draggingBubble_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setLidOpen(!0))
      : (this.draggingBubble_.setDeleteStyle(!1), a && a.setLidOpen(!1));
  };
  ...
  Blockly.navigation.focusToolbox_ = function () {
    ...
    a &&
      ...
      a.getSelectedItem() || a.selectItemByPosition(0));
  };
  ...
  Blockly.navigation.moveAndConnect_ = function (a, b) {
    if (!a || !b) return !1;
    var c = a.getSourceBlock();
    return a.getConnectionChecker().canConnect(a, b, !1)
  ...
  Blockly.navigation.connect_ = function (a, b) {
    ...
    Blockly.navigation.warn_(
      "Connection failed with error: " + c.getErrorMessage(d, a, b)
    );
    return !1;
  };
  ...
  Blockly.Gesture.prototype.doBlockClick_ = function () {
    this.flyout_ && this.flyout_.autoClose
      ...
      : Blockly.Events.fire(
          new Blockly.Events.Ui(this.startBlock_, "click", void 0, "block")
        );
    this.bringBlockToFront_();
    Blockly.Events.setGroup(!1);
  };
  ...
  Blockly.Field.prototype.getTooltip = function () {
    ...
    return a
      ? Blockly.Tooltip.getTooltipOfObject(a)
      : Blockly.Tooltip.getTooltipOfObject({ tooltip: this.tooltip_ });
  };
  ...
  Blockly.Block.prototype.unplugFromStack_ = function (a) {
    ...
    a &&
      ...
      a.disconnect(),
      b &&
        this.workspace.connectionChecker.canConnect(b, a, !1) &&
        b.connect(a));
  };
  ...
  Blockly.ContextMenu.workspaceCommentOption = function (a, b) {
    ...
    c.callback = function () {
      var d = new Blockly.WorkspaceCommentSvg(
          a,
    ...
    Blockly.ContextMenuRegistry.registry.register({
      ...
      preconditionFn: function (a) {
        return a.workspace.isMovable()
          ? 1 < a.workspace.getTopBlocks(!1).length
            ? "enabled"
            : "disabled"
          : "hidden";
      },
  ...
  Blockly.ContextMenuItems.deleteNext_ = function (a, b) {
    ...
    c &&
      (c.workspace
        ? (c.dispose(!1, !0),
          setTimeout(Blockly.ContextMenuItems.deleteNext_, 10, a, b))
        : Blockly.ContextMenuItems.deleteNext_(a, b));
    Blockly.Events.setGroup(!1);
  };
  Blockly.ContextMenuItems.registerDeleteAll = function () {
    Blockly.ContextMenuRegistry.registry.register({
      displayText: function (a) {
        if (a.workspace)
          return (
            (a = Blockly.ContextMenuItems.getDeletableBlocks_(a.workspace)
              .length),
            1 == a
              ? Blockly.Msg.DELETE_BLOCK
              : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(a))
          );
      },
      preconditionFn: function (a) {
        if (a.workspace)
          return 0 <
            Blockly.ContextMenuItems.getDeletableBlocks_(a.workspace).length
            ? "enabled"
            : "disabled";
      },
      callback: function (a) {
        if (a.workspace) {
          ...
          2 > b.length
            ? Blockly.ContextMenuItems.deleteNext_(b, c)
            : Blockly.confirm(
                Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", b.length),
                function (d) {
  ...
  Blockly.ContextMenuItems.registerComment = function () {
    Blockly.ContextMenuRegistry.registry.register({
      displayText: function (a) {
        return a.block.getCommentIcon()
          ? Blockly.Msg.REMOVE_COMMENT
          : Blockly.Msg.ADD_COMMENT;
      },
      preconditionFn: function (a) {
        a = a.block;
        return Blockly.utils.userAgent.IE ||
          a.isInFlyout ||
      ...
      preconditionFn: function (a) {
        ...
        if (!a.isInFlyout && a.isMovable() && !a.isCollapsed())
          for (var b = 1; b < a.inputList.length; b++)
            if (
              a.inputList[b - 1].type != Blockly.NEXT_STATEMENT &&
              a.inputList[b].type != Blockly.NEXT_STATEMENT
            )
              return "enabled";
        return "hidden";
      },
  ...
  Blockly.ContextMenuItems.registerHelp = function () {
    Blockly.ContextMenuRegistry.registry.register({
      ...
      preconditionFn: function (a) {
        a = a.block;
        return ("function" == typeof a.helpUrl ? a.helpUrl() : a.helpUrl)
          ? "enabled"
          : "hidden";
      },
      callback: function (a) {
  ...
  Blockly.ContextMenuRegistry.prototype.unregister = function (a) {
    if (this.registry_[a]) delete this.registry_[a];
  ...
  Blockly.BlockSvg.prototype.generateContextMenu = function () {
    ...
    var a = Blockly.ContextMenuRegistry.registry.getContextMenuOptions(
  ...
  Blockly.BlockSvg.prototype.updateDisabled = function () {
    ...
    this.applyColour();
    if (!this.isCollapsed())
      for (var b = 0, c; (c = a[b]); b++) c.rendered && c.updateDisabled();
  };
  ...
  Blockly.ConnectionDB.prototype.searchForClosest = function (a, b, c) {
    ...
    for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y, b); )
      (h = this.connections_[k]),
        this.connectionChecker_.canConnect(a, h, !0, g) &&
  ...
  Blockly.WorkspaceSvg.prototype.refreshTheme = function () {
    ...
    this.updateBlockStyles_(
      this.getAllBlocks(!1).filter(function (b) {
  ...
  Blockly.WorkspaceSvg.prototype.showContextMenu = function (a) {
    if (!this.options.readOnly && !this.isFlyout) {
      var b = Blockly.ContextMenuRegistry.registry.getContextMenuOptions(
  ...
  Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    !b.hasCategories &&
      b.languageTree &&
      ((c = e.addFlyout(Blockly.utils.Svg.SVG)),
      Blockly.utils.dom.insertAfter(c, a));
    ...
    b.readOnly ||
      e.isMovable() ||
      e.addChangeListener(function (f) {
        if (
          !e.isDragging() &&
          !e.isMovable() &&
          -1 != Blockly.Events.BUMP_EVENTS.indexOf(f.type)
        ) {
          ...
          e.isContentBounded()
            ? ((h = e.getBlocksBoundingBox()),
              (g.contentLeft = h.left),
              (g.contentTop = h.top),
              (g.contentRight = h.right),
              (g.contentBottom = h.bottom))
            : ((g.contentLeft = h.contentLeft / k),
              (g.contentTop = h.contentTop / k),
              (g.contentRight = (h.contentLeft + h.contentWidth) / k),
              (g.contentBottom = (h.contentTop + h.contentHeight) / k));
          if (
            g.contentTop < g.viewTop ||
            g.contentBottom > g.viewBottom ||
            g.contentLeft < g.viewLeft ||
            g.contentRight > g.viewRight
          ) {
            h = null;
            f &&
              ((h = Blockly.Events.getGroup()),
              Blockly.Events.setGroup(f.group));
            switch (f.type) {
              case Blockly.Events.BLOCK_CREATE:
              case Blockly.Events.BLOCK_MOVE:
                var l = e.getBlockById(f.blockId);
                l && (l = l.getRootBlock());
                break;
        ...
        Blockly.Variables.promptName(
          ...
          function (g) {
            if (g) {
              ...
              if (h) {
                if (h.type == d)
                  var k = Blockly.Msg.VARIABLE_ALREADY_EXISTS.replace(
                    "%1",
                    h.name
                  );
                else
    ...
    var d = function (e) {
      ...
      Blockly.Variables.promptName(f, e, function (g) {
        if (g) {
          ...
          h
            ? ((h = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace(
                "%1",
                h.name
              ).replace("%2", h.type)),
  ...
  Blockly.Variables.promptName = function (a, b, c) {
    Blockly.prompt(a, b, function (d) {
      d &&
        ...
        d == Blockly.Msg.RENAME_VARIABLE || d == Blockly.Msg.NEW_VARIABLE) &&
        (d = null);
      c(d);
    });
  };
  ...
  Blockly.hideChaff = function (a) {
    ...
    a ||
      ...
      a.trashcan && a.trashcan.flyout && a.trashcan.closeFlyout(),
      (a = a.getToolbox()) &&
        a.getFlyout() &&
  ...
  Blockly.Flyout.prototype.show = function (a) {
    ...
    this.listeners_.push(
      Blockly.bindEventWithChecks_(
        ...
        function () {
          for (
            var b = this.workspace_.getTopBlocks(!1), c = 0, d;
            (d = b[c]);
            c++
          )
            d.removeSelect();
  ...
  Blockly.Flyout.prototype.createFlyoutInfo_ = function (a) {
    ...
    for (
      ...
      switch (
        (f.custom &&
          ((f = this.getDynamicCategoryContents_(f.custom)),
  ...
  Blockly.Flyout.prototype.getBlockXml_ = function (a) {
    ...
    c && "string" != typeof c
      ? (b = c)
      : c && "string" == typeof c
      ? ((b = Blockly.Xml.textToDom(c)), (a.blockxml = b))
      : a.type &&
        ((b = Blockly.utils.xml.createElement("xml")),
  ...
  Blockly.ToolboxCategory.prototype.parseContents_ = function (a) {
    var b = a.contents;
    if (a.custom) this.flyoutItems_ = a.custom;
    else if (b) {
      a = 0;
  ...
  Blockly.ToolboxCategory.prototype.createRowContainer_ = function () {
    ...
    b = b.toString() + "px";
    this.workspace_.RTL
      ? (a.style.paddingRight = b)
      : (a.style.paddingLeft = b);
    return a;
  };
  ...
  Blockly.ToolboxCategory.prototype.createIconDom_ = function () {
    ...
    this.parentToolbox_.isHorizontal() ||
      Blockly.utils.dom.addClass(a, this.cssConfig_.icon);
  ...
  Blockly.ToolboxCategory.prototype.addColourBorder_ = function (a) {
    a &&
      ((a = Blockly.ToolboxCategory.borderWidth + "px solid " + (a || "#ddd")),
      this.workspace_.RTL
        ? (this.rowDiv_.style.borderRight = a)
        : (this.rowDiv_.style.borderLeft = a));
  };
  Blockly.ToolboxCategory.prototype.getColour_ = function (a) {
    ...
    else return b ? this.getColourfromStyle_(b) : this.parseColour_(a);
    return "";
  };
  ...
  Blockly.ToolboxCategory.prototype.openIcon_ = function (a) {
    a &&
      (Blockly.utils.dom.removeClasses(a, this.cssConfig_.closedicon),
      Blockly.utils.dom.addClass(a, this.cssConfig_.openicon));
  };
  Blockly.ToolboxCategory.prototype.closeIcon_ = function (a) {
    a &&
      (Blockly.utils.dom.removeClasses(a, this.cssConfig_.openicon),
  ...
  Blockly.CollapsibleToolboxCategory.prototype.makeDefaultCssConfig_ = function () {
    var a = Blockly.CollapsibleToolboxCategory.superClass_.makeDefaultCssConfig_.call(
      this
    );
  ...
  Blockly.CollapsibleToolboxCategory.prototype.parseContents_ = function (a) {
    ...
    if (a.custom) this.flyoutItems_ = a.custom;
      ...
      a = 0;
      for (var d; (d = b[a]); a++)
        !Blockly.registry.hasItem(Blockly.registry.Type.TOOLBOX_ITEM, d.kind) ||
        (d.kind.toLowerCase() == Blockly.ToolboxSeparator.registrationName && c)
          ? (this.flyoutItems_.push(d), (c = !0))
          : (this.createToolboxItem_(d), (c = !1));
    }
  };
  Blockly.CollapsibleToolboxCategory.prototype.createToolboxItem_ = function (
    ...
    var b = a.kind;
    "CATEGORY" == b.toUpperCase() &&
      Blockly.utils.toolbox.isCategoryCollapsible(a) &&
      (b = Blockly.CollapsibleToolboxCategory.registrationName);
    a = new (Blockly.registry.getClass(Blockly.registry.Type.TOOLBOX_ITEM, b))(
      a,
      this.parentToolbox_,
      this
    );
  ...
  Blockly.CollapsibleToolboxCategory.prototype.init = function () {
    ...
    this.setExpanded(
      "true" == this.toolboxItemDef_.expanded || this.toolboxItemDef_.expanded
    );
  };
  ...
  Blockly.Toolbox.prototype.attachEvents_ = function (a, b) {
    a = Blockly.bindEventWithChecks_(
      a,
      "mousedown",
      this,
      this.onClick_,
    ...
    b = Blockly.bindEventWithChecks_(
      b,
      "keydown",
      this,
      this.onKeyDown_,
  ...
  Blockly.Toolbox.prototype.onClick_ = function (a) {
    if (Blockly.utils.isRightButton(a) || a.target == this.HtmlDiv)
      ...
      b &&
        ((b = this.getToolboxItemById(b)),
        b.isSelectable() && (this.setSelectedItem(b), b.onClick(a)));
      Blockly.hideChaff(!0);
    }
    Blockly.Touch.clearTouchIdentifier();
  };
    ...
    switch (a.keyCode) {
      ...
      case Blockly.utils.KeyCodes.SPACE:
        this.selectedItem_ &&
          ...
          (this.selectedItem_.toggleExpanded(), (b = !0));
        break;
      default:
        b = !1;
    }
  ...
  Blockly.Toolbox.prototype.createToolboxItem_ = function (a, b) {
    ...
    "CATEGORY" == c.toUpperCase() &&
      Blockly.utils.toolbox.isCategoryCollapsible(a) &&
      (c = Blockly.CollapsibleToolboxCategory.registrationName);
    if (
      (c = Blockly.registry.getClass(
        Blockly.registry.Type.TOOLBOX_ITEM,
        c.toLowerCase()
      ))
    )
  ...
  Blockly.Toolbox.prototype.getClientRect = function () {
    ...
    var a = this.HtmlDiv.getBoundingClientRect(),
      ...
      d = a.left;
    a = d + a.width;
    return this.toolboxPosition == Blockly.utils.toolbox.Position.TOP
  ...
  Blockly.Toolbox.prototype.selectItemByPosition = function (a) {
    -1 < a &&
      a < this.contents_.length &&
      ((a = this.contents_[a]), a.isSelectable() && this.setSelectedItem(a));
  };
  Blockly.Toolbox.prototype.updateFlyout_ = function (a, b) {
    (a != b || b.isCollapsible()) && b && b.getContents().length
      ? (this.flyout_.show(b.getContents()), this.flyout_.scrollToStart())
      : this.flyout_.hide();
  };
  ...
  Blockly.Toolbox.prototype.selectParent_ = function () {
    return this.selectedItem_
      ? this.selectedItem_.isCollapsible() && this.selectedItem_.isExpanded()
        ? (this.selectedItem_.setExpanded(!1), !0)
        : this.selectedItem_.getParent() &&
          this.selectedItem_.getParent().isSelectable()
        ? (this.setSelectedItem(this.selectedItem_.getParent()), !0)
        : !1
      : !1;
  };
  ...
  Blockly.Toolbox.prototype.dispose = function () {
    ...
    for (a = 0; a < this.boundEvents_.length; a++)
      Blockly.unbindEvent_(this.boundEvents_[a]);
    this.boundEvents_ = [];
    this.contents_ = [];
  ...
  Blockly.Trashcan.prototype.setLidOpen = function (a) {
    this.isLidOpen != a &&
      (clearTimeout(this.lidTask_), (this.isLidOpen = a), this.animateLid_());
  };
  ...
  Blockly.Mutator.prototype.resizeBubble_ = function () {
    ...
    if (
      ...
      Math.abs(this.workspaceHeight_ - d) > a
    )
  ...
  Blockly.Mutator.prototype.setVisible = function (a) {
    if (a != this.isVisible())
      if (
        ...
        a
          ? ((b = 2 * a.CORNER_RADIUS),
            (a = this.rootBlock_.RTL ? a.getWidth() + b : b))
          : (a = b = 16);
        this.block_.RTL && (a = -a);
  ...
  Blockly.Mutator.prototype.updateBlockStyle = function () {
    ...
    if (a && a.getAllBlocks(!1)) {
      ...
      if ((c = a.getFlyout()))
        for (a = c.workspace_.getAllBlocks(!1), c = 0; c < a.length; c++)
    ...
    function a(f) {
      ...
      return (
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point(0, f * k),
          Blockly.utils.svgPaths.point(-b, g * l),
          m,
        ]) +
        Blockly.utils.svgPaths.curve("s", [
          Blockly.utils.svgPaths.point(b, 2.5 * g),
          h,
        ])
      );
    }
  ...
  Blockly.blockRendering.ConstantProvider.prototype.makeNotch = function () {
    function a(g) {
      return Blockly.utils.svgPaths.line([
        Blockly.utils.svgPaths.point(g * d, c),
        Blockly.utils.svgPaths.point(3 * g, 0),
        Blockly.utils.svgPaths.point(g * d, -c),
      ]);
    }
  ...
  Blockly.blockRendering.Types.getType = function (a) {
    Object.prototype.hasOwnProperty.call(Blockly.blockRendering.Types, a) ||
    ...
    function a(d, e, f) {
      ...
      return (
        Blockly.utils.svgPaths.arc(
          ...
          "0 0,1",
          d,
          Blockly.utils.svgPaths.point((e ? -1 : 1) * d, (e ? -1 : 1) * d)
        ) +
        Blockly.utils.svgPaths.lineOnAxis("v", (f ? 1 : -1) * g) +
        Blockly.utils.svgPaths.arc(
          "a",
          "0 0,1",
          d,
  ...
  Blockly.zelos.ConstantProvider.prototype.makeSquared = function () {
    function a(c, d, e) {
      ...
      return (
        ...
        Blockly.utils.svgPaths.lineOnAxis("v", (e ? 1 : -1) * c) +
        Blockly.utils.svgPaths.arc(
          "a",
          "0 0,1",
          b,
  ...
  Blockly.zelos.ConstantProvider.prototype.makeNotch = function () {
    function a(l) {
      return (
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((l * e) / 2, 0),
          Blockly.utils.svgPaths.point((l * e * 3) / 4, g / 2),
          Blockly.utils.svgPaths.point(l * e, g),
        ]) +
        Blockly.utils.svgPaths.line([Blockly.utils.svgPaths.point(l * e, f)]) +
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((l * e) / 4, g / 2),
          Blockly.utils.svgPaths.point((l * e) / 2, g),
          Blockly.utils.svgPaths.point(l * e, g),
        ]) +
        Blockly.utils.svgPaths.lineOnAxis("h", l * d) +
        Blockly.utils.svgPaths.curve("c", [
          Blockly.utils.svgPaths.point((l * e) / 2, 0),
          Blockly.utils.svgPaths.point((l * e * 3) / 4, -(g / 2)),
          Blockly.utils.svgPaths.point(l * e, -g),
