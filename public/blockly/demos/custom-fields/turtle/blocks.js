...
Blockly.Blocks.turtle_nullifier = {
  init: function () {
    this.appendDummyInput().appendField("no trademarks");
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_CENTRE)
      .appendField(
        new CustomFields.FieldTurtle(null, null, null, this.validate),
        "TURTLE"
      );
    this.setStyle("loop_blocks");
    this.setCommentText(
      "Validates combinations of names and hats to null" +
  ...
  validate: function (newValue) {
    ...
    if (
      (newValue.turtleName == "Leonardo" && newValue.hat == "Mask") ||
...
Blockly.Blocks.turtle_changer = {
  init: function () {
    ...
    this.appendDummyInput().appendField(
      new CustomFields.FieldTurtle("Dots", "Crown", "Yertle", this.validate),
      "TURTLE"
    );
    this.setStyle("loop_blocks");
    this.setCommentText(
      "Validates the input so that certain names always" +
