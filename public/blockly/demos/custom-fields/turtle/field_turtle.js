...
CustomFields.FieldTurtle.PATTERNS = ["Dots", "Stripes", "Hexagons"];
...
CustomFields.FieldTurtle.prototype.doClassValidation_ = function (newValue) {
  ...
  if (newValue.pattern == undefined) {
    ...
    CustomFields.FieldTurtle.PATTERNS.indexOf(newValue.pattern) == -1
  ) {
  ...
  if (newValue.turtleName == undefined) {
    ...
    CustomFields.FieldTurtle.NAMES.indexOf(newValue.turtleName) == -1
  ) {
...
CustomFields.FieldTurtle.prototype.dropdownCreate_ = function () {
  ...
  this.editorListeners_.push(
    Blockly.bindEvent_(randomizeButton, "mouseup", this, function () {
      const value = {};
      value.pattern =
...
CustomFields.FieldTurtle.prototype.applyColour = function () {
  ...
  const fillColour = isShadow
    ? this.sourceBlock_.getColourShadow()
...
CustomFields.FieldTurtle.prototype.createView_ = function () {
  ...
  const head = Blockly.utils.dom.createSvgElement(
    "path",
    {
      class: "turtleBody",
      d:
        "M47.991,17.884c0,1.92-2.144,3.477-4.788,3.477a6.262,6.262,0,0,1-2.212-.392c-0.2-.077-1.995,2.343-4.866,3.112a17.019,17.019,0,0,1-6.01.588c-4.413-.053-2.5-3.412-2.745-3.819-0.147-.242,2.232.144,6.126-0.376a7.392,7.392,0,0,0,4.919-2.588c0-1.92,2.144-3.477,4.788-3.477S47.991,15.964,47.991,17.884Z",
      transform: "translate(0.312 -12.994)",
    },
    this.turtleGroup_
  );
