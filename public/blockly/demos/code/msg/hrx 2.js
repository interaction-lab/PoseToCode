const MSG = {
  ...
  runTooltip:
    "Das Programm ausfüahre, das von den Bausten im Oorweitsbereich definiert ist.",
  ...
  xmlError:
    "Dein gespeicherte Datei könnt net gelood sin. Vielleicht woard se mit ener annre Version von Blockly erstellt.",
  badXml:
    "Fehler beim Parse von XML:\n%1\n\nWähle 'OK' zum Verwerfe von deiner Ändrunge orrer 'Abbreche' zum XML weiter beoorbeite.",
};
