...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Calculadora de seients d\'avi\u00F3</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Un avi\u00F3 t\u00E9 dos seients en la cabina de vol (pel pilot i pel copilot) i un nombre de files de seients de passatgers. Cada fila cont\u00E9 quatre seients.";
      break;
    case 3:
      output +=
        "Un avi\u00F3 t\u00E9 dos seients en la cabina de vol (pel pilot i copilot) i un nombre de files per seients de passatgers de primera classe i de segona classe. Cada fila de primera classe cont\u00E9 quatre seients. Cada fila de segona classe cont\u00E9 cinc seients.";
      break;
  }
  output +=
    '</p><p>Constru\u00EFu una f\u00F3rmula (a sota) que calculi el nombre total de seients de l\'avi\u00F3 a mida que canvi\u00EFn les files (a dalt).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
