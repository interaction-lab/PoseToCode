...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Kalkulator miejsc w samolocie.</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Samolot ma dwa miejsca w kabinie pilot\u00F3w (dla pierwszego i drugiego pilota) oraz rz\u0119dy siedze\u0144 dla pasa\u017Cer\u00F3w. Ka\u017Cdy taki rz\u0105d sk\u0142ada si\u0119 z czterech siedze\u0144.";
      break;
    case 3:
      output +=
        "Samolot ma dwa miejsca w kabinie pilot\u00F3w (dla pierwszego i drugiego pilota) oraz rz\u0119dy siedze\u0144 dla pasa\u017Cer\u00F3w pierwszej i drugiej klasy. Ka\u017Cdy rz\u0105d pierwszej klasy sk\u0142ada si\u0119 z czterech siedze\u0144. Ka\u017Cdy rz\u0105d drugiej klasy sk\u0142ada si\u0119 z pi\u0119ciu siedze\u0144.";
      break;
  }
  output +=
    '</p><p>Zbuduj wz\u00F3r (poni\u017Cej), kt\u00F3ry pozwala obliczy\u0107 \u0142\u0105czn\u0105 liczb\u0119 siedze\u0144 w samolocie w funkcji zmieniaj\u0105cej si\u0119 liczby rz\u0119d\u00F3w (powy\u017Cej).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
