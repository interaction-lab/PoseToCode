...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Lennukiistmete kalkulaator</span> &nbsp; ';
  const iLimit37 = opt_ijData.maxLevel + 1;
  for (let i37 = 1; i37 < iLimit37; i37++) {
    output +=
      " " +
      (i37 == opt_ijData.level
        ? '<span class="tab" id="selected">' + soy.$$escapeHtml(i37) + "</span>"
        : i37 < opt_ijData.level
  ...
  switch (opt_ijData.level) {
    case 1:
      output +=
        "Lennukis on reisijate istmed mitmes reas. Igas reas on neli istet.";
      break;
    case 2:
      output +=
        "Lennuki kokpitis on kaks istet (üks kummalegi piloodile) ja mingi arv istemridu reisijatele. Igas reas on neli istet.";
      break;
    case 3:
      output +=
        "Lennuki kokpitis on kaks istet (üks kummalegi piloodile), mingi arv ridu 1. klassi reisijatele ja mingi arv ridu 2. klassi reisijatele. Igas 1. klassi reas on neli istet, igas 2. klassi reas viis istet.";
      break;
  }
  output +=
    '</p><p>Ehita plokkidest valem, mis arvutab istmete arvu lennukis õigesti sõltumata ridade arvust (seda saad muuta lennuki juures oleva liuguriga).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
