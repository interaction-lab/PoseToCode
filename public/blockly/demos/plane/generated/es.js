...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Calculadora de asientos de avi\u00F3n</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Un avi\u00F3n tiene dos asientos en la cabina de vuelo (para el piloto y co-piloto), y un n\u00FAmero de filas de asientos de pasajeros. Cada fila contiene cuatro asientos.";
      break;
    case 3:
      output +=
        "Un avi\u00F3n tiene dos asientos en la cabina de vuelo (para el piloto y co-piloto), y un n\u00FAmero de filas de asientos para pasajeros de primera y segunda clase. Cada fila de la primera clase contiene cuatro asientos. Cada fila de la segunda clase contiene cinco asientos.";
      break;
  }
  output +=
    '</p><p>Construir una f\u00F3rmula (abajo) que calcule el n\u00FAmero total de asientos en el avi\u00F3n cuando las filas sean cambiadas (arriba).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
