...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Flysetekalkulator</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "Et fly har to seter i cockpit (for piloten og andrepiloten), og et antall rader med passasjerseter. Hver rad inneholder fire seter.";
      break;
    case 3:
      output +=
        "Et fly har to seter i cockpit (for piloten og andrepiloten), og et antall rader med passasjerseter p\u00E5 f\u00F8rste og andre klasse. Hver av radene p\u00E5 f\u00F8rste klasse har fire seter. Hver av radene p\u00E5 andre klasse har fem seter.";
      break;
  }
  output +=
    '</p><p>Bygg en formel (under) som beregner det totale antall seter p\u00E5 flyet etter hvert som radene endres (over).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
