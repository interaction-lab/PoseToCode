...
planepage.start = function (opt_data, opt_ignored, opt_ijData) {
  let output =
    ...
    '<table width="100%"><tr><td><h1><a href="https://developers.google.com/blockly/">Blockly</a>&rlm; &gt; <a href="../index.html">Demos</a>&rlm; &gt; <span id="title">Jederez azezenn nijerez</span> &nbsp; ';
  ...
  switch (opt_ijData.level) {
    ...
    case 2:
      output +=
        "En un nijerez ez eus div azezenn el logell levia\u00F1(evit al loman hag an eil loman), hag ur toullad renkennado\u00F9 azezenno\u00F9 evit an dremenidi. Peder azezenn zo e pep renkennad.";
      break;
    case 3:
      output +=
        "En un nijerez ez eus div azezenn el logell levia\u00F1(evit al loman hag an eil loman), hag un toullad renkennado\u00F9 azezenno\u00F9 tremenidi kenta\u00F1 hag eil klas. Peder azezenn zo e pep renkennad kenta\u00F1 klas. Pemp azezenn zo e pemp renkennad eil klas.";
      break;
  }
  output +=
    '</p><p>Sevel ur formulenn (ama\u00F1 dindan) evit jedi\u00F1 an niver a azezenno\u00F9 en holl en nijerez pa vez kemmet an niver a renkennado\u00F9 (ama\u00F1 a-us).</p><script src="../../blockly_compressed.js"></script><script src="../../blocks_compressed.js"></script><script src="../../javascript_compressed.js"></script><script src="../../msg/js/' +
    soy.$$escapeHtml(opt_ijData.lang) +
