...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Nie je možné zmazať premennú „%1“, pretože je súčasťou definície funkcie „%2“";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Zmieša dve farby v danom pomere (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Vytvoriť farbu pomocou zadaného množstva červenej, zelenej a modrej. Množstvo musí byť medzi 0 a 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "prejdi na nasledujúce opakovanie slučky";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Vynechať zvyšok tejto slučky a pokračovať ďalším opakovaním.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Upozornenie: Tento blok sa môže používať len v rámci slučky.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Pre každý prvok v zozname priraď jeho hodnotu do premenej '%1' a vykonaj príkazy.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Nechá premennú '%1' nadobúdať hodnoty od začiatočného čísla po konečné s daným medzikrokom a vykoná zadané bloky.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'Pridať podmienku k "ak" bloku.';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Pridať poslednú záchytnú podmienku k "ak" bloku.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Pridať, odstrániť alebo zmeniť poradie oddielov tohto "ak" bloku.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Ak je hodnota pravda, vykonaj príkazy v prvom bloku. Inak vykonaj príkazy v druhom bloku.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Ak je prvá hodnota pravda, vykonaj príkazy v prvom bloku. Inak, ak je druhá hodnota pravda, vykonaj príkazy v druhom bloku.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Ak je prvá hodnota pravda, vykonaj príkazy v prvom bloku. Inak, ak je druhá hodnota pravda, vykonaj príkazy v druhom bloku. Ak ani jedna hodnota nie je pravda, vykonaj príkazy v poslednom bloku.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Kým je hodnota nepravdivá, vykonávaj príkazy.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Kým je hodnota pravdivá, vykonávaj príkazy.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Odstrániť %1 použití premennej '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Táto funkcia obsahuje duplikáty vstupov.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Nie je možné použiť premennú bez mena.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Vráti zoznam nulovej dĺžky, ktorý neobsahuje žiadne prvky.";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "zoznam";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Pridaj, odstráň alebo zmeň poradie v tomto zoznamovom bloku.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Vytvor zoznam s ľubovoľným počtom prvkov.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Vráti prvok na určenej pozícii v zozname.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Vráti index prvého/posledného výskytu prvku v zozname. Ak sa nič nenašlo, vráti %1.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Vytvorí zoznam s niekoľkými rovnakými prvkami s danou hodnotou.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Vsunie prvok na určenú pozíciu v zozname.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Spojiť zoznam textov do jedného textu s oddeľovačmi.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Rozdelenie textu do zoznamu textov, lámanie na oddeľovačoch.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Vráť hodnotu pravda, ak sú vstupy rovnaké.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Vráť hodnotu pravda ak prvý vstup je väčší než druhý.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Vráť hodnotu pravda ak prvý vstup je väčší alebo rovný druhému.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Vráť hodnotu pravda, ak prvý vstup je menší než druhý.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Vráť hodnotu pravda ak prvý vstup je menší alebo rovný druhému.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Vráť hodnotu pravda, ak vstupy nie sú rovnaké.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Vráti hodnotu pravda, ak je vstup nepravda. Vráti hodnotu nepravda ak je vstup pravda.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Vráť hodnotu pravda, ak sú vstupy pravdivé.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Vráť hodnotu pravda, ak je aspoň jeden vstup pravda.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  'Skontroluj podmienku testom. Ak je podmienka pravda, vráť hodnotu "ak pravda", inak vráť hodnotu "ak nepravda".';
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Vráťte arktangent bodu (X, Y) v stupňoch od -180 do 180.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Vráť jednu zo zvyčajných konštánt: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), alebo ∞ (nekonečno).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Obmedzí číslo do zadaných hraníc (vrátane).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Skontroluj či je číslo párne, nepárne, celé, kladné, záporné alebo deliteľné určitým číslom. Vráť hodnotu pravda alebo nepravda.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Vráť aritmetický priemer čísel v zozname.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Vráť náhodné číslo z intervalu 0.0 (vrátane) až 1.0.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Vráť náhodné celé číslo z určeného intervalu (vrátane).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Spustí používateľom definovanú funkciu '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://sk.wikipedia.org/wiki/Podprogram";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Spustí používateľom definovanú funkciu '%1' a použije jej výstup.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Ak je hodnota pravda, tak vráti druhú hodnotu.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Upozornenie: Tento blok môže byť len vo vnútri funkcie.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Pridať, odstrániť alebo zmeniť poradie vstupov tejto funkcie.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Vráť kópiu textu s inou veľkosťou písmen.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Počet výskytov textu nachádzajúcom sa v inom texte.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Pridaj, odstráň alebo zmeň poradie oddielov v tomto textovom bloku.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "vyber podreťazec od # písmena od konca";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "vyber podreťazec od písmena #";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Vráti index prvého/posledného výskytu prvého textu v druhom texte. Ak nenájde, vráti %1.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Vráti hodnotu pravda, ak zadaný text je prázdny.";
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Vráti počet písmen (s medzerami) v zadanom texte.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Výzva pre používateľa na zadanie čísla.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT =
  "Výzva pre používateľa na zadanie textu.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Vráť kópiu textu bez medzier na jednom alebo oboch koncoch.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Nastaví túto premennú, aby sa rovnala vstupu.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "Premenná s názvom %1 už existuje.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Premenná s názvom '%1' už existuje pre inú premennú typu '%2'.";
