...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "متغیر '%1' را نمی‌توان پاک کرد، زیرا جزیی از تعریف تابع '%2' می‌باشد";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "دو رنگ را با نسبت مشخص‌شده مخلوط می‌کند (۰٫۰ - ۱٫۰)";
Blockly.Msg.COLOUR_PICKER_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B1%D9%86%DA%AF";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "ساخت یک رنگ با مقدار مشخص‌شده‌ای از قرمز، سبز و آبی. همهٔ مقادیر باید بین ۰ تا ۱۰۰ باشند.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "برای هر مورد در این فهرست، تنظیم متغیر «%1» به مورد و انجام تعدادی عبارت.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "متغیر %1 را در مقادیر شروع‌شده از عدد انتهای  به عدد انتهایی را دارد، با فواصل مشخص‌شده می‌شمارد و این بلوک مشخص‌شده را انجام می‌دهد.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "افزودن یک شرط به بلوک اگر.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "اضافه کردن نهایی، گرفتن همهٔ شرایط به بلوک اگر.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "افزودن، حذف یا بازمرتب‌سازی قسمت‌ها برای پیکربندی دوبارهٔ این بلوک اگر.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "اگر یک مقدار صحیح است، اول بلوک اول عبارات را انجام بده.  در غیر این صورت بلوک دوم عبارات انجام بده.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "اگر مقدار اول صحیح بود، از آن بلوک اول عبارات را انجام بده.  در غیر این صورت، اگر مقدار دوم صحیح است، بلوک دوم عبارات را انجام بده.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "اگر مقدار اول درست است، بلوک اول عبارات را انجام بده.  در غیر این صورت، اگر مقدار دوم درست باشد بلوک دوم عبارات را انجام بده.  اگر هیچ از مقادیر درست نبود، آخرین بلوک عبارات را انجام بده.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%AD%D9%84%D9%82%D9%87_%D9%81%D9%88%D8%B1";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "تعداد %1 استفاده از متغیر '%2' پاک شود؟";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "این تابع دارای ورودی‌های تکراری است.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "فهرستی با طول صفر شامل هیچ رکورد داده‌ای بر می‌گرداند.";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "فهرست";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "اضافه کردن، حذف کردن یا ترتیب‌سازی مجدد بخش‌ها این بلوک فهرستی.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "موردی در محل مشخص‌شده بر می‌گرداند.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "یک مورد تصادفی در یک فهرست بر می‌گرداند.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "مورد در محل مشخص‌شده در فهرست را حذف و بر می‌گرداند.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "مورد مشخص‌شده در موقعیت مشخص در یک فهرست را حذف و بر می‌گرداند.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "کپی از قسمت مشخص‌شدهٔ لیست درست می‌کند.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "شاخصی از اولین/آخرین رخ‌داد مورد در فهرست را بر می‌گرداند. %1 بر می‌گرداند اگر آیتم موجود نبود.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "اگر فهرست خالی است مقدار صجیج بر می‌گرداند.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "فهرستی شامل مقادیر داده‌شدهٔ تکرار شده عدد مشخص‌شده می‌سازد.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "موردی به ته فهرست اضافه می‌کند.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "مورد را به صورت تصادفی در یک فهرست می‌افزاید.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "مورد مشخص‌شده در یک فهرست را قرار می‌دهد.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "یک مورد تصادفی در یک فهرست را تعیین می‌کند.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "چسباندن یک فهرست از متن‌ها و تشکیل یک متن که با یک جداکننده جدا شده‌اند";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "شکستن متن به فهرستی از متن‌ها، شکستن در محل جداکننده";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://fa.wikipedia.org/wiki/%D9%86%D8%A7%D8%A8%D8%B1%D8%A7%D8%A8%D8%B1%DB%8C";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "بازگشت صحیح اگر هر دو ورودی با یکدیگر برابر باشد.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "بازگرداندن صحیح اگر ورودی اول بزرگتر از ورودی دوم باشد.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "بازگرداندن صحیح اگر ورودی اول بزرگتر یا مساوی یا ورودی دوم باشد.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "بازگرداندن صحیح اگر ورودی اول کوچکتر از ورودی دوم باشد.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "صجیج باز می‌گرداند اگر ورودی نا صحیح باشند. ناصحیح بازمی‌گرداند اگر ورودی صحیح باشد.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "بازگرداندن صحیح اگر هر دو ورودی صحیح باشد.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "بازگرداندن صحیح اگر یکی از دو ورودی صحیح باشد.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%AD%D8%B3%D8%A7%D8%A8";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "بازگرداندن اولین عددی که از توان عدد دوم حاصل شده باشد.";
...
Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%A7%D8%B5%D8%B7%D9%84%D8%A7%D8%AD_%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D9%87%E2%80%8C%D9%86%D9%88%DB%8C%D8%B3%DB%8C#.D8.A7.D9.81.D8.B2.D8.A7.DB.8C.D8.B4_.D8.B4.D9.85.D8.A7.D8.B1.D9.86.D8.AF.D9.87";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%AB%D8%A7%D8%A8%D8%AA_%D8%B1%DB%8C%D8%A7%D8%B6%DB%8C";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "یکی از مقادیر ثابت جهانی را برمی‌گرداند: π (۳٫۱۴۱…)، e (۲٫۷۱۸...)، φ (۱٫۶۱۸)، sqrt(۲) (۱٫۴۱۴)، sqrt(۱/۲) (۰٫۷۰۷...) و یا ∞ (بی‌نهایت).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "بررسی می‌کند که آیا یک عدد زوج، فرد، اول، کامل، مثبت، منفی یا بخش‌پذیر عدد خاصی باشد را بررسی می‌کند. درست یا نادرست باز می‌گرداند.";
Blockly.Msg.MATH_IS_WHOLE = "کامل است";
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B9%D9%85%D9%84%DB%8C%D8%A7%D8%AA_%D9%BE%DB%8C%D9%85%D8%A7%D9%86%D9%87";
...
Blockly.Msg.MATH_NUMBER_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B9%D8%AF%D8%AF";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%AA%D9%88%D9%84%DB%8C%D8%AF_%D8%A7%D8%B9%D8%AF%D8%A7%D8%AF_%D8%AA%D8%B5%D8%A7%D8%AF%D9%81%DB%8C";
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "کسر تصادفی";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "بازگرداندن کسری تصادفی بین ۰٫۰ (بسته) تا ۱٫۰ (باز).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "یک عدد تصادفی بین دو مقدار مشخص‌شده به صورت بسته باز می‌گرداند.";
Blockly.Msg.MATH_ROUND_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B1%D9%88%DB%8C%D9%87_%28%D8%B9%D9%84%D9%88%D9%85_%D8%B1%D8%A7%DB%8C%D8%A7%D9%86%D9%87%29";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B1%DB%8C%D8%B4%D9%87_%D8%AF%D9%88%D9%85";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "بازگرداندن لگاریتم بر پایهٔ ۱۰ یک عدد.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%AA%D8%A7%D8%A8%D8%B9%E2%80%8C%D9%87%D8%A7%DB%8C_%D9%85%D8%AB%D9%84%D8%AB%D8%A7%D8%AA%DB%8C";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "بازگرداندن کسینوس یک زاویه درجه (نه رادیان).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "بازگرداندن سینوس یک زاویه به درجه (نه رادیان).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "بازگرداندن تانژانت یک زاویه به درجه (نه رادیان).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B1%D9%88%DB%8C%D9%87_(%D8%B9%D9%84%D9%88%D9%85_%D8%B1%D8%A7%DB%8C%D8%A7%D9%86%D9%87)";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "اخطار: این تابعی پارامتر تکراری دارد.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "اخطار: این بلوک احتمالاً فقط داخل یک تابع استفاده می‌شود.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "افزودن، حذف یا دوباره مرتب‌کردن ورودی این تابع.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "تعداد دفعاتی که یک متن درون یک متن دیگر تکرار شده است را برمی‌گرداند";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "شاخصی از اولین آخرین رخ‌داد متن اول در متن دوم بر می‌گرداند. اگر متن یافت نشد %1 باز می‌گرداند.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "اضافه کردن صحیح اگر متن فراهم‌شده خالی است.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "یک تکه‌ای از متن را با چسپاندن همهٔ تعداد از موارد ایجاد می‌کند.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "طول %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "بازگرداندن عددی از حروف (شامل فاصله‌ها) در متن فراهم‌شده.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "جایگزین کردن تمام مواردی که از متنی درون متن دیگر وجود دارد";
...
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://fa.wikipedia.org/wiki/%D8%B1%D8%B4%D8%AA%D9%87_%28%D8%B9%D9%84%D9%88%D9%85_%D8%B1%D8%A7%DB%8C%D8%A7%D9%86%D9%87%29";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "کپی از متن با فاصله‌های حذف‌شده از یک یا هر دو پایان باز می‌گرداند.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "در حال حاضر یک متغیر با نام '%1' برای متغیر دیگری از نوع '%2' وجود دارد.";
