...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Blandar tveimur litum í gefnu hlutfalli (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Láta breytuna '%1' taka inn gildi frá fyrstu tölu til síðustu tölu, hlaupandi á tiltekna bilinu og gera tilteknu kubbana.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Skilar atriðinu í hinum tiltekna stað í lista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Fjarlægir og skilar atriðinu á hinum tiltekna stað í lista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Fjarlægir atriðið á hinum tiltekna stað í lista.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Finnur hvar atriðið kemur fyrir fyrst/síðast í listanum og skilar sæti þess. Skilar %1 ef atriðið finnst ekki.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Bætir atriðinu í listann á tilteknum stað.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Setur atriðið í tiltekna sætið í listanum.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "í stafrófsröð án tillits til stafstöðu";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Sameinar lista af textum í einn texta, með skiltákn á milli.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Skiptir texta í lista af textum, með skil við hvert skiltákn.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Bæta við, fjarlægja eða umraða inntökum fyrir þetta fall.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Finnur fyrsta/síðasta tilfelli fyrri textans í seinni textanum og skilar sæti hans. Skilar %1 ef textinn finnst ekki.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Breyta með heitinu '%1' er þegar til staðar.";
