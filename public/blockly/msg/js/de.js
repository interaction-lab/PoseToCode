...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Die Variable „%1“ kann nicht gelöscht werden, da sie Teil der Definition der Funktion „%2“ ist.";
Blockly.Msg.CHANGE_VALUE_TITLE = "Wert ändern:";
Blockly.Msg.CLEAN_UP = "Bausteine aufräumen";
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Eingeklappte Blöcke enthalten Warnungen.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Vermischt 2 Farben mit konfigurierbarem Farbverhältnis (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP =
  "Erzeugt eine Farbe nach dem Zufallsprinzip.";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Erzeugt eine Farbe mit selbst definierten Rot-, Grün- und Blauwerten. Alle Werte müssen zwischen 0 und 100 liegen.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  'Führt eine Anweisung für jeden Wert in der Liste aus und setzt dabei die Variable "%1" auf den aktuellen Listenwert.';
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Zählt die Variable "%1" von einem Startwert bis zu einem Endwert und führt für jeden Wert eine Anweisung aus.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Führt eine Anweisung aus, falls eine Bedingung wahr ist.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Führt die erste Anweisung aus, falls eine Bedingung wahr ist.  Führt ansonsten die zweite Anweisung aus.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Führt die erste Anweisung aus, falls die erste Bedingung wahr ist.  Führt ansonsten die zweite Anweisung aus, falls die zweite Bedingung wahr ist.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Führe die erste Anweisung aus, falls die erste Bedingung wahr ist.  Führt ansonsten die zweite Anweisung aus, falls die zweite Bedingung wahr ist.  Führt die dritte Anweisung aus, falls keine der beiden Bedingungen wahr ist";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Führt Anweisungen aus solange die Bedingung unwahr ist.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Führt Anweisungen aus solange die Bedingung wahr ist.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "%1 Verwendungen der Variable „%2“ löschen?";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Du kannst keinen leeren Variablennamen verwenden.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Erzeugt eine Liste aus den angegebenen Elementen.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Entfernt ein zufälliges Element aus der Liste.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Sucht die Position (Index) eines Elementes in der Liste. Gibt %1 zurück, falls kein Element gefunden wurde.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Setzt das letzte Element in die Liste.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Ist wahr, falls beide Werte gleich sind.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Ist wahr, falls der erste Wert größer als der zweite Wert ist.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Ist wahr, falls der erste Wert größer als oder gleich groß wie der zweite Wert ist.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Ist wahr, falls der erste Wert kleiner als der zweite Wert ist.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Ist wahr, falls der erste Wert kleiner als oder gleich groß wie der zweite Wert ist.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Ist wahr, falls der Eingabewert unwahr ist.  Ist unwahr, falls der Eingabewert wahr ist.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Ist wahr, falls beide Werte wahr sind.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Ist wahr, falls einer der beiden Werte wahr ist.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Ist die erste Zahl potenziert mit der zweiten Zahl.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Gibt den Arkustangens des Punktes (X, Y) in Grad von -180 bis 180 zurück.";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Begrenzt eine Zahl auf den Wertebereich zwischen zwei anderen Zahlen (inklusiv).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Überprüft ob eine Zahl gerade, ungerade, eine Primzahl, ganzzahlig, positiv, negativ oder durch eine zweite Zahl teilbar ist.  Gibt wahr oder falsch zurück.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Erzeugt eine Zufallszahl zwischen 0.0 (inklusiv) und 1.0 (exklusiv).";
Blockly.Msg.MATH_RANDOM_INT_HELPURL =
  "https://de.wikipedia.org/wiki/Zufallszahlen";
Blockly.Msg.MATH_RANDOM_INT_TITLE =
  "ganzzahlige Zufallszahl zwischen %1 und %2";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Erzeugt eine ganzzahlige Zufallszahl zwischen zwei Zahlen (inklusiv).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP =
  "Ist Wert der Exponentialfunktion einer Zahl.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Ist der natürliche Logarithmus einer Zahl.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Ist der dekadische Logarithmus einer Zahl.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Ist der Sinus des Winkels (nicht Radiant).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Ist der Tangens des Winkels (nicht Radiant).";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Gibt den zweiten Wert zurück und verlässt die Funktion, falls der erste Wert wahr ist.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Warnung: Dieser Block darf nur innerhalb eines Funktionsblocks genutzt werden.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Zähle, wie oft ein Text innerhalb eines anderen Textes vorkommt.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Findet das erste / letzte Auftreten eines Suchbegriffs in einem Text.  Gibt die Position des Begriffs zurück oder %1 falls der Suchbegriff nicht gefunden wurde.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Ist wahr, falls der Text keine Zeichen enthält.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Ersetze alle Vorkommen eines Textes innerhalb eines anderen Textes.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Kehre die Reihenfolge der Zeichen im Text um.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Eine Variable namens „%1“ ist bereits vorhanden.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Eine Variable namens „%1“ ist bereits für einen anderen Typ vorhanden: „%2“.";
