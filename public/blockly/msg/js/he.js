...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  'אי אפשר למחוק את המשתנה "%1", מכיוון שהגדרת הפונקציה "%2" משתמשת בו.';
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "מערבב שני צבעים יחד עם יחס נתון(0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "צור צבע עם הסכום המצוין של אדום, ירוק וכחול. כל הערכים חייבים להיות בין 0 ל100.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "לכל פריט ברשימה, להגדיר את המשתנה '%1' לפריט הזה, ולאחר מכן לעשות כמה פעולות.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "תוסיף, תמחק, או תסדר מחדש כדי להגדיר מחדש את הבלוק If.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "אם הערך הוא אמת, לבצע את הבלוק הראשון של הפעולות. אחרת, לבצע את הבלוק השני של הפעולות.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "אם הערך הראשון הוא אמת, לבצע את הבלוק הראשון של הפעולות. אחרת, אם הערך השני הוא אמת, לבצע את הבלוק השני של הפעולות.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "אם הערך הראשון הוא אמת, לבצע את הבלוק הראשון של הפעולות. אחרת, אם הערך השני הוא אמת, לבצע את הבלוק השני של הפעולות. אם אף אחד מהם אינו נכון, לבצע את הבלוק האחרון של הפעולות.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "בזמן שהערך שווה לשגוי, תעשה מספר חישובים.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "כל עוד הערך הוא אמת, לעשות כמה פעולות.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "החזר רשימה,באורך 0, המכילה רשומות נתונים";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "מחזיר פריט במיקום שצוין ברשימה.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "לקבל חלק מהרשימה החל מ-# עד הסוף";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "מחזירה את האינדקס של המופע הראשון/האחרון של הפריט ברשימה.  מחזירה %1 אם הפריט אינו נמצא.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "יוצר רשימה המורכבת מהערך נתון חוזר מספר פעמים שצוין.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "מכניס את הפריט במיקום שצוין ברשימה.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "תחזיר נכון אם שני הקלטים שווים אחד לשני.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "תחזיר נכון אם הקלט הראשון גדול יותר מהקלט השני.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "תחזיר נכון אם הקלט הראשון גדול יותר או שווה לכניסה השנייה.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "תחזיר אמת (true) אם הקלט הראשון הוא קטן יותר מאשר הקלט השני.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "תחזיר אמת אם הקלט הראשון הוא קטן יותר או שווה לקלט השני.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "תחזיר אמת אם שני הקלטים אינם שווים זה לזה.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "החזר אמת אם הקלט הוא שקר. החזר שקר אם הקלט אמת.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "תחזיר נכון אם מתקיים לפחות אחד מהקלטים נכונים.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://he.wikipedia.org/wiki/ארבע_פעולות_החשבון";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "החזרת תוצאת הכפל בין שני מספרים.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "החזרת המספר הראשון בחזקת המספר השני.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "החזרת אחד מהקבועים המקובלים: π (3.141…),‏ e (2.718…),‏ φ (1.618…),‏ sqrt(2) (1.414…),‏ sqrt(½) (0.707…)‏ או ∞ (אינסוף).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "הגבלת מספר כך שיהיה בין המגבלות שמוגדרות (כולל).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "בדיקה האם מספר הוא זוגי, אי־זוגי, ראשוני, שלם, חיובי, שלילי או אם ניתן לחלק אותו במספר כלשהו. מחזירה אמת או שקר.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "החזרת הממוצע (ממוצע חשבוני) של הערכים המספריים שברשימה.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "החזרת רשימה של הפריטים הנפוצים ביותר ברשימה";
...
Blockly.Msg.MATH_RANDOM_INT_HELPURL =
  "https://he.wikipedia.org/wiki/מחולל_מספרים_אקראיים";
Blockly.Msg.MATH_RANDOM_INT_TITLE = "מספר שלם אקראי בין %1 ל-%2 (כולל)";
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "החזרת מספר שלם, חיובי ואקראי בין שני הגבולות שהוגדרו, כולל.";
Blockly.Msg.MATH_ROUND_HELPURL =
  "https://he.wikipedia.org/wiki/עיגול_(אריתמטיקה)";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://he.wikipedia.org/wiki/שגרה_(תכנות)";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "להפעיל את הפונקציה המוגדרת על-ידי המשתמש '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://he.wikipedia.org/wiki/שגרה_(תכנות)";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "להפעיל את הפונקציה המוגדרת על-ידי המשתמש '%1' ולהשתמש הפלט שלה.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "אזהרה: לפונקציה זו יש פרמטרים כפולים.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "אזהרה: בלוק זה עשוי לשמש רק בתוך הגדרה של פונקציה.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "הוסף, הסר או סדר מחדש קלטים לפונקציה זו";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE =
  "לאותיות קטנות (עבור טקסט באנגלית)";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE =
  "לאותיות גדולות בתחילת כל מילה (עבור טקסט באנגלית)";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE =
  "לאותיות גדולות (עבור טקסט באנגלית)";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "מחזירה את האינדקס של המופע הראשון/האחרון בטקסט הראשון לתוך הטקסט השני. מחזירה %1 אם הטקסט אינו נמצא.";
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "מחזיר את מספר התווים (אותיות, רווחים וכו') בטקסט שהוזן.";
...
Blockly.Msg.TEXT_TEXT_HELPURL =
  "https://he.wikipedia.org/wiki/מחרוזת_(מדעי_המחשב)";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "להחזיר עותק של הטקסט לאחר מחיקת רווחים מאחד או משני הקצוות.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  'קיים כבר משתנה בשם "%1" מסוג אחר: "%2"';
