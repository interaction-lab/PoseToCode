...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Ezin da '%1' aldagaia ezabatu '%2' funtzioaren definizioaren zati delako.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Bi koloreko nahasketak erlazio jakin batekin nahasten ditu (0.0-1.0)";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "jarraitu hurrengo begizta iterazioarekin";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Agertzen den begiztatik ihes egin.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Zerrendako elementu bakoitzarentzat, ezarri %1 aldagaia elementura, eta egin adierazpen batzuk.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "%1 aldagaiak hasierako zenbakiaren eta amaierako zenbakirako balioak hartzen ditu, zehaztutako tartea zenbatzen du eta zehaztutako blokeak egin.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Gehitu, ezabatu, ala berrantolatu aukeraketak "ba" bloke hau berrezartzeko.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Balorea egia den bitartean, egin adierazpen batzuk.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Balorea egia bada, orduan egin ezazu lehenengo adierazpen blokea. Bestela, egin ezazu bigarren adierazpen blokea.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Lehenengo balorea egia bada, orduan egin ezazu lehenengo adierazpen blokea. Bestela, bigarren balorea egia bada, egin ezazu bigarren adierazpen blokea.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Lehenengo balorea egia bada, orduan egin ezazu lehenengo adierazpen blokea. Bestela, bigarren balorea egia bada, egin ezazu bigarren adierazpen blokea. Baloreetako bat ere ez bada egia, egin ezazu adierazpenen azkeneko blokea.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://eu.wikipedia.org/wiki/For_begizta";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Balorea gezurra den bitartean, egin adierazpen batzuk.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Ezabatu %2 aldagaiaren %1 erabilerak?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Funtzio honek errepikatutako sarrerak ditu.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Ezin duzu aldagaiaren izen huts bat erabili.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Zerrenda bat itzultzen du, 0 luzera duena, daturik gabekoa";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Lehenengo artikulua zerrendara bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Artikulua zerrendako posizio zehatz batera bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Azken artikulua zerrendara bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Artikulu aleatorioa zerrendara bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Lehenengo artikulua zerrendako posizio zehatz batera kentzen eta bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Artikulua zerrendako posizio zehatz batera kentzen eta bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Zerrendako azken artikulua kentzen eta bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Artikulu aleatorio bat zerrendatik kentzen eta bueltatzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Lehenengo artikulua zerrendatik kentzen du.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Artikulua zerrendako posizio zehatz batetik kentzen du.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Artikulu aleatorioa zerrendatik kentzen du.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://eu.wikipedia.org/wiki/Desberdintza";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://eu.wikipedia.org/wiki/Aritmetika";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Bi zenbakien biderkadura ematen du.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Konstante ohikoenetako bat itzultzen du: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), edo ∞ (infinitua).";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Zerrendako zenbakizko balioen batazbestekoa (aritmetikoa) itzultzen du.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Bueltatu artikulurik ohikoenetarikoen zerrenda.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Itzuli zerrendako elementu aleatorioa.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP =
  "Zenbaki bat gehiagoz edo gutxiagoz biribildu.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://eu.wikipedia.org/wiki/Funtzio_trigonometriko";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Azpierrutina";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Abisua: Funtzio honek parametro bikoiztuak dauzka.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Balioa egiazkoa bada, orduan itzuli bigarren baliora.";
...
Blockly.Msg.RENAME_VARIABLE_TITLE =
  "Aldatu '%1' aldagai guztien izenak eta izen hau eman:";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Gehitu, ezabatu, ala berrantolatu aukeraketak testu bloke hau berrezartzeko.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "zehaztutako testua, zenbakia edo bestelako balioa inprimatzen du.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "%1 izeneko aldagaia dagoeneko existitzen da.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "%1 izeneko aldagaia dagoeneko existitzen da %2 motako beste aldagai batekin.";
