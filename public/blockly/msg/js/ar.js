...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  'لايمكن حذف متغير "%1" بسبب انه جزء من الدالة "%2"';
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "إنشئ لون بالكمية المحددة من الأحمر, الأخضر والأزرق. بحيث يجب تكون كافة القيم بين 0 و 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "استمر ابتداءا من التكرار التالي من الحلقة";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "تخط ما تبقى من هذه الحلقة، واستمر ابتداءا من التكرار التالي.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "تحذير: يمكن استخدام هذه القطعة فقط داخل حلقة.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "لكل عنصر في قائمة ما، عين المتغير '%1' لهذا الغنصر، ومن ثم نفذ بعض الأوامر.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "اجعل المتغير  %1 يأخذ القيم من رقم البداية الى رقم النهاية، وقم بالعد داخل المجال المحدد، وطبق أوامر القطع المحددة.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = 'إضف شرطا إلى القطعة الشرطية "إذا".';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'أضف شرط "نهاية، إجمع" إلى القطعة الشرطية "إذا".';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'أضف, إزل, أو أعد ترتيب المقاطع لإعادة تكوين القطعة الشرطية "إذا".';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "إذا كانت قيمة ما تساوي صحيح, إذن قم بتنفيذ أمر ما.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  'إذا كانت قيمة ما تساوي "صحيح"، إذن قم بتنفيذ أول قطعة من الأوامر. والا ،قم بتنفيذ القطعة الثانية من الأوامر.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  'إذا كانت القيمة الأولى تساوي "صحيح", إذن قم بتنفيذ القطعة الأولى من الأوامر. والا, إذا كانت القيمة الثانية تساوي "صحيح", قم بتنفيذ القطعة الثانية من الأوامر.';
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  'إذا كانت القيمة الأولى تساوي "صحيح", إذن قم بتنفيذ القطعة الأولى من الأوامر. والا , إذا كانت القيمة الثانية تساوي "صحيح", قم بتنفيذ القطعة الثانية من الأوامر. إذا لم تكن هناك أي قيمة تساوي صحيح, قم بتنفيذ آخر قطعة من الأوامر.';
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "بما ان القيمة خاطئة, نفّذ بعض الأوامر.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "بما ان القيمة صحيحة, نفّذ بعض الأوامر.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "تقوم بإرجاع قائمة، طولها 0, لا تحتوي على أية سجلات البيانات";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "قائمة";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "أضف, إزل, أو أعد ترتيب المقاطع لإعادة تكوين القطعة قائمة القطع التالية.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "يرجع العنصر الأول في قائمة ما.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "يقوم بإرجاع العنصر في الموضع المحدد في قائمة ما.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "يرجع العنصر الأخير في قائمة ما.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "تقوم بإرجاع مؤشر التواجد  الأول/الأخير في القائمة.  تقوم بإرجاع %1 إذا لم يتم العثور على النص.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "انشئ قائمة تتألف من القيمة المعطاة متكررة لعدد محدد من المرات.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "ضم قائمة النصوص في نص واحد، مفصولة بواسطة محدد.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "تقسيم النص إلى قائمة من النصوص، وكسر في كل محدد";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "يرجع صحيح إذا كان كلا المدخلات مساوية بعضها البعض.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "يرجع صحيح إذا كان الإدخال الأول أكبر من الإدخال الثاني.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "يرجع صحيح إذا كان الإدخال الأول أكبر من أو يساوي الإدخال الثاني.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "يرجع صحيح إذا كان الإدخال الأول أصغر من الإدخال الثاني.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "يرجع صحيح إذا كان الإدخال الأول أصغر من أو يساوي الإدخال الثاني.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "يرجع صحيح إذا كانت كلا المدخلات غير مساوية لبعضها البعض.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "يرجع صحيح إذا كان الإدخال خاطئ .  يرجع خاطئ إذا كان الإدخال صحيح.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "ترجع صحيح إذا كان كلا المٌدخلات صحيح.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "ترجع صحيح إذا كان واحد على الأقل من المدخلات صحيح.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "تحقق الشرط في 'الاختبار'. إذا كان الشرط صحيح، يقوم بإرجاع قيمة 'اذا كانت العبارة صحيحة'؛ خلاف ذلك يرجع قيمة 'اذا كانت العبارة خاطئة'.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "يرجع الرقم الأول مرفوع إلى تربيع الرقم الثاني.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 من X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "عودة قوس ظل النقطة (س، ص) بالدرجات من -180 إلى 180.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "ير جع واحد من الثوابت الشائعة : π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), or ∞ (infinity).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "تقييد العددليكون بين الحدود المحددة (ضمناً).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "تحقق إذا كان عدد ما زوجيا، فرذيا, أوليا، صحيحا،موجبا أو سالبا، أو إذا كان قابلا للقسمة على عدد معين.  يرجع صحيح أو خاطئ.";
...
Blockly.Msg.MATH_NUMBER_HELPURL =
  "https://ar.wikipedia.org/wiki/%D8%B9%D8%AF%D8%AF";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "يرجع المعدل (الوسط الحسابي) للقيم الرقمية في القائمة.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "يرجع قائمة من العنصر أو العناصر الأكثر شيوعاً في القائمة.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "يرجع مجموع كافة الأرقام الموجودة في القائمة.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "يرجع جزء عشوائي بين 0.0 (ضمنياً) و 1.0 (خارجيا).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "يرجع عدد صحيح عشوائي بين حدين محددين, ضمنيا.";
...
Blockly.Msg.MATH_ROUND_TOOLTIP =
  "تقريب الى اكبر عدد صحيح أو الى اصغر عدد صحيح.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP =
  "يرجع ه‍ (e) مرفوعا لأس بقيمة الرقم المدخل.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "يرجع جيب التمام لدرجة (لا زواية نصف قطرية).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "تشغيل الدالة المعرفة من قبل المستخدم '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "تشغيل الدالة المعرفة من قبل المستخدم %1 واستخدام  مخرجاتها.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "تحذير: هذه الدالة تحتوي على معلمات مكررة.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "إذا كانت القيمة صحيحة ، اذان قم بارجاع القيمة الثانية.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "تحذير:هذه القطعة تستخدم فقط داخل تعريف دالة.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "إضافة أو إزالة أو إعادة ترتيب المدخلات لهذه المهمة.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "أضف, إحذف, أو أعد ترتيب المقاطع لإعادة تكوين النص من القطع التالية.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "الحصول على سلسلة حروف فرعية من الحرف # من نهاية";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START =
  "الحصول على سلسلة حروف فرعية من الحرف #";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "تقوم بإرجاع مؤشر التواجد الأول/الأخير للنص الأول في النص الثاني.  تقوم بإرجاع %1 إذا لم يتم العثور على النص.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "أنشئ جزء من النص بالصاق أي عدد من العناصر ببعضها البعض.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "طول %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "تقوم بإرجاع عدد الاحرف (بما في ذلك الفراغات) في النص المقدم.";
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER =
  "انتظر ادخال المستخدم لرقم ما مع اظهار رسالة";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT =
  "انتظر ادخال المستخدم لنص ما مع اظهار رسالة";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "استبدل جميع حالات حدوث بعض النصوص داخل نص آخر.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "يرجع نسخة من النص مع حذف من أحد أو كلا الفراغات من أطرافه.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "تعيين هذا المتغير لتكون مساوية للقيمة المدخلة.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "المتغير '%1' موجود بالفعل";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "متغير بأسم '%1' معرف من نوع اخر : '%2'.";
