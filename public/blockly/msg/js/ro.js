...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Nu se poate șterge variabila '%1' deoarece face parte din definiția funcției '%2'";
...
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Blocurile blocate conțin avertismente.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Amestecă două culori cu un raport dat (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continuă cu următoarea iterație a buclei";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Ieși din bucla care conţine.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Adauga o stare finala, cuprinde toata conditia din blocul if.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Adaugă, elimină sau reordonează secţiuni pentru a reconfigura acest bloc if.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Dacă o valoare este adevărată, atunci fa unele declaraţii.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "În timp ce o valoare este adevărat, atunci face unele declaraţii.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Șterge %1 utilizările variabilei '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Această funcție are intrări duplicate.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Nu puteți utiliza un nume de variabilă gol.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Returneaza elementul la poziţia specificată într-o listă.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Returneaza un element aleatoriu într-o listă.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Elimină şi returneaza elementul la poziţia specificată într-o listă.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Elimină elementul la poziţia specificată într-o listă.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Returnează indexul primei/ultimei apariții a articolului din listă. Returnează %1 dacă elementul nu este găsit.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Returnează adevărat dacă lista este goală.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "creaza lista cu %1 elemente repetate de %2 ori";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Inserează elementul la poziţia specificată într-o listă.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Inserează elementul aleatoriu într-o listă.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Setează elementul la poziţia specificată într-o listă.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Setează un element aleator într-o listă.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Concatenează o listă de texte (alternate cu separatorul) într-un text unic";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Împarte textul într-o listă de texte, despărțite prin fiecare separator";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Returnează adevărat daca cele două intrări nu sunt egale.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Returnează adevărat daca ambele intrări sunt adevărate.";
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://ro.wikipedia.org/wiki/Aritmetic%C4%83";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Returneaza diferenţa dintre cele două numere.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Întoarceți arctangentul punctului (X, Y) în grade de la -180 la 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://ro.wikipedia.org/wiki/Constant%C4%83_matematic%C4%83";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Întoarce restul din împărţirea celor două numere.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Întoarce media (aritmetică) a valorilor numerice în listă.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Întoarce deviația standard a listei.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Returnează suma tuturor numerelor din lista.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Returnează o fracţie aleatoare între 0.0 (inclusiv) si 1.0 (exclusiv).";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Întoarce logaritmul natural al unui număr.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://ro.wikipedia.org/wiki/Funcții_trigonometrice";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS =
  "Întoarce cosinusul unui grad (nu radianul).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN =
  "Întoarce cosinusul unui grad (nu radianul).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN =
  "Întoarce tangenta unui grad (nu radianul).";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Executați funcția '%1 'definită de utilizator.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Executați funcția '%1 'definită de utilizator şi folosiţi producţia sa.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Crează o funcţie cu nici o ieşire.";
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL =
  "https://ro.wikipedia.org/wiki/Subrutină";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP =
  "Adaugă un parametru de intrare pentru funcție.";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "intrări";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Adăugă, șterge sau reordonează parametrii de intrare ai acestei funcții.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Întoarce o copie a textului într-un caz diferit.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Aflați de câte ori apare un text într-un alt text.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Adaugă, elimină sau reordonează secțiuni ca să reconfigureze blocul text.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Returnează indicele primei/ultimei apariţii din primul text în al doilea text.  Returnează %1 dacă textul nu este găsit.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Creaţi o bucată de text prin unirea oricărui număr de elemente.";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Solicită utilizatorul pentru un număr.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Înlocuiți toate aparițiile anumitor texte într-un alt text.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Returnează o copie a textului fără spațiile de la unul sau ambele capete.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Setează această variabilă sa fie egală la intrare.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "O variabilă cu numele '%1'  există deja.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "o variabilă numită '%1' există deja pentru alt tip: '%2'.";
