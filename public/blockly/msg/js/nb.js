...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Kan ikke slette variabelen «%1» fordi den er del av definisjonen for funksjonen «%2»";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Blander to farger sammen med et gitt forhold (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Lag en farge med angitt verdi av rød, grønn og blå. Alle verdier må være mellom 0 og 100.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Ha variabel "%1" ta verdiene fra start nummer til slutt nummer, telle med spesifisert intervall og lag de spesifiserte blokkene.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  "Legg til en betingelse til hvis blokken.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Legg til hva som skal skje hvis de andre ikke slår til.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Legg til, fjern eller flytt seksjoner i denne hvis-blokken.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Hvis dette er sant, så utfør den første blokken av instruksjoner. Hvis ikke, utfør den andre blokken.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Hvis det første stemmer, så utfør den første blokken av instruksjoner. Ellers, hvis det andre stemmer, utfør den andre blokken av instruksjoner.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Hvis den første verdien er sann, så utfør den første blokken med setninger. Ellers, hvis den andre verdien er sann, så utfør den andre blokken med setninger. Hvis ingen av verdiene er sanne, så utfør den siste blokken med setninger.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Så lenge et utsagn ikke stemmer, gjør noen instruksjoner.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Så lenge et utsagn stemmer, utfør noen instruksjoner.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Denne funksjonen har duplikatparametere.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Du kan ikke bruke et tomt variabelnavn.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Returner elementet på den angitte posisjonen i en liste.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Fjerner og returnerer elementet ved en gitt posisjon i en liste.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Fjerner et element ved en gitt posisjon i en liste.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Returnerer indeksen av den første/siste forekomsten av elementet i lista. Returnerer %1 hvis ikke funnet.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Setter inn elementet ved den angitte posisjonen i en liste.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabetisk, ignorert store/små bokstaver";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Føy sammen en liste tekster til én tekst, avskilt av en avgrenser.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Splitt teksten til en liste med tekster, brutt ved hver avgrenser.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Returnerer sann hvis begge inputene er like hverandre.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Returnerer sant hvis det første argumentet er større enn den andre argumentet.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Returnerer sant hvis det første argumentet er større enn eller likt det andre argumentet.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Returnerer sant hvis det første argumentet er mindre enn det andre argumentet.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Returnerer sant hvis det første argumentet er mindre enn eller likt det andre argumentet.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Returnerer sant hvis begge argumentene er ulike hverandre.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Returner det første tallet opphøyd i den andre tallet.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Opprett en funksjon som ikke har noe resultat.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Legg til, fjern eller endre rekkefølgen på input til denne funksjonen.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Tell hvor mange ganger noe tekst dukker opp i annen tekst.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Returnerer posisjonen for første/siste forekomsten av den første tekst i den andre teksten.  Returnerer %1 hvis teksten ikke blir funnet.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Erstatter alle forekomster av noe tekst i en annen tekst.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Reverserer rekkefølgen på tegnene i teksten.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "En variabel med navn «%1» finnes allerede.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "En variabel med navn «%1» finnes allerede for en annen type: «%2».";
