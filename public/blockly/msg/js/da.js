...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Kan ikke slette variablen »%1« da den er en del af definitionen af funktionen »%2«";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Blander to farver sammen i et bestemt forhold (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Lav en farve med den angivne mængde af rød, grøn og blå. Alle værdier skal være mellem 0 og 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "fortsæt med den næste gentagelse i løkken";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Bryd ud af den omgivende løkke.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Spring resten af denne løkke over, og fortsæt med den næste gentagelse.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Advarsel: Denne blok kan kun bruges i en løkke.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "For hvert element i en liste, sæt variablen '%1' til elementet, og udfør derefter nogle kommandoer.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Få variablen "%1" til at have værdierne fra startværdien til slutværdien, mens der tælles med det angivne interval, og udfør de angivne blokke.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP =
  'Tilføj en betingelse til denne "hvis" blok.';
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  'Tilføj en sidste fang-alt betingelse, til denne "hvis" blok.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  'Tilføj, fjern eller byt om på rækkefølgen af delene for at konfigurere denne "hvis" blok.';
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Hvis en værdi er sand, så udfør nogle kommandoer.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Hvis en værdi er sand, så udfør den første blok af kommandoer. Ellers udfør den anden blok af kommandoer.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Hvis den første værdi er sand, så udfør den første blok af kommandoer.  Ellers, hvis den anden værdi er sand, så udfør den anden blok af kommandoer.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Hvis den første værdi er sand, så udfør den første blok af kommandoer. Ellers, hvis den anden værdi er sand, så udfør den anden blok af kommandoer. Hvis ingen af værdierne er sande, så udfør den sidste blok af kommandoer.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://da.wikipedia.org/wiki/For-l%C3%B8kke";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Udfør nogle kommandoer, sålænge en værdi er falsk.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Udfør nogle kommandoer, sålænge en værdi er sand.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Denne funktion har duplikerede inddata.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Du kan ikke bruge et tomt variabelnavn.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Returnerer en liste af længde 0, som ikke indeholder nogen data";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "liste";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Tilføj, fjern eller byt om på rækkefølgen af delene for at konfigurere denne blok.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Returnerer elementet på den angivne position på en liste.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Returnerer den sidste element i en liste.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Fjerner og returnerer elementet på den angivne position på en liste.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Fjerner elementet på den angivne position på en liste.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Fjerner sidste element i en liste.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Opretter en kopi af den angivne del af en liste.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Returnerer indeks for første/sidste forekomst af elementet i listen. Returnerer %1, hvis elementet ikke kan findes.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "opret liste med elementet %1 gentaget %2 gange";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Opretter en liste bestående af den givne værdi gentaget et bestemt antal gange.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Indsætter elementet på den angivne position i en liste.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Føj elementet til slutningen af en liste.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Sætter elementet på den angivne position i en liste.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "alfabetisk, ignorer store/små bogstaver";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Saml en liste af tekster til én tekst, der er adskilt af et skilletegn.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Bryd tekst op i en liste af tekster med brud ved hvert skilletegn.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://da.wikipedia.org/wiki/Ulighed_(matematik)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Returnere sand, hvis begge inputs er lig med hinanden.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Returnere sand, hvis det første input er større end det andet input.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Returnere sand, hvis det første input er større end eller lig med det andet input.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Returnere sand, hvis det første input er mindre end det andet input.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Returnere sand, hvis det første input er mindre end eller lig med det andet input.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Returnere sand, hvis begge inputs ikke er lig med hinanden.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Returnere sand, hvis begge inputs er sande.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Returnere sand, hvis mindst et af inputtene er sande.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  'Kontrollér betingelsen i \'test\'. Hvis betingelsen er sand, returnér "hvis sand" værdien; ellers returnér "hvis falsk" værdien.';
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Returnere kvotienten af de to tal.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Returnere forskellen mellem de to tal.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Returnere produktet af de to tal.";
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Returnere det første tal opløftet til potensen af det andet tal.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://da.wikipedia.org/wiki/Matematisk_konstant";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Returnere en af de ofte brugte konstanter: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(2) (1.414…), sqrt(½) (0.707…) eller ∞ (uendeligt).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Begræns et tal til at være mellem de angivne grænser (inklusiv).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Kontrollere, om et tal er lige, ulige, primtal, helt, positivt, negativt, eller om det er deleligt med bestemt tal. Returnere sandt eller falskt.";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://da.wikipedia.org/wiki/Trigonometrisk_funktion";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Kør den brugerdefinerede funktion '%1' og brug dens returværdi.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Opretter en funktion der ikke har nogen returværdi.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Opretter en funktion der har en returværdi.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Returner en kopi af teksten hvor bogstaverne enten er udelukkende store eller små, eller hvor første bogstav i hvert ord er stort.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Returnerer bogstavet på den angivne placering.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Tæl hvor mange gange noget tekst fremgår i en anden tekst.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Tilføj, fjern eller byt om på rækkefølgen af delene for at konfigurere denne tekstblok.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Returnerer den angivne del af teksten.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Returnerer indeks for første/sidste forekomst af første tekst i den anden tekst.  Returnerer %1, hvis teksten ikke kan findes.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Returnerer sand, hvis den angivne tekst er tom.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Lav et stykke tekst ved at sætte et antal elementer sammen.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "længden af %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Returnerer antallet af bogstaver (herunder mellemrum) i den angivne tekst.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Skriv den angivne tekst, tal eller anden værdi.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Erstat alle forekomster af noget tekst i en anden tekst.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Vender rækkefølgen om for tegnene i teksten.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Returner en kopi af teksten med mellemrum fjernet fra den ene eller begge sider.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Sætter denne variabel til at være lig med input.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "En variabel med navnet »%1« findes allerede.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "En variabel med navnet »%1« findes allerede for en anden type: »%2«.";
