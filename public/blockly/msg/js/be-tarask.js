...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Немагчыма выдаліць зьменную «%1», таму што яна зьяўляецца часткай вызначэньня функцыі «%2»";
...
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Згорнутыя блёкі ўтрымліваюць папярэджаньні.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Зьмешвае два колеры ў дадзенай прапорцыі (0.0 — 1.0)";
Blockly.Msg.COLOUR_PICKER_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%9A%D0%BE%D0%BB%D0%B5%D1%80";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Стварыць колер з абранымі прапорцыямі чырвонага, зялёнага і сіняга. Усе значэньні павінны быць ад 0 да 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "працягнуць з наступнага кроку цыклю";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Прапусьціць рэшту цыклю і перайсьці да наступнага кроку.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Увага: гэты блёк можа быць выкарыстаны толькі ў цыклі.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Для кожнага элемэнту сьпісу прысвойвае зьменнай '%1' ягонае значэньне і выконвае пэўныя апэрацыі.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Прысвойвае зьменнай "%1" значэньні ад пачатковага да канчатковага значэньня, улічваючы зададзены крок, і выконвае абраныя блёкі.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Дадаць умову да блёку «калі».";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Дадаць заключную ўмову для ўсіх астатніх варыянтаў блёку «калі».";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Дадаць, выдаліць ці пераставіць сэкцыі для пераканфігураваньня гэтага блёку «калі».";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Калі значэньне ісьціна, выканаць пэўныя апэрацыі.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Калі значэньне ісьціна, выканаць першы блёк апэрацыяў, інакш выканаць другі блёк.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Калі першае значэньне ісьціна, выканаць першы блёк апэрацыяў. Інакш, калі другое значэньне ісьціна, выканаць другі блёк апэрацыяў.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Калі першае значэньне ісьціна, выканаць першы блёк апэрацыяў. Інакш, калі другое значэньне ісьціна, выканаць другі блёк апэрацыяў. Калі ніводнае з значэньняў не сапраўднае, выканаць апошні блёк апэрацыяў.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Пакуль значэньне хлусьня, выконваць пэўныя апэрацыі.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Пакуль значэньне ісьціна, выконваць пэўныя апэрацыі.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Выдаліць %1 выкарыстаньняў зьменнай «%2»?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Уваходныя зьвесткі гэтай функцыі дублююцца.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Вы ня можаце выкарыстоўваць пустую назву зьменнай.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Вяртае сьпіс даўжынёй 0, які ня ўтрымлівае запісаў зьвестак";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "сьпіс";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Дадаць, выдаліць ці пераставіць сэкцыі для пераканфігураваньня гэтага блёку.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Ставарае сьпіс зь любой колькасьцю элемэнтаў.";
...
Blockly.Msg.LISTS_GET_SUBLIST_TOOLTIP =
  "Стварае копію пазначанай часткі сьпісу.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Вяртае індэкс першага/апошняга ўваходжаньня элемэнту ў сьпіс. Вяртае %1, калі элемэнт ня знойдзены.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  "Вяртае значэньне ісьціна, калі сьпіс пусты.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "стварыць сьпіс з элемэнту %1, які паўтараецца %2 разоў";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Стварае сьпіс, які ўтрымлівае пададзеную колькасьць копіяў элемэнту.";
...
Blockly.Msg.LISTS_REVERSE_TOOLTIP =
  "Зьмяняе парадак копіі сьпісу на адваротны.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "паводле альфабэту, ігнараваць рэгістар";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Аб’ядноўвае сьпіс тэкстаў у адзін тэкст па падзяляльніках.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Падзяліць тэкст у сьпіс тэкстаў, па падзяляльніках.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%9D%D1%8F%D1%80%D0%BE%D1%9E%D0%BD%D0%B0%D1%81%D1%8C%D1%86%D1%8C";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Вяртае «ісьціна», калі абодва ўводы роўныя.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Вяртае «ісьціна», калі першы ўвод большы за другі.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Вяртае «ісьціна», калі першы ўвод большы ці роўны другому.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Вяртае «ісьціна», калі першы ўвод меншы за другі.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Вяртае «ісьціна», калі першы ўвод меншы ці роўны другому.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Вяртае «ісьціна», калі абодва ўводы ня роўныя.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Вяртае «ісьціна», калі ўвод непраўдзівы. Вяртае «хлусьня», калі ўвод праўдзівы.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Вяртае «ісьціна», калі абодва ўводы праўдзівыя.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Вяртае «ісьціна», калі прынамсі адзін з уводаў праўдзівы.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Праверыць умову ў 'тэст'. Калі ўмова праўдзівая, будзе вернутае значэньне «калі ісьціна»; інакш будзе вернутае «калі хлусьня».";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%90%D1%80%D1%8B%D1%82%D0%BC%D1%8D%D1%82%D1%8B%D0%BA%D0%B0";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Вяртае першы лік у ступені другога ліку.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 ад X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Вяртае арктангенс пункту (X, Y) у градусах ад -180 да 180.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%9C%D0%B0%D1%82%D1%8D%D0%BC%D0%B0%D1%82%D1%8B%D1%87%D0%BD%D0%B0%D1%8F_%D0%BA%D0%B0%D0%BD%D1%81%D1%82%D0%B0%D0%BD%D1%82%D0%B0";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Вяртае адну з агульных канстантаў: π (3.141...), e (2.718...), φ (1.618...), sqrt(2) (1.414...), sqrt(½) (0,707...) або ∞ (бясконцасьць).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Абмяжоўвае колькасьць ніжняй і верхняй межамі (уключна).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Правярае, ці зьяўляецца лік парным, няпарным, простым, станоўчым, адмоўным, ці ён дзеліцца на пэўны лік без астатку. Вяртае значэньне ісьціна або няпраўда.";
...
Blockly.Msg.MATH_NUMBER_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%9B%D1%96%D0%BA";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Вяртае сярэднеарытмэтычнае значэньне лікавых значэньняў у сьпісе.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Вяртае выпадковую дроб у дыяпазоне ад 0,0 (уключна) да 1,0.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Вяртае выпадковы цэлы лік паміж двума зададзенымі абмежаваньнямі ўключна.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%9A%D0%B2%D0%B0%D0%B4%D1%80%D0%B0%D1%82%D0%BD%D1%8B_%D0%BA%D0%BE%D1%80%D0%B0%D0%BD%D1%8C";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://be-x-old.wikipedia.org/wiki/%D0%A2%D1%80%D1%8B%D0%B3%D0%B0%D0%BD%D0%B0%D0%BC%D1%8D%D1%82%D1%80%D1%8B%D1%8F#.D0.A2.D1.80.D1.8B.D0.B3.D0.B0.D0.BD.D0.B0.D0.BC.D1.8D.D1.82.D1.80.D1.8B.D1.87.D0.BD.D1.8B.D1.8F_.D1.84.D1.83.D0.BD.D0.BA.D1.86.D1.8B.D1.96";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Запусьціць функцыю вызначаную карыстальнікам '%1'.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Запусьціць функцыю вызначаную карыстальнікам '%1' і выкарыстаць яе вынік.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Увага: гэтая функцыя мае парамэтры-дублікаты.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Вярнуць копію тэксту зь іншай велічынёй літар.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Падлічвае колькі разоў нейкі тэкст сустракаецца ўнутры нейкага іншага тэксту.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Дадайце, выдаліце ці зьмяніце парадак разьдзелаў для перадачы тэкставага блёку.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST =
  "атрымаць падрадок зь першай літары";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "узяць падрадок зь літары № з канца";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Вяртае індэкс першага/апошняга ўваходжаньня першага тэксту ў другі тэкст. Вяртае %1, калі тэкст ня знойдзены.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Вяртае значэньне ісьціна, калі тэкст пусты.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Стварае фрагмэнт тэксту аб’яднаньнем любой колькасьці элемэнтаў.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Замяняе ўсе выпадкі нейкага тэксту на іншы тэкст.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Мяняе парадак сымбаляў у тэксьце на адваротны.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Вяртае копію тэксту з прабеламі, выдаленымі ад аднаго ці абодвух бакоў.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Зьменная з назвай «%1» ужо існуе зь іншым тыпам: «%2».";
