...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continue with next iteration of loop"; // untranslated
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Break out of the containing loop."; // untranslated
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Skip the rest of this loop, and continue with the next iteration."; // untranslated
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Warning: This block may only be used within a loop."; // untranslated
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Add a final, catch-all condition to the if block."; // untranslated
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "If a value is true, then do some statements."; // untranslated
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "If a value is true, then do the first block of statements. Otherwise, do the second block of statements."; // untranslated
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "If the first value is true, then do the first block of statements. Otherwise, if the second value is true, do the second block of statements."; // untranslated
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "If the first value is true, then do the first block of statements. Otherwise, if the second value is true, do the second block of statements. If none of the values are true, do the last block of statements."; // untranslated
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Féiert d'Uweisungen aus, soulaang wéi de Wäert falsch ass.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Féiert d'Uweisungen aus, soulaang wéi de Wäert richteg ass";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Dir kënnt keen eidelen Numm fir eng Variabel benotzen.";
...
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP =
  "En Element op d'Lëscht derbäisetzen.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Schéckt en zoufällegt Element aus enger Lëscht zréck.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Hëlt dat lescht Element aus enger Lëscht eraus.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Hëlt en zoufällegt Element aus enger Lëscht eraus.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Setzt d'Element um Enn vun enger Lëscht derbäi.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Setzt d'Element op eng zoufälleg Plaz an d'Lëscht derbäi.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Setzt en zoufällegt Element an eng Lëscht.";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP =
  "Schéckt entweder richteg oder falsch zréck.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Return true if both inputs equal each other."; // untranslated
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Return true if the first input is greater than the second input."; // untranslated
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Return true if the first input is greater than or equal to the second input."; // untranslated
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Return true if the first input is smaller than the second input."; // untranslated
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Return true if the first input is smaller than or equal to the second input."; // untranslated
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Return true if both inputs are not equal to each other."; // untranslated
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_ADD =
  "Den Total vun den zwou Zuelen zréckginn.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "D'Produkt vun den zwou Zuelen zréckginn.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Schéckt de gréisste Wäert aus enger Lëscht zréck.";
...
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP =
  "En Element bei den Text derbäisetzen.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "All Kéiers wou e bestëmmten Text do ass duerch en aneren Text ersetzen.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Dréint d'Reiefolleg vun den Zeechen am Text ëm.";
