...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Неможливо видалити змінну '%1', тому що це частина визначення функції '%2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Змішує два кольори разом у вказаному співвідношені (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Створити колір зі вказаними рівнями червоного, зеленого та синього. Усі значення мають бути від 0 до 100.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Для кожного елемента в списку змінна '%1' отримує значення елемента, а потім виконуються певні дії.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Наявна змінна "%1" набуває значень від початкового до кінцевого, враховуючи заданий інтервал, і виконуються вказані блоки.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Додайте, вилучіть або змініть порядок секцій, щоб переналаштувати цей блок 'якщо'.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Якщо значення істинне, то виконати певні дії.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Якщо значення істинне, то виконується перший блок операторів. В іншому випадку виконується другий блок операторів.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Якщо перше значення істинне, то виконується перший блок операторів. В іншому випадку, якщо друге значення істина, то виконується другий блок операторів.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Якщо перше значення істинне, то виконується перший блок операторів. В іншому випадку, якщо друге значення істинне, то виконується другий блок операторів. Якщо жодне із значень не є істинним, то виконується останній блок операторів.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://uk.wikipedia.org/wiki/Цикл_(програмування)#.D0.A6.D0.B8.D0.BA.D0.BB_.D0.B7_.D0.BB.D1.96.D1.87.D0.B8.D0.BB.D1.8C.D0.BD.D0.B8.D0.BA.D0.BE.D0.BC";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Вилучити %1 використання змінної '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "У цієї функції є вхідні змінні, що дублюються.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Ви не можете використовувати порожню назву змінної.";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Додайте, вилучіть або змініть порядок секцій для переналаштування блока списку.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Повертає елемент у заданій позиції у списку.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Видаляє і повертає елемент у заданій позиції у списку.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Повертає індекс першого/останнього входження елемента у списку. Повертає %1, якщо елемент не знайдено.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Створює список, що складається з заданого значення повтореного задану кількість разів.";
...
Blockly.Msg.LISTS_REVERSE_TOOLTIP =
  "Змінити порядок копії списку на зворотний.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Злити список текстів у єдиний текст, відокремивши розділювачами.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Поділити текст на список текстів, розриваючи на кожному розділювачі.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Повертає істину, якщо перше вхідне значення більше, ніж друге.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Повертає істину, якщо перше вхідне значення більше або дорівнює другому.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Повертає істину, якщо перше вхідне значення менше, ніж друге.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Повертає істину, якщо перше вхідне значення менше або дорівнює другому.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Повертає істину, якщо вхідне значення хибне. Повертає хибність, якщо вхідне значення істинне.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Повертає істину, якщо принаймні один з входів істинний.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Перевіряє умову в 'тест'. Якщо умова істинна, то повертає  значення 'якщо істина'; в іншому випадку повертає значення 'якщо хибність'.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Повертає перше число, піднесене до степеня, вираженого другим числом.";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Перевіряє, чи число парне, непарне, просте, ціле, додатне, від'ємне або чи воно ділиться на певне число без остачі. Повертає істину або хибність.";
Blockly.Msg.MATH_IS_WHOLE = "ціле";
Blockly.Msg.MATH_MODULO_HELPURL =
  "https://uk.wikipedia.org/wiki/Ділення_з_остачею";
...
Blockly.Msg.MATH_ONLIST_HELPURL =
  "http://www.mapleprimes.com/questions/100441-Applying-Function-To-List-Of-Numbers";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://uk.wikipedia.org/wiki/Генерація_випадкових_чисел";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Якщо значення істинне, то повернути друге значення.";
...
Blockly.Msg.PROCEDURES_MUTATORARG_TOOLTIP =
  "Додати до функції вхідні параметри.";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "входи";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Додайте, вилучіть або змініть порядок вхідних параметрів для цієї функції.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Підраховує, скільки разів деякий текст з'являється в іншому тексті.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Додайте, вилучіть або змініть порядок секцій для переналаштування текстового блоку.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Повертає індекс першого/останнього входження першого тексту в другий. Повертає %1, якщо текст не знайдено.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Повертає істину, якщо вказаний текст порожній.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "Створити фрагмент тексту шляхом з'єднування будь-якого числа елементів.";
Blockly.Msg.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification"; // untranslated
Blockly.Msg.TEXT_LENGTH_TITLE = "довжина %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Повертає число символів (включно з пропусками) у даному тексті.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Надрукувати заданий текст, числа або інші значення.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Замінює всі входження деякого тексту іншим текстом.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Змінює на протилежний порядок символів у тексті.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Повертає копію тексту з вилученими пропусками з одного або обох кінців.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Змінна з назвою '%1' вже існує в іншому типі: '%2'.";
