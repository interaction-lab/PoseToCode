...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Không thể xóa giá trị '%1' vì nó được bao gồm trong định nghĩa của chức năng '%2'";
...
Blockly.Msg.COLOUR_PICKER_HELPURL =
  "https://vi.wikipedia.org/wiki/M%C3%A0u_s%E1%BA%AFc";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Chú ý: Mảnh này chỉ có thế dùng trong các vòng lặp.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Cho biến '%1' lấy các giá trị từ số bắt đầu đến số kết thúc, đếm theo khoảng thời gian đã chỉ định và thực hiện các khối được chỉ định.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Thêm một điều kiện vào mảnh nếu.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Cuối cùng, khi không điều kiện nào đúng.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Thêm, bỏ, hoặc đổi thứ tự các mảnh con để tạo cấu trúc mới cho mảnh nếu.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Nếu điều kiện đúng, thực hiện các lệnh đầu.  Nếu sai, thực hiện các lệnh sau.";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Hàm này có chứa các input trùng nhau.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Bạn không thể không nhập tên biến.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Hoàn trả một danh sách, với độ dài 0, không có thành tố nào cả";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Hoàn trả thành tố trong danh sách ở vị trí ấn định.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Hoàn trả thành tố cuối cùng trong danh sách.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Hoàn trả một thành tố bất kỳ trong danh sách.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Hoàn trả và xóa thành tố đầu tiên trong danh sách.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Hoàn trả và xóa thành tố trong danh sách ở vị trí ấn định.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Xóa thành tố đầu tiên trong danh sách.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Xóa thành tố trong danh sách ở vị trí ấn định.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Xóa thành tố cuối cùng trong danh sách.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Xóa thành tố bất kỳ trong danh sách.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END =
  "lấy một danh sách con từ (đếm từ cuối) từ vị trí thứ";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START =
  "lấy một danh sách con từ vị trí thứ";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Hoàn trả vị trí xuất hiện đầu tiên/cuối cùng của vật trong danh sách. Nếu không tìm thấy thì hoàn trả số %1.";
...
Blockly.Msg.LISTS_ISEMPTY_TOOLTIP =
  'Hoàn trả “đúng" nếu danh sách không có thành tử nào.';
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Tạo danh sách gồm một số lượng vật nhất định với mỗi vật đều giống nhau.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
  "Chèn vật vào đầu danh sách.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM =
  "Chèn vật vào danh sách theo vị trí ấn định.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "Gắn thêm vật vào cuối danh sách.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Gắn chèn vật vào danh sách ở vị trí ngẫu nhiên.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Đặt giá trị của thành tố đầu tiên trong danh sách.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Đặt giá trị của thành tố ở vị trí ấn định trong một danh sách.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Đặt giá trị của thành tố cuối cùng trong danh sách.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Đặt giá trị của thành tố ngẫu nhiên trong danh sách.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Liên kết một danh sách các văn bản vào một văn bản, cách nhau bằng dấu phân cách.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Tách văn bản thành một danh sách các văn bản nhỏ, ngắt bởi các ký tự phân cách.";
...
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://vi.wikipedia.org/wiki/B%E1%BA%A5t_%C4%91%E1%BA%B3ng_th%E1%BB%A9c";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  'Hoàn trả giá trị "đúng" (true) nếu giá trị hai đầu vào bằng nhau.';
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  'Hoàn trả giá trị "đúng" (true) nếu đầu vào thứ nhất lớn hơn đầu vào thứ hai.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  'Hoàn trả giá trị "đúng" (true) nếu đầu vào thứ nhất nhỏ hơn đầu vào thứ hai.';
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  'Hoàn trả giá trị "đúng" (true) nếu giá trị hai đầu vào không bằng nhau.';
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  'Hoàn trả "đúng" (true) nếu cả hai đầu vào đều đúng.';
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  'Hoàn trả "đúng" (true) nếu ít nhất một trong hai đầu vào đúng.';
...
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://vi.wikipedia.org/wiki/S%E1%BB%91_h%E1%BB%8Dc";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Hoàn trả số lũy thừa với số thứ nhất là cơ số và số thứ hai là số mũ.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2 của X:%1 Y:%2";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Trả về arctangent của điểm (X, Y) trong khoảng từ -180 độ đến 180 độ.";
Blockly.Msg.MATH_CHANGE_HELPURL =
  "https://vi.wikipedia.org/wiki/Ph%C3%A9p_c%E1%BB%99ng";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Giới hạn số đầu vào để không dưới số thứ nhất và không hơn số thứ hai.";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Chia số thứ nhất cho số thứ hai rồi hoàn trả số dư từ.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Hoàn trả giá trị trung bình từ của danh sách số.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX =
  "Hoàn trả số lớn nhất trong tất cả các số trong danh sách.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN =
  "Hoàn trả số trung vị của danh sách số.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN =
  "Hoàn trả số nhỏ nhất trong tất cả các số trong danh sách.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Hoàn trả các số có mặt nhiều nhất trong danh sách.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM =
  "Hoàn trả một số bất kỳ từ các số trong danh sách.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Hoàn trả độ lệch chuẩn của danh sách số.";
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Hoàn trả tổng số của tất cả các số trong danh sách.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Hoàn trả một phân số bất kỳ không nhỏ hơn 0.0 và không lớn hơn 1.0.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://vi.wikipedia.org/wiki/C%C4%83n_b%E1%BA%ADc_hai";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS =
  "Hoàn trả giá trị tuyệt đối của số đầu vào.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP =
  "Hoàn trả lũy thừa của số e với số mũ đầu vào.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LN =
  "Hoàn trả lôgarit tự nhiên của số đầu vào.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_LOG10 =
  "Hoàn trả lôgarit cơ số 10 của số đầu vào.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_NEG =
  "Đổi dấu của số đầu vào: âm thành dương và dương thành âm, và hoàn trả số mới.";
Blockly.Msg.MATH_SINGLE_TOOLTIP_POW10 =
  "Hoàn trả lũy thừa của số 10 với số mũ đầu vào.";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://vi.wikipedia.org/wiki/Ch%C6%B0%C6%A1ng_tr%C3%ACnh_con";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Chạy một thủ tục không có giá trị hoàn trả.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://vi.wikipedia.org/wiki/Ch%C6%B0%C6%A1ng_tr%C3%ACnh_con";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Chạy một thủ tục có giá trị hoàn trả.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Một thủ tục không có giá trị hoàn trả.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Thêm, xóa hoặc sắp xếp lại các đầu vào cho hàm này.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Hoàn trả văn bản sau khi chuyển đổi chữ in hoa hay thường.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Đếm số lần một đoạn văn bản xuất hiện trong một đoạn văn bản khác.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Thêm, bỏ, hoặc sắp xếp lại các thành phần để tạo dựng mảnh văn bản này.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP =
  "Hoàn trả một mảng ký tự ấn định từ trong văn bản.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Hoàn trả vị trí xuất hiện đầu/cuối của văn bản thứ nhất trong văn bản thứ hai.  Nếu không tìm thấy thì hoàn trả số %1.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Hoàn trả “đúng nếu văn bản không có ký tự nào.";
...
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "Hoàn trả số lượng ký tự (kể cả khoảng trắng) trong văn bản đầu vào.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "In ra màng hình một văn bản, con số, hay một giá trị đầu vào khác.";
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER =
  "Xin người dùng nhập vào con số với dòng hướng dẫn";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Thay thế tất cả các lần xuất hiện của văn bản bằng văn bản khác.";
...
Blockly.Msg.TEXT_REVERSE_TOOLTIP =
  "Đảo ngược thứ tự của các chữ cái trong văn bản.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Hoàn trả bản sao của văn bản sau khi xóa khoảng trắng từ một hoặc hai bên.";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Giá trị '%1' đã tồn tại dưới dạng: '%2'.";
