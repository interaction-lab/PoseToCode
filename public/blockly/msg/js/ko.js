...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "빨강,파랑,초록의 값을 이용하여 색을 만드십시오. 모든 값은 0과 100 사이에 있어야 합니다.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL =
  "https://ko.wikipedia.org/wiki/%EC%A0%9C%EC%96%B4_%ED%9D%90%EB%A6%84";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "나머지 반복 부분을 더 이상 실행하지 않고, 다음 반복을 수행합니다.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "경고 : 이 블록은 반복 실행 블럭 안에서만 사용됩니다.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL =
  "https://ko.wikipedia.org/wiki/For_%EB%A3%A8%ED%94%84#.EC.9E.84.EC.9D.98.EC.9D.98_.EC.A7.91.ED.95.A9";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  '변수 "%1"은 지정된 간격으로 시작 수에서 끝 수까지를 세어 지정된 블록을 수행해야 합니다.';
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "섹션을 추가, 제거하거나 순서를 변경하여 이 if 블럭을 재구성합니다.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "조건식의 계산 결과가 참이면, 첫 번째 블럭의 명령을 실행하고, 그렇지 않으면 두 번째 블럭의 명령을 실행합니다.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "첫 번째 조건식의 계산 결과가 참이면, 첫 번째 블럭의 명령을 실행하고, 두 번째 조건식의 계산 결과가 참이면, 두 번째 블럭의 명령을 실행합니다.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "첫 번째 조건식의 계산 결과가 참이면, 첫 번째 블럭의 명령을 실행하고, 두 번째 조건식의 계산 결과가 참이면, 두 번째 블럭의 명령을 실행하고, ... , 어떤 조건식의 계산 결과도 참이 아니면, 마지막 블럭의 명령을 실행합니다.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "값이 거짓일 때, 몇 가지 선언을 합니다.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "값이 참일 때, 몇 가지 선언을 합니다.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "목록에서 항목이 처음 또는 마지막으로 발생한 색인 위치를 반환합니다. 항목이 없으면 %1을 반환합니다.";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "구분 기호로 구분하여 텍스트 목록을 하나의 텍스트에 병합합니다.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "각 속보, 텍스트의 목록들에서 텍스트를 분할합니다.";
...
Blockly.Msg.LOGIC_NEGATE_HELPURL =
  "https://ko.wikipedia.org/wiki/%EB%B6%80%EC%A0%95";
Blockly.Msg.LOGIC_NEGATE_TITLE = "%1가 아닙니다";
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "입력값이 거짓이라면 참을 반환합니다. 참이라면 거짓을 반환합니다.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "'test'의 조건을 검사합니다. 조건이 참이면 'if true' 값을 반환합니다. 거짓이면 'if false' 값을 반환합니다.";
...
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "점 (X, Y)의 아크탄젠트를 -180에서 180까지 도 단위로 반환합니다.";
...
Blockly.Msg.MATH_CONSTRAIN_HELPURL =
  "https://ko.wikipedia.org/wiki/클램핑_(그래픽)";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_ABS =
  "어떤 수의 절대값(absolute)을 계산한 결과를, 정수값으로 돌려줍니다.";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://ko.wikipedia.org/wiki/함수_(프로그래밍)";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_HELPURL =
  "https://ko.wikipedia.org/wiki/%ED%95%A8%EC%88%98_%28%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D%29";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "다른 어떤 텍스트에서 어떤 텍스트가 나타난 횟수를 셉니다.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "섹션을 추가, 제거하거나 순서를 변경하여 이 텍스트 블럭을 재구성합니다.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "두 번째 텍스트에서 첫 번째 텍스트가 처음 또는 마지막으로 발생한 색인 위치를 반환합니다. 텍스트가 없으면 %1을 반환합니다.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "다른 텍스트 내에서 일부 텍스트의 모든 발생을 치환합니다.";
