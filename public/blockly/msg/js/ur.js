...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "متغیر '٪ 1' کو حذف نہیں کر سکتا کیونکہ یہ فنکشن کی تعریف کا حصہ ہے '٪ 2'";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "دیئے گئے ریشیو میں دو رنگوں کو مرکب کریں (0.0-1.0)";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "مخصوص، سرخ، سبز اور نیلے رنگ کے ساتھ ایک رنگ بنائیں. تمام اقدار 0 اور 100 کے درمیان ہونا ضروری ہے.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "انتباہ: اس بلاک کو صرف لوپ میں استعمال کیا جاسکتا ہے۔";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "فہرست میں ہر آئٹم کے لئے، '%1' متغیر کو آئٹم پہ لگائے،اور پھر کچھ جملے کہے";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "کیا چر '%1' ابتدا عدد سے اختتام عدد تک मानों کو لیتا ہے، निर्दिष्ट अंतराल کے تحت گنتی کرتا ہے، اور निर्दिष्ट रुकावटों کو کرتا ہے۔";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "اگر ایک ویلیو صحیح ہے، تو کچھ سٹیٹمنٹ کریں";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "'٪ 2' متغیر کے٪ 1 استعمال کو حذف کریں؟";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "فہرست میں پہلا آئٹم  کا تعین کریں";
...
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "ایک متغیر نام '٪ 1' پہلے سے ہی موجود ہے.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "ایک متغیر نام '٪ 1' کسی دوسرے قسم کے لئے پہلے ہی موجود ہے: '٪ 2'.";
