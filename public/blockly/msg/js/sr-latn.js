...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Ne mogu da obrišem varijablu ’%1’ jer je deo definicije funkcije ’%2’";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Pomešati dve boje zajedno sa datim odnosom (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Kreiraj boju sa određenom količinom crvene,zelene, i plave. Sve vrednosti moraju biti između 0 i 100.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "nastavi sa sledećom iteracijom petlje";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Preskoči ostatak ove petlje, i nastavi sa sledećom iteracijom(ponavljanjem).";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Upozorenje: Ovaj blok može da se upotrebi samo unutar petlje.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Za svaku stavku unutar liste, podesi promenjivu '%1' po stavci, i onda načini neke izjave-naredbe.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  'Imaj promenjivu "%1" uzmi vrednosti od početnog broja do zadnjeg broja, brojeći po određenom intervalu, i izvrši određene blokove.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Dodajte uslov bloku „ako“.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Dodaj konačni, catch-all  (uhvati sve) uslove if bloka.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Dodaj, ukloni, ili preuredi delove kako bih rekonfigurisali ovaj if blok.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "ako je vrednost tačna, onda izvrši neke naredbe-izjave.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "ako je vrednost tačna, onda izvrši prvi blok naredbi, U suprotnom, izvrši drugi blok naredbi.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Ako je prva vrednost tačna, onda izvrši prvi blok naredbi, u suprotnom, ako je druga vrednost tačna , izvrši drugi blok naredbi.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Ako je prva vrednost tačna, onda izvrši prvi blok naredbi, u suprotnom, ako je druga vrednost tačna , izvrši drugi blok naredbi. Ako ni jedna od vrednosti nije tačna, izvrši poslednji blok naredbi.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL =
  "https://sr.wikipedia.org/wiki/For_petlja";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Dok vrednost nije tačna, onda izvršiti neke naredbe.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Dok je vrednost tačna, onda izvršite neke naredbe.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Da obrišem %1 upotreba promenljive '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Ova funkcija ima duplicirane unose.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Ne možete da koristite prazno ime varijable.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "vraća listu, dužine 0, ne sadržavajući  evidenciju podataka";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "spisak";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Dodajte, izbrišite, ili preuredite delove kako bi se reorganizovali ovaj blok liste.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Kreiraj listu sa bilo kojim brojem stavki.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Vraća broj prvog i/poslednjeg ulaska elementa u listu. Vraća %1 Ako element nije pronađen.";
...
Blockly.Msg.LISTS_REPEAT_TITLE =
  "Napraviti listu sa stavkom %1 koja se ponavlja %2 puta";
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Pravi listu koja se sastoji od zadane vrednosti koju ponavljamo određeni broj šuta.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "azbučno, ignoriši mala i velika slova";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Da se pridruži listu tekstova u jedan tekst, podeljenih za razdvajanje.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Podeliti tekst u listu tekstova, razbijanje na svakom graničnik.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Vraća vrednost „tačno“ ako su oba ulaza jednaka.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Vraća vrednost „tačno“ ako je prvi ulaz veći od drugog.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Vraća vrednost „tačno“ ako je prvi ulaz veći ili jednak drugom.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Vraća vrednost „tačno“ ako je prvi ulaz manji od drugog.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Vraća vrednost „tačno“ ako je prvi ulaz manji ili jednak drugom.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Vraća vrednost „tačno“ ako su oba ulaza nejednaka.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Vraća vrednost „tačno“ ako je ulaz netačan. Vraća vrednost „netačno“ ako je ulaz tačan.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Vraća vrednost „tačno“ ako su oba ulaza tačna.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Vraća vrednost „tačno“ ako je bar jedan od ulaza tačan.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Proveri uslov u 'test'. Ako je uslov tačan, tada vraća 'if true' vrednost; u drugom slučaju vraća 'if false' vrednost.";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Vraća prvi broj stepenovan drugim.";
...
Blockly.Msg.MATH_CONSTANT_HELPURL =
  "https://sr.wikipedia.org/wiki/Matematička_konstanta";
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "vrati jednu od zajedničkih konstanti: π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ili ∞ (infinity).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Ograničava broj na donje i gornje granice (uključivo).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Provjerava da li je broj paran, neparan, prost, cio, pozitivan, negativan, ili da li je deljiv sa određenim brojem. Vraća tačno ili netačno.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Vraća prosek numeričkih vrednosti sa spiska.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_HELPURL =
  "https://sr.wikipedia.org/wiki/Generator_slučajnih_brojeva";
Blockly.Msg.MATH_RANDOM_FLOAT_TITLE_RANDOM = "slučajni razlomak";
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Vraća slučajni razlomak između 0.0 (uključivo) i 1.0 (isključivo).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Vraća slučajno odabrani celi broj između dve određene granice, uključivo.";
...
Blockly.Msg.MATH_SINGLE_HELPURL =
  "https://sr.wikipedia.org/wiki/Kvadratni_koren";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://sr.wikipedia.org/wiki/Trigonometrijske_funkcije";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Pokrenite prilagođenu funkciju „%1“.";
Blockly.Msg.PROCEDURES_CALLRETURN_HELPURL =
  "https://en.wikipedia.org/wiki/Subroutine";
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP =
  "Pokrenite prilagođenu funkciju „%1“ i koristi njen izlaz.";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Upozorenje: Ova funkcija ima duplikate parametara.";
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Istakni definiciju funkcije";
Blockly.Msg.PROCEDURES_IFRETURN_HELPURL = "http://c2.com/cgi/wiki?GuardClause"; // untranslated
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Ukoliko je vrednost tačna, vrati drugu vrednost.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Upozorenje: Ovaj blok se može koristiti jedino u definiciji funkcije.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Da dodate, uklonite ili pereuporяdočitь ulaza za ovu funkciju.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Vraća primerak teksta sa drugačijom veličinom slova.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Broji koliko puta se neki tekst pojavljuje unutar nekog drugog teksta.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Dodaj, ukloni, ili drugačije poredaj odjelke kako bi iznova postavili ovaj tekst blok.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END =
  "preuzmi podnisku iz slova # sa kraja";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST =
  "pronađi poslednje pojavljivanje teksta";
Blockly.Msg.TEXT_INDEXOF_TITLE = "u tekstu %1 %2 %3";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Vraća odnos prvog/zadnjeg pojavljivanja teksta u drugom tekstu. Vrađa %1 ako tekst nije pronađen.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Vraća tačno ako je dostavljeni tekst prazan.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Prikažite određeni tekst, broj ili drugu vrednost na ekranu.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Zamena svih pojava nekog teksta unutar nekog drugog teksta.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Vraća kopiju teksta sa uklonjenim prostorom sa jednog od dva kraja.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Postavlja promenljivu tako da bude jednaka ulazu.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS =
  "Promenljiva pod imenom '%1' već postoji.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Varijabla po imenu '%1' već postoji za drugu varijablu tipa '%2'.";
