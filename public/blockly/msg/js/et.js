...
Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE =
  "Muutujat '%1' ei saa kustutada, sest see on osa funktsiooni '%2' määratlusest";
...
Blockly.Msg.COLLAPSED_WARNINGS_WARNING =
  "Kokkuvajunud plokid sisaldavad hoiatusi.";
...
Blockly.Msg.COLOUR_BLEND_TOOLTIP =
  "Segab kaks värvi määratud suhtega (0.0 - 1.0) kokku.";
...
Blockly.Msg.COLOUR_RGB_TOOLTIP =
  "Tekitab värvi määratud hulgast punasest, rohelisest ja sinisest. Kõik väärtused peavad olema 0 ja 100 vahel.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "katkesta see kordus ja liigu järgmisele";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK =
  "Väljub kordusest ja liigub edasi korduse järel oleva koodi käivitamisele.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Katkestab korduses oleva koodi käivitamise ja käivitab järgmise korduse.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Hoiatus: Seda plokki saab kasutada ainult korduse sees.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP =
  "Iga elemendiga loendis anna muutujale '%1' elemendi väärtus ja kõivita plokis olevad käsud.";
...
Blockly.Msg.CONTROLS_FOR_TITLE =
  "loendus muutujaga %1 alates %2 kuni %3, %4 kaupa";
Blockly.Msg.CONTROLS_FOR_TOOLTIP =
  "Annab muutujale '%1' väärtused ühest numbrist teiseni, muutes seda intervalli kaupa ja käivitab igal muudatusel ploki sees oleva koodi.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Lisab „kui“ plokile tingimuse.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP =
  "Lisab „kui“ plokile lõpliku tingimuseta koodiploki.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP =
  "Selle „kui“ ploki muutmine sektsioonide lisamise, eemaldamise ja järjestamisega.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 =
  "Kui avaldis on tõene, käivita ploki sees olevad käsud.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 =
  "Kui avaldis on tõene, käivita käsud esimesest plokist. Vastasel juhul käivita käsud teisest plokist.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 =
  "Kui esimene avaldis on tõene, käivita käsud esimesest plokist. Vastasel juhul, kui teine avaldis on tõene, käivita käsud teisest plokist.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 =
  "Kui esimene avaldis on tõene, käivita käsud esimesest plokist. Vastasel juhul, kui teine avaldis on tõene, käivita käsud teisest plokist. Kui ükski avaldistest pole tõene, käivita käsud viimasest plokist.";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP =
  "Plokis olevate käskude käivitamine määratud arv kordi.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Plokis olevaid käske korratakse seni kui avaldis pole tõene.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Plokis olevaid käske korratakse seni kui avaldis on tõene.";
...
Blockly.Msg.DELETE_VARIABLE_CONFIRMATION =
  "Kas kustutada %1 kohas kasutatav muutuja '%2'?";
...
Blockly.Msg.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Sellel funktsioonil on dubleerivad sisendid.";
...
Blockly.Msg.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "Tühja muutuja nime ei saa kasutada.";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP =
  "Tagastab loendi, mille pikkus on 0 ja milles pole ühtegi elementi.";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "loend";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Loendiploki elementide lisamine, eemaldamine või järjestuse muutmine.";
...
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "Tekitab mistahes arvust elementidest loendi.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Tagastab loendi esimese elemendi.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Tagastab loendis määratud asukohal oleva elemendi.";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "Tagastab esimese/viimase loendist leitud objekti asukoha (objekti järjekorranumbri loendis). Kui objekti ei leita, tagastab %1.";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP =
  "Tekitab uue loendi, millesse lisatakse ühte elementi pikkusega määratud arv kordi.";
...
Blockly.Msg.LISTS_SORT_TYPE_IGNORECASE =
  "tähestiku järgi (tähesuurust eirates)";
...
Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN =
  "Ühendab tekstide loendis olevad tükid üheks tekstiks, asetades tükkide vahele eraldaja.";
Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Tükeldab teksti eraldajade kohalt ja asetab tükid tekstide loendisse.";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP =
  "Tagastab tõeväärtuse – kas „tõene“ või „väär“.";
Blockly.Msg.LOGIC_BOOLEAN_TRUE = "tõene";
Blockly.Msg.LOGIC_COMPARE_HELPURL =
  "https://en.wikipedia.org/wiki/Inequality_(mathematics)";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "Tagastab „tõene“, kui avaldiste väärtused on võrdsed.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "Tagastab „tõene“, kui esimese avaldise väärtus on suurem kui teise väärtus.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "Tagastab „tõene“, kui esimese avaldise väärtus on suurem või võrdne teise väärtusega.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "Tagastab „tõene“, kui esimese avaldise väärtus on väiksem kui teise väärtus.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "Tagastab „tõene“, kui esimese avaldise väärtus on väiksem või võrdne teise väärtusega.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "Tagastab „tõene“, kui avaldiste väärtused pole võrdsed.";
...
Blockly.Msg.LOGIC_NEGATE_TOOLTIP =
  "Tagastab „tõene“, kui avaldis on väär. Tagastab „väär“, kui avaldis on tõene.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "Tagastab „tõene“, kui mõlemad avaldised on tõesed.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "Tagastab „tõene“, kui vähemalt üks avaldistest on tõene.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Kui tingimuse väärtus on tõene, tagastab „kui tõene“ väärtuse, vastasel juhul „kui väär“ väärtuse.";
Blockly.Msg.MATH_ADDITION_SYMBOL = "+"; // untranslated
Blockly.Msg.MATH_ARITHMETIC_HELPURL =
  "https://et.wikipedia.org/wiki/Aritmeetika";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Tagastab esimese arvu teise arvu astmes.";
Blockly.Msg.MATH_ATAN2_HELPURL = "https://en.wikipedia.org/wiki/Atan2";
Blockly.Msg.MATH_ATAN2_TITLE = "atan2(X:%1, Y:%2)";
Blockly.Msg.MATH_ATAN2_TOOLTIP =
  "Tagastab punkti (X, Y) arkustangentsit kraadides vahemikus -180 kuni 180.";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "Tagastab ühe konstantidest: π (3,141…), e (2,718…), φ (1.618…), √2) (1,414…), √½ (0,707…), või ∞ (infinity).";
...
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP =
  "Piirab arvu väärtuse toodud piiridesse (piirarvud kaasa arvatud).";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "Kontrollib kas arv on paarisarv, paaritu arv, algarv, täisarv, positiivne, negatiivne või jagub kindla arvuga. Tagastab „tõene“ või „väär“.";
...
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "Tagastab esimese numbri teisega jagamisel tekkiva jäägi.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Tagastab loendis olevate arvväärtuste aritmeetilise keskmise.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE =
  "Tagastab loendi kõige sagedamini esinevate loendi liikmetega.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM =
  "Tagastab kõigi loendis olevate arvude summa.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP =
  "Tagastab juhusliku murdosa 0.0 (kaasa arvatud) and 1.0 (välja arvatud) vahel.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP =
  "Tagastab juhusliku täisarvu toodud piiride vahel (piirarvud kaasa arvatud).";
...
Blockly.Msg.MATH_TRIG_HELPURL =
  "https://et.wikipedia.org/wiki/Trigonomeetrilised_funktsioonid";
...
Blockly.Msg.PROCEDURES_CALLNORETURN_HELPURL =
  "https://et.wikipedia.org/wiki/Alamprogramm";
Blockly.Msg.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Käivitab kasutaja defineeritud funktsiooni '%1'.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Tekitab funktsiooni, mis ei tagasta midagi.";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Tekitab funktsiooni, mis tagastab midagi.";
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Hoiatus: Sel funktsioonil on mitu sama nimega sisendit.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP =
  "Kui väärtus on tõene, tagastatakse teine väärtus.";
Blockly.Msg.PROCEDURES_IFRETURN_WARNING =
  "Hoiatus: Seda plokki saab kasutada ainult funktsiooni definitsioonis.";
...
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "Funktsiooni sisendite lisamine, eemaldamine või järjestuse muutmine.";
...
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP =
  "Tagastab muudetud tähesuurusega teksti koopia.";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP =
  "Tagastab tekstis määratud asukohal oleva sümboli.";
...
Blockly.Msg.TEXT_COUNT_TOOLTIP =
  "Loenda, mitu korda mingi tekst esineb teise teksti sees.";
...
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP =
  "Tekstiploki muutmine sektsioonide lisamise, eemaldamise või järjestuse muutmisega.";
...
Blockly.Msg.TEXT_INDEXOF_TOOLTIP =
  "Tagastab esimesest tekstist esimese/viimase leitud teise teksti asukoha (indeksi). Kui teksti ei leita, tagastab %1.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP =
  "Tagastab „tõene“, kui tekstis pole ühtegi sümbolit.";
...
Blockly.Msg.TEXT_PRINT_TOOLTIP =
  "Trükib määratud teksti, numbri või mõne muu objekti väärtuse.";
Blockly.Msg.TEXT_PROMPT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#getting-input-from-the-user"; // untranslated
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER =
  "Küsib kasutajalt teadet näidates mingit arvu.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT =
  "Küsib kasutajalt teadet näidates mingit teksti.";
...
Blockly.Msg.TEXT_REPLACE_TOOLTIP =
  "Asenda mõne teksti esinemine mõnes muus tekstis.";
...
Blockly.Msg.TEXT_TRIM_TOOLTIP =
  "Tagastab koopia tekstist, millel on tühikud ühelt või mõlemalt poolt eemaldatud.";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP =
  "Määrab selle muutuja väärtuse võrdseks sisendi väärtusega.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS = "'%1'-nimeline muutuja on juba olemas.";
Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Muutuja nimega '%1' juba eksisteerib teise tüübina: '%2'.";
